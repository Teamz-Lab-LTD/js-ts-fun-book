...
const COURSE_CONFIG = {
  ...
  keywords: 'flutter interview questions 2026, flutter senior interview preparation, dart interview questions, flutter bloc interview, clean architecture flutter interview, flutter testing interview, flutter system design interview, flutter behavioral interview, flutter remote jobs, flutter developer career, flutter platform channels interview, flutter ci cd interview, flutter performance optimization, flutter offline first architecture, flutter state management interview, senior flutter developer preparation, flutter job preparation course free, flutter riverpod interview, flutter navigation interview questions, flutter widget lifecycle interview, flutter animations interview, flutter firebase interview, flutter offline first interview, dart async await interview, flutter mock interview practice, flutter coding challenge, how to prepare flutter interview, flutter developer salary negotiation, flutter interview tips 2026, best flutter interview course free, flutter technical interview questions, dart generics interview, flutter memory management interview',
