const LESSONS_DATA = [
  {id:1,title:"JavaScript vs TypeScript",subtitle:"Adding Superpowers to JS",analogy:"JavaScript is like texting without autocorrect — fast but you make typos that nobody catches until it's embarrassing. TypeScript is like texting WITH autocorrect AND grammar check — it catches your mistakes BEFORE you hit send!",points:[{t:"TypeScript = JS + Types",d:"TypeScript is JavaScript with type annotations added on top. You tell the compiler 'this variable is a string' or 'this function returns a number' — and it checks your work. Every valid JS code is also valid TS code!",code:"// JavaScript\nlet name = 'Alice'; // no type info\n\n// TypeScript\nlet name: string = 'Alice'; // type declared!\n// name = 42; // Error! Can't assign number to string"},{t:"Type Annotations",d:"You write types after a colon — like name: string or age: number. This tells TypeScript exactly what kind of data is allowed, so it can warn you if you use the wrong type.",code:"let name: string = 'Alice';\nlet age: number = 25;\nlet isActive: boolean = true;\nlet scores: number[] = [95, 87, 92];\n\nfunction greet(name: string): string {\n  return 'Hello, ' + name;\n}"},{t:"Interfaces — Shape Contracts",d:"An interface defines the shape of an object — what properties it has and what types they are. Think of it as a blueprint: interface User { name: string; age: number; }. Now TypeScript knows exactly what a User looks like!",code:"interface User {\n  name: string;\n  age: number;\n  email: string;\n}\n\nconst user: User = {\n  name: 'Alice',\n  age: 25,\n  email: 'alice@mail.com'\n};\n// Missing a field? TypeScript errors immediately!"},{t:"Optional Properties with ?",d:"Add a ? after a property name to make it optional: email?: string means 'email can be a string OR it can be left out entirely'. No ? means the property is required — you MUST provide it.",code:"interface User {\n  name: string;     // required\n  email?: string;   // optional (can be undefined)\n}\n\nconst user1: User = { name: 'Alice' };            // OK\nconst user2: User = { name: 'Bob', email: 'b@x' }; // also OK"},{t:"Catches Bugs Early",d:"Instead of finding errors at 3 AM in production, TypeScript finds them while you're coding. Pass a number where a string is expected? TypeScript tells you immediately. Studies show TypeScript prevents about 15% of bugs that would otherwise make it to production.",code:"function add(a: number, b: number): number {\n  return a + b;\n}\n\nadd(5, 3);      // OK → 8\n// add('5', 3); // Error at compile time!\n// Without TS: '5' + 3 = '53' — bug found at 3 AM in production!"},{t:"Compiles to JavaScript",d:"Browsers don't understand TypeScript directly. Your .ts files get compiled (translated) into regular .js files before running. The types are stripped away — they're only there to help YOU during development.",code:"// TypeScript (.ts)\nconst greet = (name: string): string => {\n  return 'Hello, ' + name;\n};\n\n// Compiles to JavaScript (.js) — types stripped!\nconst greet = (name) => {\n  return 'Hello, ' + name;\n};\n// Run: npx tsc myfile.ts"},{t:"Editor Autocomplete & IntelliSense",d:"TypeScript supercharges your code editor with intelligent autocompletion. When you type 'user.' your editor shows every available property and method with their types. This means less time reading documentation and fewer typos — your editor becomes a knowledgeable coding partner that knows your entire codebase.",code:"interface User {\n  name: string;\n  age: number;\n  email: string;\n}\n\nconst user: User = { name: 'Alice', age: 25, email: 'a@b.com' };\n\n// Type 'user.' and your editor suggests:\n// .name   .age   .email\n// No more guessing property names!"},{t:"Enums — Named Constants",d:"Enums let you define a set of named constants: enum Status { Active, Inactive, Pending }. Instead of using magic strings like 'active' scattered through your code, you use Status.Active — readable, refactorable, and your editor catches typos instantly. Enums make your code self-documenting.","code":"// Enums give names to sets of constants\nenum Direction {\n  Up = 'UP',\n  Down = 'DOWN',\n  Left = 'LEFT',\n  Right = 'RIGHT'\n}\n\nfunction move(dir: Direction) {\n  console.log('Moving:', dir);\n}\n\nmove(Direction.Up);    // 'Moving: UP'\nmove(Direction.Left);  // 'Moving: LEFT'\n// move('diagonal');    // Error! Not a valid Direction"}],whatIs:"TypeScript is a superset of JavaScript created by Microsoft. It adds static type checking — you declare what type of data each variable, parameter, and return value should be (string, number, boolean, etc.) and the compiler verifies you use them correctly. You also get interfaces to define object shapes, optional properties with ?, and much better editor autocomplete.",realWorld:"Almost every major company uses TypeScript now: Airbnb, Slack, Stripe, and more. NestJS is built entirely in TypeScript, and React has first-class TypeScript support.",code:`// JavaScript — no types, YOLO mode 🎲
function greet(name) {
...
# If ESLint finds errors → commit is BLOCKED! 🚫`,funFact:"The 'tabs vs spaces' debate has been going on since the 1960s. Prettier ended it by saying 'I don't care what you prefer, I'll format it MY way.' And everyone agreed because they were tired of arguing! 😂",quiz:[{q:"What does Husky do?",opts:["Pulls a sled","Runs scripts (like linting) before git commits to catch issues early","Barks at bad code","Replaces Docker"],ans:1},{q:"What's the purpose of ESLint?",opts:["Creating links between JavaScript files","Finding bugs and bad patterns in code","Linking CSS stylesheets","Linking databases"],ans:1},{q:"What does Prettier do?",opts:["Makes code look prettier to humans only","Auto-formats code consistently across the project","Creates CSS styles","Compresses code for production"],ans:1},{q:"What does an .editorconfig file ensure?",opts:["Consistent editor settings like indent size and line endings across different editors and IDEs","Faster code compilation","Automatic code deployment","Better Git integration"],ans:0},{q:"What is the 'prepare' script in package.json commonly used for with Husky?",opts:["Building the project","Automatically installing Git hooks when a developer runs npm install","Running tests","Starting the development server"],ans:1}],challenge:"Add ESLint + Prettier + Husky to a project. Make a deliberate formatting mistake, try to commit — watch Husky block it! Then fix it and commit successfully.",resources:[{type:"docs",title:"ESLint Getting Started",url:"https://eslint.org/docs/latest/use/getting-started",source:"ESLint Official"},{type:"docs",title:"Prettier Documentation",url:"https://prettier.io/docs/index.html",source:"Prettier Official"},{type:"video",title:"ESLint & Prettier Setup",url:"https://www.youtube.com/watch?v=SydnKbGc7W8",source:"Traversy Media"}],eli5:"Imagine your room is messy and you have to clean it yourself every day. Developer tools are like having a robot that tidies up automatically! ESLint spots things in the wrong place, Prettier makes everything neat, and Husky checks your room before you leave the house.",codeWalkthrough:["Comment: ESLint catches bugs automatically","Comment: ESLint configuration file name","Exporting the ESLint config as a module","Setting the parser to understand TypeScript syntax","Specifying TypeScript ESLint plugins to use","Opening the 'extends' array for preset rule collections","Using ESLint's recommended built-in rules","Adding TypeScript-specific recommended rules","Closing the extends array","Opening custom rules section","Unused variables cause an error - helps keep code clean","console.log triggers a warning - reminds you to remove debug logs","Using TypeScript 'any' type causes an error - forces proper types","Closing the rules section","Closing the config export","","Comment: Prettier formats code consistently","Comment: Prettier configuration file name","Opening the Prettier config object","Always add semicolons at end of statements","Use single quotes instead of double quotes","Use 2 spaces for indentation","Add trailing commas (helps with git diffs)","Wrap lines longer than 80 characters","Closing the Prettier config","","Comment: Husky runs checks before git commits","Comment: package.json configuration","Opening the package.json section","Opening the scripts section","The 'prepare' script sets up Husky hooks on npm install","Closing scripts","Opening lint-staged config - only checks files being committed","For TypeScript files: auto-fix ESLint, then auto-format with Prettier","For JSON and Markdown: just auto-format with Prettier","Closing lint-staged config","Closing the package.json section","","Comment: The actual Husky pre-commit hook file","Shebang line telling the system to use sh shell","Run lint-staged via npx when a commit is attempted","Comment: If ESLint finds errors, the commit is blocked!"],bugChallenge:{"code":"// .eslintrc.js\nmodule.exports = {\n  rules: {\n    'no-unused-vars': 'warning',\n  },\n};","hint":"ESLint rule severity levels have specific allowed string values...","answer":"The value 'warning' is not a valid ESLint severity. Valid values are 'off', 'warn', or 'error' (or 0, 1, 2). Fix: change 'warning' to 'warn'."},difficulty:"beginner",prereqs:[1,3,5]},
  ...
  {id:3,title:"Variables, Types & Arrays",subtitle:"The Building Blocks of Data",analogy:"Variables are like labeled boxes — each box holds ONE type of thing. Some boxes are permanent (const), some can be swapped out (let). Arrays are like containers that hold MANY boxes of the same type in order!",points:[{t:"const vs let vs var",d:"Use const by default — it can't be reassigned. Use let only when you NEED to change a variable. NEVER use var — it has weird bugs. Rule: const > let >> var (avoid var!)",code:"const name = 'Alice';   // can't reassign\nlet age = 25;           // can reassign\nage = 26;               // OK!\n// name = 'Bob';        // Error!\n\n// var is old-school — avoid it\nvar old = 'dont use';   // function-scoped, hoisted"},{t:"Primitive Types",d:"string (text), number (any number: int, decimal, negative), boolean (true/false), null (empty on purpose), undefined (not set yet), void (function returns nothing), never (function never finishes).",code:"const name: string = 'Alice';\nconst age: number = 25;\nconst isStudent: boolean = true;\nconst nothing: null = null;\nconst notSet: undefined = undefined;\n\n// TypeScript catches mistakes:\n// age = 'twenty'; // Error: string is not number"},{t:"Type Inference",d:"TypeScript guesses types for you! const name = 'John' → TS knows it's string. You only need to write types when it's NOT obvious.",code:"// TypeScript figures out the type automatically\nconst message = 'Hello'; // type: string (inferred)\nconst count = 42;        // type: number (inferred)\nconst items = [1, 2, 3]; // type: number[] (inferred)\n\n// You don't always need to write types!\nlet x = 10;   // TypeScript knows it's a number\n// x = 'hi';  // Error! Can't assign string to number"},{t:"Arrays and Array Methods",d:"Arrays hold multiple items: string[], number[]. Use .map() to transform, .filter() to select, .find() to search, .reduce() to combine, .some()/.every() to check conditions.",code:"const fruits: string[] = ['apple', 'banana', 'cherry'];\n\nfruits.push('date');         // add to end\nfruits.pop();                // remove from end\nfruits.includes('apple');    // true\nfruits.length;               // 3\n\n// Loop through\nfruits.forEach(f => console.log(f));"},{t:"Array Methods Deep Dive",d:"push/pop (add/remove), length (count), includes (check if exists), indexOf (find position), forEach (loop), map (transform each), filter (keep matches), find (first match), some/every (any/all match), reduce (combine to one value).",code:"const nums = [1, 2, 3, 4, 5];\n\n// map — transform each item\nconst doubled = nums.map(n => n * 2);     // [2, 4, 6, 8, 10]\n\n// filter — keep items that pass test\nconst evens = nums.filter(n => n % 2 === 0); // [2, 4]\n\n// find — first match\nconst found = nums.find(n => n > 3);      // 4\n\n// reduce — combine into single value\nconst sum = nums.reduce((acc, n) => acc + n, 0); // 15"},{t:"Map and Set Collections",d:"Map is like a dictionary (key → value lookup). Set is like a bag of unique stickers (no duplicates). Use Map for dynamic keys, Set to remove duplicates.",code:"// Map — key-value pairs (keys can be anything)\nconst scores = new Map<string, number>();\nscores.set('Alice', 95);\nscores.set('Bob', 87);\nconsole.log(scores.get('Alice')); // 95\n\n// Set — unique values only\nconst unique = new Set([1, 2, 2, 3, 3]);\nconsole.log(unique.size); // 3\nunique.add(4);\nunique.has(2); // true"},{t:"Object Utility Methods",d:"Object.keys() gets all keys, Object.values() gets all values, Object.entries() gets key-value pairs. Loop with for...of or .forEach().",code:"const user = { name: 'Alice', age: 25, role: 'dev' };\n\nObject.keys(user);    // ['name', 'age', 'role']\nObject.values(user);  // ['Alice', 25, 'dev']\nObject.entries(user);  // [['name','Alice'], ['age',25], ['role','dev']]\n\n// Loop through object\nfor (const [key, val] of Object.entries(user)) {\n  console.log(key, val);\n}"},{t:"Destructuring and Spread",d:"Unpack arrays and objects into variables: const [a, b] = arr or const {name, age} = user. Spread operator (...) merges arrays/objects: [...arr1, ...arr2]",code:"// Destructuring — unpack values\nconst { name, age } = { name: 'Alice', age: 25 };\nconst [first, ...rest] = [1, 2, 3, 4];\n// first = 1, rest = [2, 3, 4]\n\n// Spread — copy & merge\nconst base = { a: 1, b: 2 };\nconst extended = { ...base, c: 3 }; // { a: 1, b: 2, c: 3 }\n\nconst arr1 = [1, 2];\nconst arr2 = [...arr1, 3, 4]; // [1, 2, 3, 4]"}],whatIs:"Variables store data. TypeScript has primitive types (string, number, boolean) and collection types (arrays, Maps, Sets). Arrays are the most common way to store multiple items. Each type is strictly checked — you can't put a string where a number is expected.",realWorld:"Almost every program uses arrays constantly: shopping lists, user searches, data from databases. Array methods like map, filter, and reduce are so important they appear in interviews!",code:`// Variables — choose const by default
...
const [first, second] = fruits;  // first="apple", second="banana"`,funFact:"The .reduce() method is considered the most powerful array method. You can implement map, filter, and almost any other operation using reduce! Senior developers flex with it.",quiz:[{q:"What's the difference between const and let?",opts:["const is faster","const cannot be reassigned; let can","const is for objects, let is for primitives","There's no real difference"],ans:1},{q:"Which array method combines all items into ONE value?",opts:["map","filter","reduce","find"],ans:2},{q:"What does 'Set' guarantee that a regular array doesn't?",opts:["Faster access","No duplicate values","Better performance","Automatic sorting"],ans:1},{q:"What does TypeScript's type inference mean for developers?",opts:["You don't need to write types when TypeScript can automatically determine them from assigned values","TypeScript guesses randomly","You must always write explicit types","TypeScript ignores types entirely"],ans:0},{q:"What does the spread operator (...) do when used with arrays?",opts:["Deletes array items","Expands array elements or merges multiple arrays into a new one","Sorts array items","Creates typed arrays"],ans:1}],challenge:"Create an array of numbers [1-10]. Use array methods to: filter evens, map to double them, and reduce to sum. What's the result?",resources:[{type:"docs",title:"TypeScript Handbook - Everyday Types",url:"https://www.typescriptlang.org/docs/handbook/2/everyday-types.html",source:"TypeScript Official"},{type:"video",title:"JavaScript Arrays Explained",url:"https://www.youtube.com/watch?v=7W4pQQ20nJg",source:"Web Dev Simplified"},{type:"docs",title:"MDN Array Reference",url:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array",source:"MDN Web Docs"}],eli5:"Think of variables like labeled jars in your kitchen. One jar says 'cookies' and only holds cookies. Another says 'candies' and only holds candies. Arrays are like a cookie jar that holds MANY cookies in a row. You can count them, pick your favorite, or add more!",codeWalkthrough:["Comment: Use const by default for variables","Declaring a constant 'name' set to 'John' - cannot be reassigned","Declaring 'age' with let starting at 25 - CAN be changed","Reassigning age to 26 - allowed because we used let","","Comment: Basic TypeScript types","Explicitly typed string variable","Explicitly typed number variable","Explicitly typed boolean variable","Null type - intentionally empty","Undefined type - value not yet set","","Comment: Arrays hold multiple items of the same type","A string array with two fruit names","A number array with three numbers","","Comment: Array methods for manipulating arrays","push() adds 'cherry' to the end of the array","pop() removes and returns the last item","length tells how many items (2)","includes() checks if 'apple' is in the array (true)","indexOf() finds the position of 'banana' (index 1)","","Comment: Transform arrays with map","map() creates a new array by uppercasing each fruit","Comment: Result is ['APPLE', 'BANANA']","","Comment: Filter keeps only matching items","filter() keeps only fruits with more than 5 characters","Comment: Only 'banana' matches","","Comment: Find the first matching item","find() returns the first fruit starting with 'a'","Comment: Result is 'apple'","","Comment: Check if any or all items match","some() checks if at least one fruit equals 'apple' - true","every() checks if ALL fruits have more than 2 characters - true","","Comment: Reduce combines all items into one value","Creating a number array for reduce demo","reduce() adds all numbers starting from 0: result is 15","Comment: Final result is 15","","Comment: Map is a key-value dictionary","Creating a new Map with string keys and number values","Setting key 'math' to value 95","Getting value for key 'math' - returns 95","Checking if key 'math' exists - true","Getting the Map's size - 1 entry","","Comment: Set stores only unique values","Creating a new Set for strings","Adding 'javascript' to the set","Adding 'javascript' again - ignored because it's a duplicate!","Getting the set size - still 1","","Comment: Spread operator merges arrays","Array a with [1, 2]","Array b with [3, 4]","Spread both into a new merged array: [1, 2, 3, 4]","","Comment: Destructuring unpacks arrays into variables","Extracting first='apple' and second='banana' from the fruits array"],bugChallenge:{"code":"const age: string = 25;\nconst names: number[] = [\"Alice\", \"Bob\"];\nconsole.log(age, names);","hint":"Look at the types assigned versus the actual values...","answer":"Two type mismatches: 'age' is typed as string but assigned number 25, and 'names' is typed as number[] but contains strings. Fix: change to 'age: number = 25' and 'names: string[] = [\"Alice\", \"Bob\"]'."},difficulty:"beginner",prereqs:[1]},
  ...
  {id:4,title:"Objects & Interfaces",subtitle:"Structuring Complex Data",analogy:"Objects are like student ID cards — they have labeled fields (name, age, email). Interfaces are like the ID card DESIGN — they say 'every card MUST have these fields with these types.' Separate objects follow the same design!",points:[{t:"Objects as Key-Value Bags",d:"Objects store multiple pieces of info about ONE thing. { name: 'John', age: 25, email: 'j@m.com' }. Access with dot notation: user.name or user['name'].",code:"const user = {\n  name: 'Alice',\n  age: 25,\n  isActive: true,\n};\n\nconsole.log(user.name);     // 'Alice'\nconsole.log(user['age']);   // 25\nuser.age = 26;              // update value"},{t:"Interfaces Define Shapes",d:"interface User { name: string; age: number; } tells TypeScript 'a User MUST have name and age with these types.' Any object claiming to be a User must match this shape.",code:"interface User {\n  name: string;\n  age: number;\n  email: string;\n}\n\nconst alice: User = {\n  name: 'Alice',\n  age: 25,\n  email: 'alice@example.com',\n};\n// Missing a field? TypeScript yells at you!"},{t:"Optional Properties with ?",d:"interface User { name: string; email?: string } means email CAN be missing. Required = must exist. Optional = might not exist.",code:"interface User {\n  name: string;      // required\n  age: number;       // required\n  email?: string;    // optional!\n}\n\nconst user1: User = { name: 'Alice', age: 25 }; // OK!\nconst user2: User = { name: 'Bob', age: 30, email: 'bob@test.com' }; // also OK!"},{t:"Readonly Properties",d:"interface Config { readonly apiUrl: string } means you can READ it but never CHANGE it. Great for constants!",code:"interface Config {\n  readonly apiUrl: string;\n  readonly port: number;\n}\n\nconst config: Config = { apiUrl: 'https://api.com', port: 3000 };\n// config.port = 8080; // Error! Cannot assign to 'port' because it is read-only"},{t:"Type vs Interface",d:"Both define shapes but use them differently: interface for objects (most common), type for unions/literals/functions. Interface can be extended; type uses intersection (&).",code:"// Interface — extendable, best for objects\ninterface Animal {\n  name: string;\n}\ninterface Dog extends Animal {\n  breed: string;\n}\n\n// Type — more flexible, can do unions\ntype Status = 'active' | 'inactive';\ntype StringOrNumber = string | number;\n\n// Both work for objects, but interface is preferred"},{t:"Extending Interfaces",d:"interface Dog extends Animal { breed: string } means Dog has everything Animal has PLUS breed. Inheritance = less repetition!",code:"interface Animal {\n  name: string;\n  age: number;\n}\n\ninterface Dog extends Animal {\n  breed: string;    // Dog has name + age + breed\n}\n\ninterface ServiceDog extends Dog {\n  task: string;     // ServiceDog has all of the above + task\n}\n\nconst buddy: ServiceDog = {\n  name: 'Buddy', age: 3, breed: 'Lab', task: 'guide'\n};"},{t:"Nested Interfaces",d:"Objects inside objects: { user: { name: string; address: { city: string; country: string } } }. Build complex shapes by nesting!",code:"interface Address {\n  street: string;\n  city: string;\n  country: string;\n}\n\ninterface User {\n  name: string;\n  address: Address;   // nested interface!\n}\n\nconst user: User = {\n  name: 'Alice',\n  address: { street: '123 Main', city: 'NYC', country: 'US' },\n};"},{t:"Index Signatures for Dynamic Keys",d:"interface Colors { [key: string]: string } means you can have ANY string key with string values. Perfect when keys aren't known in advance!",code:"// When you don't know all key names in advance\ninterface StringMap {\n  [key: string]: number;   // any string key → number value\n}\n\nconst scores: StringMap = {};\nscores.math = 95;          // OK\nscores.science = 88;       // OK\nscores['english'] = 92;    // OK\n// scores.art = 'good';    // Error! Must be number"}],whatIs:"Objects are collections of key-value pairs. Interfaces define the expected shape of an object — what properties it must have and their types. A well-defined interface prevents bugs by ensuring objects have the required structure.",realWorld:"Every API response is an object. Every database record is an object. Learning to design good interfaces is one of the most important skills in TypeScript!",code:`// Simple object
const user = {
  name: "John",
  age: 25,
  email: "john@mail.com"
...
const colors: ColorMap = {
  ...
  {id:5,title:"Functions & Arrow Functions",subtitle:"Reusable Recipes of Code",analogy:"A function is like a vending machine — you press a button (pass arguments), gears turn inside (logic runs), and a snack drops out (return value). Arrow functions are the sleek, touchscreen version of the same machine. Same snacks, less bulk!",points:[{t:"Function Declarations",d:"The traditional way to define functions: function add(a: number, b: number): number { return a + b; }. Function declarations are hoisted, meaning you can call them before they appear in the code. They are verbose but very clear and readable for beginners learning the basics.",code:"// Named function\nfunction greet(name: string): string {\n  return 'Hello, ' + name;\n}\n\nconsole.log(greet('Alice')); // 'Hello, Alice'"},{t:"Arrow Functions — The Modern Way",d:"The modern shorthand: const add = (a: number, b: number): number => a + b. Arrow functions are shorter and used everywhere in modern JavaScript and React. If the body is a single expression, you can skip the curly braces and return keyword. They also do not bind their own 'this' context.",code:"// Arrow function (same thing, shorter syntax)\nconst greet = (name: string): string => {\n  return 'Hello, ' + name;\n};\n\n// One-liner (implicit return)\nconst double = (n: number): number => n * 2;\nconsole.log(double(5)); // 10"},{t:"Optional & Default Parameters",d:"function greet(name: string, title?: string) {} means title is optional — callers can skip it. Use defaults for common values: function greet(name: string, greeting = 'Hello') {} means greeting defaults to 'Hello' if not provided. This reduces boilerplate and makes your API flexible.",code:"// Optional parameter (may be undefined)\nfunction greet(name: string, title?: string): string {\n  return title ? title + ' ' + name : name;\n}\ngreet('Alice');          // 'Alice'\ngreet('Alice', 'Dr.');   // 'Dr. Alice'\n\n// Default parameter (has a fallback)\nfunction hello(name: string, greeting = 'Hello') {\n  return greeting + ', ' + name;\n}\nhello('Bob');           // 'Hello, Bob'\nhello('Bob', 'Hey');    // 'Hey, Bob'"},{t:"Rest Parameters (...args)",d:"The three dots collect ALL remaining arguments into an array: function sum(...numbers: number[]): number {}. Call it with sum(1,2,3,4,5) and numbers becomes [1,2,3,4,5]. This is flexible because you can pass any number of arguments without defining each one separately in the signature.",code:"// Accept any number of arguments\nfunction sum(...nums: number[]): number {\n  return nums.reduce((total, n) => total + n, 0);\n}\n\nconsole.log(sum(1, 2));          // 3\nconsole.log(sum(1, 2, 3, 4, 5)); // 15"},{t:"Function Types",d:"type MathFn = (a: number, b: number) => number; describes a function's shape — its parameters and return type. You can use this type to ensure variables and parameters hold functions with the correct signature: const add: MathFn = (a,b) => a+b. TypeScript verifies the assignment matches.",code:"// Define what a function looks like\ntype MathFn = (a: number, b: number) => number;\n\nconst add: MathFn = (a, b) => a + b;\nconst multiply: MathFn = (a, b) => a * b;\n\nconsole.log(add(2, 3));      // 5\nconsole.log(multiply(2, 3)); // 6"},{t:"Callbacks — Passing Functions",d:"A callback is a function passed as an argument to another function: function doMath(a: number, b: number, operation: MathFn) {}. The receiving function calls it back at the right time. Callbacks are the foundation of event handlers, array methods like map and filter, and asynchronous patterns.",code:"// A callback is a function passed to another function\nfunction doMath(a: number, b: number, operation: (x: number, y: number) => number) {\n  return operation(a, b);\n}\n\ndoMath(5, 3, (a, b) => a + b);  // 8\ndoMath(5, 3, (a, b) => a * b);  // 15\n\n// Common: array methods use callbacks\n[1, 2, 3].map(n => n * 2);      // [2, 4, 6]"},{t:"Function Overloads",d:"function format(value: string): string; function format(value: number): string; — same function name with different parameter types. TypeScript picks the right overload automatically based on what you pass, giving you precise return types for each call. Useful for utility functions that accept multiple input types.",code:"// Different parameter types → different return types\nfunction format(value: string): string;\nfunction format(value: number): string;\nfunction format(value: string | number): string {\n  if (typeof value === 'string') return value.toUpperCase();\n  return value.toFixed(2);\n}\n\nformat('hello');  // 'HELLO'\nformat(3.14159); // '3.14'"},{t:"Closures — Functions with Memory",d:"A closure is a function that remembers variables from its outer scope even after that scope has finished executing. For example, a counter function that returns an increment function — the inner function closes over the count variable and keeps it alive between calls. Closures power many JavaScript patterns.",code:"function createCounter() {\n  let count = 0; // private variable\n  return function() {\n    count++;\n    return count;\n  };\n}\n\nconst counter = createCounter();\nconsole.log(counter()); // 1\nconsole.log(counter()); // 2\nconsole.log(counter()); // 3\n// count is 'remembered' between calls!"},{t:"Pure Functions & Side Effects",d:"A pure function always returns the same output for the same input and changes nothing outside itself. Functions that modify global state, write to a database, or log to the console have side effects. Keeping functions pure makes your code predictable, testable, and easier to debug in large applications.",code:"// Pure function — same input always gives same output\nfunction add(a: number, b: number): number {\n  return a + b; // no side effects!\n}\n\n// Impure function — modifies external state\nlet total = 0;\nfunction addToTotal(n: number): number {\n  total += n; // side effect: changes external variable\n  return total;\n}\n\nconsole.log(add(2, 3)); // always 5\nconsole.log(add(2, 3)); // always 5\nconsole.log(addToTotal(5)); // 5\nconsole.log(addToTotal(5)); // 10 — different result!"}],whatIs:"Functions are reusable blocks of code. They take input (parameters), do work, and return output. TypeScript requires you to specify parameter types and return types. Arrow functions are shorter syntax for the same thing.",realWorld:"Almost every function you write will be an arrow function. They're so common in React (hooks, event handlers) that you'll type => a hundred times a day!",code:`// Named function — traditional way
function add(a: number, b: number): number {
  return a + b;
}
...
// After:  import { helper } from '@shared/utils/helper';`,funFact:"JavaScript originally had NO module system at all. Every script shared the same global scope. This led to chaos until CommonJS (2009) and ES Modules (2015) brought order to the madness.",quiz:[{q:"What is the difference between named and default exports?",opts:["Named exports are faster","You can have multiple named exports but only one default export per file","Default exports are deprecated","There is no difference"],ans:1},{q:"What is a barrel file (index.ts)?",opts:["A file that stores binary data","A file that re-exports from multiple files for cleaner imports","A file that contains test data","A configuration file for npm"],ans:1},{q:"What does a dynamic import do?",opts:["Imports faster than static imports","Loads a module on-demand at runtime instead of upfront","Creates a new module from scratch","Imports from the internet"],ans:1},{q:"What does tree shaking accomplish in a JavaScript bundler?",opts:["Automatically removes unused exported code from the final production bundle","Sorts import statements alphabetically","Reorganizes the project directory structure","Shakes out syntax errors from the code"],ans:0},{q:"What is a path alias like @utils/helpers useful for?",opts:["Making imports slower","Replacing fragile deep relative paths with clean readable imports that don't break when files move","Creating new npm packages","Aliasing database tables"],ans:1}],challenge:"Create three files: math.ts (export add, multiply), string-utils.ts (export capitalize, reverse), and an index.ts barrel file that re-exports everything. Import from the barrel file in app.ts!",resources:[{type:"docs",title:"MDN JavaScript Modules",url:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules",source:"MDN Web Docs"},{type:"docs",title:"TypeScript Modules",url:"https://www.typescriptlang.org/docs/handbook/2/modules.html",source:"TypeScript Official"},{type:"video",title:"JavaScript Modules in 100 Seconds",url:"https://www.youtube.com/watch?v=cRHQNNcYf6s",source:"Fireship"}],eli5:"Imagine your toys are scattered everywhere. Modules are like labeled toy boxes - one for cars, one for dolls, one for blocks. When you want to play with cars, just open the car box! You can also share your favorite toy with a friend by lending it out (exporting).",codeWalkthrough:["--- Named Exports ---","math.ts","Exporting for use in other files","Exporting for use in other files","","app.ts","Importing required dependencies","Printing output to the console","Printing output to the console","","--- Default Export ---","Logger.ts","Exporting for use in other files","","Closing block","","app.ts","Importing required dependencies","Declaring a variable","","","--- Barrel File (index.ts) ---","users/index.ts","Exporting for use in other files","Exporting for use in other files","Exporting for use in other files","","Now import everything from one place:","Importing required dependencies","","--- Dynamic Import (lazy loading) ---","Declaring a variable","Declaring a variable","Returning a value","Closing block","","--- Path Aliases (tsconfig.json) ---","Before: import { helper } from '../../../shared/utils/helper';","After:  import { helper } from '@shared/utils/helper';"],bugChallenge:{"code":"// math.ts\nexport default const add = (a: number, b: number) => a + b;\nexport default const subtract = (a: number, b: number) => a - b;","hint":"How many default exports can a single file have?","answer":"A file can only have ONE default export, but this file tries to have two. Fix: use named exports (remove 'default') or keep only one as default."},difficulty:"beginner",prereqs:[1,5]},
  ...
  {id:7,title:"Union Types & Type Narrowing",subtitle:"Being Flexible While Safe",analogy:"A union type is like a parking spot that accepts 'cars OR motorcycles.' Type narrowing is like checking WHICH vehicle is parked there before trying to ride it. You narrow down the possibilities until you KNOW what type it is!",points:[{t:"Union Types (|)",d:"A variable that can be ONE of several types: string | number means it could be EITHER. Super flexible! Use when a function needs to handle multiple types.",code:"// A variable that can be multiple types\nlet id: string | number;\nid = 'abc';   // OK\nid = 123;     // also OK\n// id = true; // Error! boolean not allowed\n\nfunction printId(id: string | number) {\n  console.log('ID:', id);\n}"},{t:"Literal Unions",d:"type Status = 'active' | 'inactive' | 'banned'; only these EXACT values allowed. Typo like 'activated'? Error! Much safer than plain strings.",code:"// Only specific values allowed\ntype Direction = 'up' | 'down' | 'left' | 'right';\ntype DiceRoll = 1 | 2 | 3 | 4 | 5 | 6;\n\nlet dir: Direction = 'up';   // OK\n// dir = 'diagonal';         // Error!\n\nlet roll: DiceRoll = 3;     // OK\n// roll = 7;                 // Error!"},{t:"Type Narrowing with typeof",d:"if (typeof id === 'string') { /* handle string */ } else { /* handle number */ }. After the check, TypeScript KNOWS which type it is in each branch.",code:"function format(value: string | number): string {\n  if (typeof value === 'string') {\n    return value.toUpperCase(); // TS knows it's string here\n  }\n  return value.toFixed(2);      // TS knows it's number here\n}"},{t:"Truthiness Narrowing",d:"if (user) { /* user is NOT null/undefined */ }. TypeScript narrows nullable types. Check if a value is truthy to eliminate null/undefined.",code:"function greet(name: string | null) {\n  if (name) {\n    // TypeScript knows name is string here (not null)\n    console.log('Hello, ' + name.toUpperCase());\n  } else {\n    console.log('Hello, stranger\!');\n  }\n}"},{t:"The 'in' Operator",d:"if ('swim' in animal) { /* animal has swim property */ }. Check if object has a property to narrow union types. Great for discriminating between object types!",code:"interface Cat { meow(): void; }\ninterface Dog { bark(): void; }\n\nfunction speak(pet: Cat | Dog) {\n  if ('meow' in pet) {\n    pet.meow();  // TS knows it's Cat\n  } else {\n    pet.bark();  // TS knows it's Dog\n  }\n}"},{t:"instanceof for Classes",d:"if (value instanceof Date) { /* it's a Date */ }. Check if something is an instance of a class. Works with custom classes too!",code:"class ApiError extends Error {\n  statusCode: number;\n  constructor(status: number, msg: string) {\n    super(msg);\n    this.statusCode = status;\n  }\n}\n\nfunction handleError(err: Error) {\n  if (err instanceof ApiError) {\n    console.log(err.statusCode); // TS knows it's ApiError\n  } else {\n    console.log(err.message);    // plain Error\n  }\n}"},{t:"Intersection Types (&)",d:"type Combined = A & B means BOTH types at once. Must have all properties from A AND all properties from B. Useful for combining interfaces.",code:"interface HasName { name: string; }\ninterface HasAge { age: number; }\n\n// Combine both — must have ALL properties\ntype Person = HasName & HasAge;\n\nconst person: Person = {\n  name: 'Alice',\n  age: 25,\n  // Must have both name AND age\!\n};"},{t:"Exhaustiveness Checking",d:"Use unions with switch to handle ALL cases. If you forget a case, TypeScript errors! Perfect for state machines and enums.",code:"type Shape = 'circle' | 'square' | 'triangle';\n\nfunction area(shape: Shape) {\n  switch (shape) {\n    case 'circle':   return 'pi * r^2';\n    case 'square':   return 'side^2';\n    case 'triangle': return '0.5 * b * h';\n    default:\n      // If you add a new shape but forget a case,\n      // TypeScript will error here!\n      const _never: never = shape;\n      return _never;\n  }\n}"}],whatIs:"Union types let variables be multiple types. Type narrowing means checking 'what type is it RIGHT NOW?' in different code branches. After you narrow, TypeScript knows the specific type and prevents type errors.",realWorld:"Union types power real-world features: API responses (success | error), user states (loggedIn | loggedOut), form status (idle | loading | error | success).",code:`// Union type — string OR number
let id: string | number;
id = "abc";    // OK
id = 123;      // OK
// id = true;  // ERROR!
...
function handle(result: Result) {
  ...
  {id:8,title:"Classes & OOP",subtitle:"Organizing Code Into Objects",analogy:"A class is like a 3D printer mold. The mold defines the shape — every figure that comes out has the same structure (properties) and movable joints (methods). Objects are the printed figures. Change the mold, and every future figure changes. OOP is designing great molds!",points:[{t:"Classes = Blueprints",d:"class User { name: string; constructor(n: string) { this.name = n; } }. Define ONCE, create MANY objects from it.",code:"class Car {\n  brand: string;\n  speed: number;\n\n  constructor(brand: string) {\n    this.brand = brand;\n    this.speed = 0;\n  }\n}\n\nconst myCar = new Car('Toyota');\nconsole.log(myCar.brand); // 'Toyota'"},{t:"Constructor — the Setup",d:"constructor(name: string) { this.name = name; } runs automatically when you do new User('John'). It initializes the object.",code:"class User {\n  // Shorthand: declare + assign in constructor\n  constructor(\n    public name: string,\n    public email: string,\n    public age: number,\n  ) {}\n}\n\nconst user = new User('Alice', 'alice@mail.com', 25);\nconsole.log(user.name); // 'Alice'"},{t:"Properties & Methods",d:"Properties store data. Methods are functions. A User has name (property) and greet() (method). Properties = nouns. Methods = verbs!",code:"class Calculator {\n  result = 0;  // property\n\n  add(n: number): this {\n    this.result += n;\n    return this; // enables chaining\n  }\n\n  reset(): void {\n    this.result = 0;\n  }\n}\n\nconst calc = new Calculator();\ncalc.add(5).add(3); // chaining!\nconsole.log(calc.result); // 8"},{t:"Access Modifiers: public/private/protected",d:"public (default) = anyone accesses. private = only THIS class. protected = this class + child classes. Use private to hide implementation details!",code:"class BankAccount {\n  public owner: string;          // anyone can access\n  private balance: number;       // only this class\n  protected accountType: string; // this class + subclasses\n\n  constructor(owner: string) {\n    this.owner = owner;\n    this.balance = 0;\n    this.accountType = 'checking';\n  }\n\n  deposit(amount: number) { this.balance += amount; }\n  getBalance() { return this.balance; }\n}\n\nconst acc = new BankAccount('Alice');\nacc.owner;       // OK\n// acc.balance;   // Error! Private"},{t:"Readonly — Can't Change",d:"readonly id: string means you can READ it but never MODIFY it. Great for IDs and timestamps that should never change.",code:"class Config {\n  readonly apiUrl: string;\n  readonly maxRetries: number;\n\n  constructor(url: string, retries: number) {\n    this.apiUrl = url;        // OK in constructor\n    this.maxRetries = retries;\n  }\n}\n\nconst config = new Config('https://api.com', 3);\n// config.apiUrl = 'new';  // Error! readonly"},{t:"Inheritance with extends",d:"class Dog extends Animal { } means Dog is an Animal PLUS extra stuff. Dog gets ALL of Animal's properties and methods.",code:"class Animal {\n  constructor(public name: string) {}\n  speak() { return this.name + ' makes a sound'; }\n}\n\nclass Dog extends Animal {\n  speak() { return this.name + ' barks!'; } // override\n  fetch() { return this.name + ' fetches the ball'; }\n}\n\nconst dog = new Dog('Rex');\ndog.speak();  // 'Rex barks!'\ndog.fetch();  // 'Rex fetches the ball'"},{t:"Implements Interface",d:"class Report implements Printable { } means Report promises to have everything Printable requires. TypeScript checks it!",code:"interface Printable {\n  print(): string;\n}\n\ninterface Loggable {\n  log(): void;\n}\n\nclass Report implements Printable, Loggable {\n  print() { return 'Report content'; }\n  log() { console.log('Report logged'); }\n}\n\n// Must implement ALL methods from ALL interfaces!"},{t:"Abstract Classes",d:"abstract class Shape { abstract area(): number; } cannot create Shape directly — MUST extend it. Forces child classes to implement abstract methods!",code:"abstract class Shape {\n  abstract area(): number;  // subclass MUST implement\n\n  describe(): string {      // shared method\n    return 'Area is ' + this.area();\n  }\n}\n\nclass Circle extends Shape {\n  constructor(public radius: number) { super(); }\n  area() { return Math.PI * this.radius ** 2; }\n}\n\n// const s = new Shape(); // Error! Can't instantiate abstract\nconst c = new Circle(5);\nc.describe(); // 'Area is 78.54...'"}],whatIs:"Classes bundle data (properties) and actions (methods) together. TypeScript adds access modifiers (public/private/protected) to control visibility. Inheritance lets classes extend parent classes. The 4 pillars of OOP are encapsulation, inheritance, polymorphism, and abstraction.",realWorld:"NestJS services are classes. React class components are classes. Every enterprise app uses classes to organize business logic!",code:`// Simple class
class User {
  name: string;
  age: number;
...
c.area();       // ~78.54`,funFact:"The 4 Pillars of OOP: Encapsulation (hiding details), Inheritance (extending classes), Polymorphism (same method, different behavior), Abstraction (simplifying complexity). Master these and you master OOP!",quiz:[{q:"What does 'new User()' do?",opts:["Creates a copy of the User class","Calls the constructor and creates a User object","Deletes the User class","Makes User public"],ans:1},{q:"What's the difference between public and private?",opts:["public is faster","public can be accessed from anywhere; private only in that class","They're the same thing","private is more secure"],ans:1},{q:"What does 'extends' do?",opts:["Adds more memory","Creates a child class that inherits from parent","Extends the file size","Extends the type system"],ans:1},{q:"What does the shorthand constructor 'constructor(public name: string)' do in TypeScript?",opts:["Automatically creates and assigns the this.name property, reducing boilerplate code","Only declares a parameter without creating a property","Makes the constructor faster","Creates a static property"],ans:0},{q:"What is the key difference between abstract methods and regular methods in an abstract class?",opts:["There is no difference","Abstract methods have no implementation body and MUST be implemented by child classes","Abstract methods are faster","Regular methods cannot be overridden"],ans:1}],challenge:"Create a class hierarchy: Animal (with speak method), then Dog and Cat that override it. Create instances and call speak on each!",resources:[{type:"docs",title:"MDN JavaScript Classes",url:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes",source:"MDN Web Docs"},{type:"docs",title:"TypeScript Classes",url:"https://www.typescriptlang.org/docs/handbook/2/classes.html",source:"TypeScript Official"},{type:"video",title:"Object Oriented Programming in JavaScript",url:"https://www.youtube.com/watch?v=PFmuCDHHpwk",source:"Fireship"}],eli5:"A class is like a cookie cutter. The cookie cutter (class) is the shape, and each cookie you make (object) looks the same but can have different sprinkles. You design the cutter once, then stamp out as many cookies as you want!",codeWalkthrough:["Simple class","Declaring a class","","","","","","","Closing block","","","Returning a value","Closing block","Closing block","","Declaring a variable","","","Shorthand constructor (more common!)","Declaring a class","","","","","","Closing block","","Access modifiers","Declaring a class","","","","","","","","","","","Closing block","","","Returning a value","Closing block","Closing block","","Declaring a variable","","u.password;  // ERROR — private","u.id = \"x\";  // ERROR — readonly","","Inheritance","Declaring a class","","","","Returning a value","Closing block","Closing block","","Declaring a class","","","Closing block","","Override parent method","","Returning a value","Closing block","Closing block","","Declaring a variable","","","Implements interface","Defining an interface shape","","Closing block","","Declaring a class","","Printing output to the console","Closing block","Closing block","","Abstract class","","","","Grouping related tests together","Returning a value","Closing block","Closing block","","Declaring a class","","","Closing block","","","Returning a value","Closing block","Closing block","","const s = new Shape();     // ERROR — cannot create abstract","Declaring a variable",""],bugChallenge:{"code":"class Dog {\n  private name: string;\n  constructor(name: string) {\n    this.name = name;\n  }\n}\nconst dog = new Dog(\"Rex\");\nconsole.log(dog.name);","hint":"Check the access modifier on the name property...","answer":"The property 'name' is private, so dog.name cannot be accessed outside the class. Fix: change 'private' to 'public', or add a public getName() method."},difficulty:"intermediate",prereqs:[1,4,5]},
  ...
  {id:9,title:"Async/Await & Promises",subtitle:"Handling Work That Takes Time",analogy:"A Promise is like ordering pizza. You get a receipt (Promise) immediately. Pizza isn't ready yet — it's PENDING. Later: Pizza arrives (FULFILLED) or they call saying it's cancelled (REJECTED). async/await is a cleaner way to handle pizza than the old .then() way!",points:[{t:"Promise States: Pending → Fulfilled → Rejected",d:"PENDING: waiting. FULFILLED: got the value. REJECTED: error happened. A Promise is always in one of these states.",code:"// A Promise is like ordering food:\nconst order = new Promise((resolve, reject) => {\n  // Pending... (waiting for food)\n  const success = true;\n  if (success) resolve('Pizza ready!');  // Fulfilled\n  else reject('Kitchen closed');         // Rejected\n});\n\norder.then(food => console.log(food));   // 'Pizza ready!'"},{t:"async/await — The Modern Way",d:"async function getName() { const name = await fetch(...); return name; } — await means 'pause here and wait for the Promise.' async functions always return Promises.",code:"// async makes a function return a Promise\n// await pauses until the Promise resolves\nasync function getUser(id: number) {\n  const response = await fetch('/api/users/' + id);\n  const user = await response.json();\n  return user; // automatically wrapped in Promise\n}\n\n// Usage\nconst user = await getUser(1);"},{t:"try/catch/finally — Error Handling",d:"try { await mayFail(); } catch(e) { console.error(e); } finally { cleanup(); } — same as other languages. finally ALWAYS runs.",code:"async function fetchData() {\n  try {\n    const res = await fetch('/api/data');\n    const data = await res.json();\n    return data;\n  } catch (error) {\n    console.error('Failed:', error);\n    return null;\n  } finally {\n    console.log('Done!'); // always runs\n  }\n}"},{t:"Promise.all — Parallel Execution",d:"await Promise.all([promise1, promise2, promise3]) runs ALL at once. If any fails, all fail. 10x faster than running them one-by-one!",code:"// Run multiple async tasks at the same time!\nconst [users, posts, comments] = await Promise.all([\n  fetch('/api/users').then(r => r.json()),\n  fetch('/api/posts').then(r => r.json()),\n  fetch('/api/comments').then(r => r.json()),\n]);\n// All 3 fetched simultaneously — much faster than sequential!"},{t:"Custom Error Classes",d:"throw new Error('message') or throw new CustomError(). Catch with catch(error). Better error handling than undefined/null.",code:"// Custom error class for better error handling\nclass ApiError extends Error {\n  constructor(\n    public statusCode: number,\n    message: string,\n  ) {\n    super(message);\n    this.name = 'ApiError';\n  }\n}\n\nasync function fetchUser(id: number) {\n  const res = await fetch(`/api/users/${id}`);\n  if (res.status === 404) throw new ApiError(404, 'User not found');\n  if (!res.ok) throw new ApiError(res.status, 'API failed');\n  return res.json();\n}\n\ntry {\n  await fetchUser(999);\n} catch (e) {\n  if (e instanceof ApiError) console.log(e.statusCode); // 404\n}"},{t:".then/.catch — Old Way (Know It!)",d:"promise.then(value => {}).catch(error => {}) — works but gets messy with chains. Use async/await instead! But you'll see this in old code.",code:"// Promise chain (before async/await existed)\nfetch('/api/users')\n  .then(response => response.json())\n  .then(users => {\n    console.log(users);\n    return fetch('/api/posts');\n  })\n  .then(response => response.json())\n  .catch(error => console.error('Error:', error));"},{t:"Promise.race",d:"await Promise.race([promise1, promise2]) — whichever promise finishes FIRST wins, and the rest are ignored. This is perfect for implementing timeouts: race your API call against a timer, and if the timer wins, you know the request took too long!",code:"// First one to finish wins!\nconst result = await Promise.race([\n  fetch('/api/fast-server'),\n  fetch('/api/slow-server'),\n  new Promise((_, reject) =>\n    setTimeout(() => reject('Timeout!'), 5000)\n  ),\n]);\n// Returns whichever resolves OR rejects first"},{t:"Throw vs Return in async",d:"throw new Error() in an async function makes the Promise reject. Return a value makes it fulfill. Choose wisely!",code:"async function validate(input: string) {\n  if (!input) throw new Error('Empty!');  // rejects the promise\n  return input.trim();                     // resolves the promise\n}\n\n// throw = Promise.reject()\n// return = Promise.resolve()\n\ntry {\n  await validate('');\n} catch (e) {\n  console.log(e.message); // 'Empty!'\n}"}],whatIs:"Promises represent values that don't exist yet but will in the future. async/await is syntax sugar that makes Promises feel like normal code. It's the standard way to handle asynchronous work (API calls, file reads, timeouts).",realWorld:"Every API call is a Promise. React Query wraps Promises. You'll use async/await multiple times every day!",code:`// Promise states
...
// whichever completes first is returned!`,funFact:"Promises were inspired by other languages' Futures (Dart) and Completable Futures (Java). async/await was added to make Promises feel like normal synchronous code!",quiz:[{q:"What does 'await' do?",opts:["Makes code faster","Pauses execution and waits for Promise to finish","Avoids running code","Skips to the next line"],ans:1},{q:"What's the advantage of Promise.all over sequential awaits?",opts:["It's more readable","It runs Promises in parallel instead of one-by-one — much faster!","It's required by React","No real difference"],ans:1},{q:"What always runs in try/catch/finally?",opts:["try block","catch block","finally block","depends on errors"],ans:2},{q:"What happens when one promise in Promise.all() rejects?",opts:["The entire Promise.all() rejects immediately, even if other promises succeeded","Only the failed promise is skipped","All promises continue running","It retries the failed promise automatically"],ans:0},{q:"What does Promise.race() return?",opts:["All promise results in an array","The result of the slowest promise","The result of whichever promise settles first, whether fulfilled or rejected","Only successful promises"],ans:2}],challenge:"Create async functions that each take 1 second. Run 5 of them sequentially (measures time), then in parallel with Promise.all. How much faster?",resources:[{type:"docs",title:"MDN Async/Await",url:"https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Async_JS/Promises",source:"MDN Web Docs"},{type:"video",title:"JavaScript Promises in 100 Seconds",url:"https://www.youtube.com/watch?v=RvYYCGs45L4",source:"Fireship"},{type:"docs",title:"MDN Using Promises",url:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises",source:"MDN Web Docs"}],eli5:"Imagine ordering a toy online. You don't get it right away - you get a tracking number (Promise). You can wait by the door all day (old way) or go play and someone tells you when it arrives (async/await). Much better!",codeWalkthrough:["Promise states","Declaring a variable","PENDING: waiting for response","then either:","FULFILLED: response arrived","REJECTED: network error","","async/await — the clean way! ✨","Declaring a function","Opening try block for error handling","Declaring a variable","Declaring a variable","Printing output to the console","Returning a value","Catching any errors from the try block","","handle error","Finally block - runs regardless of success or failure","Printing output to the console","Closing block","Closing block","","Call async function","Declaring a variable","","Multiple async operations","Declaring a function","Declaring a variable","Declaring a variable","Total time: 2sec + 2sec = 4 seconds ⏳","Returning a value","Closing block","","Promise.all — parallel execution! 🚀","Declaring a function","Declaring a variable","","","","","All run at SAME TIME!","Total time: 2 seconds (instead of 6!) ⚡","Returning a value","Closing block","",".then/.catch (old way — avoid!)","","Method chaining on the previous expression","Method chaining on the previous expression","Method chaining on the previous expression","Gets messy with more steps!","","Throwing errors in async","Declaring a function","Conditional check","Throwing an error","Closing block","Returning a value","Closing block","","Promise.race — first to finish wins","Declaring a variable","","","","","whichever completes first is returned!"],bugChallenge:{"code":"function getUser() {\n  const user = await fetch(\"/api/user\");\n  return user.json();\n}","hint":"What keyword is missing from the function declaration?","answer":"You can only use 'await' inside an 'async' function, but this function is not declared as async. Fix: change 'function getUser()' to 'async function getUser()'."},difficulty:"intermediate",prereqs:[1,5]},
  ...
  {id:10,title:"Error Handling",subtitle:"Catching Problems Before They Crash",analogy:"Error handling is like a safety net under a trapeze artist. The artist (your code) performs amazing feats, but sometimes things go wrong mid-air. Without a safety net (try/catch), they crash to the ground (app crashes). With it, they bounce back and the show goes on!",points:[{t:"try/catch/finally",d:"Wrap risky code in try { }. If it fails, catch(error) { } runs instead of crashing. finally { } runs no matter what — perfect for cleanup like closing connections.",code:"try {\n  const data = JSON.parse('{invalid json}');\n} catch (error) {\n  console.error('Parse failed:', error.message);\n} finally {\n  console.log('Cleanup here'); // always runs\n}"},{t:"Error Types",d:"TypeError (wrong type), ReferenceError (variable not found), SyntaxError (bad code), RangeError (out of bounds). Each tells you WHAT went wrong.",code:"// Built-in error types\nnew Error('generic error');\nnew TypeError('expected string, got number');\nnew RangeError('index out of bounds');\nnew SyntaxError('unexpected token');\nnew ReferenceError('x is not defined');\n\n// Check error type\ntry { /* ... */ } catch (e) {\n  if (e instanceof TypeError) console.log('Type error!');\n}"},{t:"Custom Error Classes",d:"Extend the Error class for specific errors: class NotFoundError extends Error { }. Now you can catch different errors differently and add custom properties like statusCode.",code:"class NotFoundError extends Error {\n  constructor(resource: string) {\n    super(resource + ' not found');\n    this.name = 'NotFoundError';\n  }\n}\n\nclass ValidationError extends Error {\n  constructor(public field: string, message: string) {\n    super(message);\n    this.name = 'ValidationError';\n  }\n}\n\nthrow new NotFoundError('User');  // 'User not found'"},{t:"Async Error Handling",d:"Async functions need try/catch around await calls. Without it, rejected promises silently fail. Always wrap await in try/catch!",code:"// Always wrap await in try/catch\nasync function getUser(id: number) {\n  try {\n    const res = await fetch('/api/users/' + id);\n    if (!res.ok) throw new Error('HTTP ' + res.status);\n    return await res.json();\n  } catch (error) {\n    console.error('Failed to fetch user:', error);\n    throw error; // re-throw to let caller handle it\n  }\n}"},{t:"NestJS HttpException",d:"throw new HttpException('Not found', 404) sends a proper HTTP error response. NestJS has built-in exceptions: NotFoundException, BadRequestException, UnauthorizedException, ForbiddenException.",code:"import { HttpException, HttpStatus, NotFoundException } from '@nestjs/common';\n\n// Generic\nthrow new HttpException('Forbidden', HttpStatus.FORBIDDEN);\n\n// Built-in shortcuts\nthrow new NotFoundException('User not found');\nthrow new BadRequestException('Invalid email');\nthrow new UnauthorizedException('Please log in');\nthrow new ForbiddenException('Admin only');"},{t:"Exception Filters",d:"NestJS exception filters catch errors globally or per-controller. They transform errors into clean API responses with proper status codes and messages.",code:"@Catch(HttpException)\nexport class HttpExceptionFilter implements ExceptionFilter {\n  catch(exception: HttpException, host: ArgumentsHost) {\n    const ctx = host.switchToHttp();\n    const response = ctx.getResponse();\n    const status = exception.getStatus();\n\n    response.status(status).json({\n      statusCode: status,\n      message: exception.message,\n      timestamp: new Date().toISOString(),\n    });\n  }\n}"},{t:"Validation Errors",d:"Invalid user input should return 400 Bad Request with details about what went wrong. NestJS ValidationPipe does this automatically with class-validator.",code:"// class-validator + ValidationPipe\nclass CreateUserDto {\n  @IsString() @MinLength(2)\n  name: string;\n\n  @IsEmail()\n  email: string;\n}\n\n// NestJS auto-validates and returns:\n// { statusCode: 400, message: ['name must be longer than 2 chars'] }"},{t:"Error Logging",d:"Always log errors with context: what happened, where, and the stack trace. In production, use structured logging (JSON format) for easy searching and alerting.",code:"// Winston logger for NestJS\nimport { Logger } from '@nestjs/common';\n\n@Injectable()\nexport class UserService {\n  private readonly logger = new Logger(UserService.name);\n\n  async findOne(id: number) {\n    this.logger.log('Finding user ' + id);\n    try {\n      return await this.prisma.user.findUnique({ where: { id } });\n    } catch (error) {\n      this.logger.error('Failed to find user', error.stack);\n      throw error;\n    }\n  }\n}"}],whatIs:"Error handling is the practice of anticipating, detecting, and gracefully responding to errors in your code. Instead of letting your app crash, you catch errors and either recover from them, show helpful messages, or log them for debugging. In NestJS, exception filters provide a structured way to handle HTTP errors.",realWorld:"Every production API must handle errors properly. A payment processing endpoint that crashes instead of returning a clear error message could cost thousands of dollars. Good error handling is the difference between a professional and amateur application.",code:`// Basic try/catch/finally
try {
  const data = JSON.parse('invalid json');
} catch (error) {
  console.error('Parse failed:', error.message);
...
function UserProfile({ userId }: { userId: string }) {
  ...
  {id:12,title:"State Management & Data Fetching",subtitle:"Making Your Frontend Talk to Your Backend",analogy:"Imagine a classroom with a whiteboard (state). When the teacher writes something new (state update), every student (component) who's watching the board sees the change instantly. useState is the whiteboard. useContext is like a school-wide PA system — everyone hears it. React Query is like a librarian who fetches books (data) for you, keeps a copy cached, and automatically checks if there's a newer edition!",points:[{t:"useState — Local State",d:"const [count, setCount] = useState(0). Each component manages its own data. When you call setCount, React re-renders that component with the new value. Simple and direct.",code:"const [name, setName] = useState(\'Alice\');\nconst [items, setItems] = useState<string[]>([]);\n\n// Update state\nsetName(\'Bob\');\nsetItems([...items, \'new item\']);\n\n// State is immutable — always create new values!\n// items.push(\'bad\'); // WRONG\n// setItems([...items, \'good\']); // RIGHT"},{t:"useEffect — Side Effects",d:"Run code when something changes: useEffect(() => { fetchData() }, [userId]). The array at the end says 'run this when userId changes'. Empty array [] means 'run once on mount'.",code:"// Run code when component mounts or dependencies change\nuseEffect(() => {\n  console.log(\'Component mounted!\');\n  const timer = setInterval(() => console.log(\'tick\'), 1000);\n\n  return () => clearInterval(timer); // cleanup!\n}, []); // empty [] = run once on mount\n\nuseEffect(() => {\n  document.title = \'Count: \' + count;\n}, [count]); // runs when count changes"},{t:"useContext — Shared State",d:"Pass data through the component tree without prop drilling. Create a context, wrap your app in a Provider, and any child can access the value. Great for themes, auth, and language.","code":"// Create + provide + consume in 3 steps\nconst UserContext = createContext(null);\n\nfunction App() {\n  const [user, setUser] = useState({ name: 'Alice' });\n  return (\n    <UserContext.Provider value={user}>\n      <Profile /> {/* No need to pass user as prop! */}\n    </UserContext.Provider>\n  );\n}\n\nfunction Profile() {\n  const user = useContext(UserContext);\n  return <h1>Hello, {user.name}!</h1>;\n}"},{t:"fetch & axios — HTTP Requests",d:"fetch('http://localhost:3000/api/users') calls your NestJS backend. axios is a popular library that's easier to use: axios.get('/users'). Both return promises.",code:"// fetch (built-in)\nconst res = await fetch(\'/api/users\');\nconst users = await res.json();\n\n// axios (popular library — auto-parses JSON)\nimport axios from \'axios\';\nconst { data } = await axios.get(\'/api/users\');\n\n// POST request\nawait axios.post(\'/api/users\', { name: \'Alice\', age: 25 });"},{t:"React Query (TanStack Query)",d:"The game-changer for data fetching. useQuery(['users'], fetchUsers) handles loading, errors, caching, and refetching automatically. No more manually managing loading states!",code:"// React Query handles loading, caching, refetching\nfunction Users() {\n  const { data, isLoading, error } = useQuery({\n    queryKey: [\'users\'],\n    queryFn: () => fetch(\'/api/users\').then(r => r.json()),\n  });\n\n  if (isLoading) return <p>Loading...</p>;\n  if (error) return <p>Error!</p>;\n  return <ul>{data.map(u => <li key={u.id}>{u.name}</li>)}</ul>;\n}"},{t:"CORS Explained",d:"Cross-Origin Resource Sharing. Your React app (localhost:3000) calls NestJS (localhost:4000) — browser blocks it for security! Fix: enable CORS on the backend with app.enableCors().",code:"// Backend: enable CORS in NestJS\nimport { NestFactory } from \'@nestjs/core\';\n\nconst app = await NestFactory.create(AppModule);\napp.enableCors({\n  origin: \'http://localhost:3000\', // frontend URL\n  methods: [\'GET\', \'POST\', \'PUT\', \'DELETE\'],\n  credentials: true,\n});\n// Now frontend can talk to this backend!"},{t:"Loading & Error States",d:"Every data fetch has 3 states: loading (spinner), success (show data), error (show message). React Query gives you { isLoading, isError, data } — no manual state juggling.",code:"function UserProfile({ id }: { id: number }) {\n  const [user, setUser] = useState(null);\n  const [loading, setLoading] = useState(true);\n  const [error, setError] = useState(null);\n\n  useEffect(() => {\n    fetch(\'/api/users/\' + id)\n      .then(r => r.json())\n      .then(setUser)\n      .catch(setError)\n      .finally(() => setLoading(false));\n  }, [id]);\n\n  if (loading) return <Spinner />;\n  if (error) return <ErrorMessage error={error} />;\n  return <h1>{user.name}</h1>;\n}"},{t:"Optimistic Updates",d:"Update the UI immediately BEFORE the server responds, then roll back if it fails. Makes the app feel instant. React Query makes this easy with onMutate/onError callbacks.","code":"// Optimistic update — show result instantly, fix if server fails\nconst mutation = useMutation(updateTodo, {\n  onMutate: async (newTodo) => {\n    await queryClient.cancelQueries(['todos']);\n    const previous = queryClient.getQueryData(['todos']);\n    // Instantly update UI\n    queryClient.setQueryData(['todos'], old =>\n      old.map(t => t.id === newTodo.id ? newTodo : t)\n    );\n    return { previous }; // save for rollback\n  },\n  onError: (err, newTodo, context) => {\n    // Rollback on failure\n    queryClient.setQueryData(['todos'], context.previous);\n  },\n});"}],whatIs:"State management is how you store and update data in your React app. Local state (useState) is for single components. Context (useContext) shares state across components. React Query manages server state — data that comes from your API. Data fetching is how your frontend communicates with your backend API using HTTP requests.",realWorld:"Every app you use daily does this: Instagram loads your feed (data fetching), updates the like count instantly when you tap (optimistic update), and caches your feed so it loads fast when you come back (React Query caching).",code:`// useState — local state
import { useState } from 'react';
...
create(@Body() dto: CreateProductDto) { ... }`,funFact:"The GitHub API has over 1,000 endpoints. Stripe's API documentation is so good that it's used as a teaching example in university computer science courses! 📚",quiz:[{q:"What HTTP method should you use to create a new resource?",opts:["GET","POST","DELETE","PATCH"],ans:1},{q:"What does a 404 status code mean?",opts:["Server error","Request successful","Resource not found","Bad request"],ans:2},{q:"What are DTOs used for?",opts:["Storing data in the database","Defining the shape of request/response data","Making APIs faster","Securing endpoints"],ans:1},{q:"What does Swagger/OpenAPI automatically generate for your NestJS API?",opts:["Database schemas and migrations","Docker containers for each endpoint","Interactive API documentation where frontend developers can explore and test endpoints","TypeScript types for the frontend"],ans:2},{q:"What HTTP status code should be returned when creating a new resource successfully?",opts:["200 OK","404 Not Found","400 Bad Request","201 Created"],ans:3}],challenge:"Design a REST API for a 'bookstore' on paper first: what endpoints would you need for books, authors, and orders? Then implement the books CRUD in NestJS!",resources:[{type:"docs",title:"MDN HTTP Overview",url:"https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/Overview",source:"MDN Web Docs"},{type:"article",title:"REST API Design Best Practices",url:"https://restfulapi.net/",source:"RESTful API"},{type:"video",title:"RESTful APIs in 100 Seconds",url:"https://www.youtube.com/watch?v=-MTSQjw5DrM",source:"Fireship"}],eli5:"An API is like a restaurant menu. You look at the menu and tell the waiter 'I want chicken' (make a request). The kitchen makes it and the waiter brings it back. You never go into the kitchen yourself - you just use the menu to order!",codeWalkthrough:["RESTful routes — clean and predictable 📐","Decorator that adds metadata or behavior","Exporting for use in other files","Decorator that adds metadata or behavior","","Returning a value","Closing block","","Decorator that adds metadata or behavior","","Returning a value","Closing block","","Decorator that adds metadata or behavior","","Returning a value","Closing block","","Decorator that adds metadata or behavior","","Returning a value","Closing block","","Decorator that adds metadata or behavior","","Returning a value","Closing block","Closing block","","DTO with validation — reject bad data at the door! 🚫","Declaring a class","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","Closing block","","Swagger — auto-generated docs! 📚","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior",""],bugChallenge:{"code":"@Controller('users')\nexport class UserController {\n  @Post(':id')\n  deleteUser(@Param('id') id: string) {\n    return this.userService.delete(id);\n  }\n}","hint":"Does the HTTP method match the action being performed?","answer":"The method uses @Post() but deletes a user. POST is for creating, DELETE is for deleting. Fix: change @Post(':id') to @Delete(':id')."},difficulty:"intermediate",prereqs:[1,5,8]},
  ...
  {id:15,title:"Why NestJS?",subtitle:"Express Grew Up and Got Organized",analogy:"Express is like a studio apartment — everything in one room, you decide where stuff goes. NestJS is like a well-designed house with labeled rooms: kitchen (services), front door (controllers), hallways (modules). Both work, but the house is WAY easier to manage when you have 50 rooms!",points:[{t:"Built-in Structure",d:"Module → Controller → Service pattern. Everyone organizes code the same way — no more 'where did John put that file?'",code:"// NestJS gives you structure from day 1\n@Module({\n  imports: [UsersModule, AuthModule, DatabaseModule],\n  controllers: [AppController],\n  providers: [AppService],\n})\nexport class AppModule {}\n// Every piece has a clear place!"},{t:"Dependency Injection",d:"Instead of manually creating instances, you just declare what you need and NestJS delivers it. Like room service!",code:"// NestJS creates and injects dependencies for you\n@Injectable()\nexport class UsersService {\n  constructor(private prisma: PrismaService) {} // injected!\n\n  findAll() {\n    return this.prisma.user.findMany(); // just use it!\n  }\n}\n// No need to: new PrismaService(), pass it around, etc."},{t:"TypeScript First",d:"NestJS is built FOR TypeScript. Decorators (@Get, @Post, @Injectable) make code readable and self-documenting.",code:"// NestJS is built WITH TypeScript — decorators everywhere\n@Controller('users')\nexport class UsersController {\n  @Get(':id')\n  @UseGuards(AuthGuard)\n  findOne(@Param('id', ParseIntPipe) id: number): Promise<User> {\n    return this.service.findOne(id);\n  }\n}\n// Full type safety from route to database"},{t:"Batteries Included",d:"Validation, auth guards, Swagger docs, WebSockets, microservices — all built-in or plug-and-play.",code:"// NestJS includes everything you need:\nimport { ValidationPipe } from '@nestjs/common';    // validation\nimport { ThrottlerModule } from '@nestjs/throttler'; // rate limiting\nimport { CacheModule } from '@nestjs/cache-manager'; // caching\nimport { ScheduleModule } from '@nestjs/schedule';   // cron jobs\nimport { BullModule } from '@nestjs/bull';            // queues\n// No hunting for libraries!"},{t:"Scalable from Day 1",d:"Start small with one controller. Grow to 100 modules without refactoring. NestJS scales with your team!",code:"// Start small, grow big — same patterns work at any scale\n// Small app:\nAppModule \u2192 UsersModule \u2192 UsersService\n\n// Large app:\nAppModule\n  \u251c\u2500\u2500 AuthModule (JWT, OAuth, Guards)\n  \u251c\u2500\u2500 UsersModule (CRUD, profiles)\n  \u251c\u2500\u2500 OrdersModule (cart, checkout)\n  \u251c\u2500\u2500 PaymentsModule (Stripe, webhooks)\n  \u251c\u2500\u2500 NotificationsModule (email, push)\n  \u2514\u2500\u2500 SharedModule (logger, config)"},{t:"Rich Ecosystem",d:"@nestjs/jwt, @nestjs/passport, @nestjs/websockets, @nestjs/graphql. Add what you need, nothing more.",code:"// Official NestJS packages for everything\n@nestjs/config       // environment variables\n@nestjs/swagger      // API documentation\n@nestjs/passport     // authentication\n@nestjs/jwt          // JWT tokens\n@nestjs/typeorm      // TypeORM integration\n@nestjs/mongoose     // MongoDB integration\n@nestjs/graphql      // GraphQL support\n@nestjs/websockets   // real-time\n@nestjs/microservices // microservices"},{t:"Pipes — Data Transformation & Validation",d:"Pipes transform or validate incoming data before it reaches your controller. ValidationPipe automatically checks DTOs, ParseIntPipe converts strings to numbers. Think of pipes as airport security — they inspect your luggage (data) before you board the plane (controller).",code:"// Built-in validation pipe\n@Get(':id')\nfindOne(@Param('id', ParseIntPipe) id: number) {\n  return this.service.findOne(id);\n}\n// GET /users/abc → 400 Bad Request (not a number!)\n// GET /users/5   → calls findOne(5)"},{t:"Interceptors — Before & After Logic",d:"Interceptors wrap around your route handler. They can transform the response, add logging, cache results, or measure execution time. Like a sandwich — interceptor code runs before AND after your handler. Example: automatically wrapping all responses in {success: true, data: ...} format.",code:"// Logging interceptor — runs before AND after\n@Injectable()\nexport class LoggingInterceptor implements NestInterceptor {\n  intercept(context: ExecutionContext, next: CallHandler) {\n    const now = Date.now();\n    console.log('Before...');\n    return next.handle().pipe(\n      tap(() => console.log(`After... ${Date.now() - now}ms`)),\n    );\n  }\n}\n// Apply: @UseInterceptors(LoggingInterceptor)"},{t:"Exception Filters — Centralized Error Handling",d:"Instead of try/catch everywhere, exception filters catch errors globally and return consistent error responses. Create a custom filter to log errors, send alerts, and return user-friendly messages. One place to handle ALL errors.",code:"// Custom exception filter\n@Catch(HttpException)\nexport class HttpExceptionFilter implements ExceptionFilter {\n  catch(exception: HttpException, host: ArgumentsHost) {\n    const ctx = host.switchToHttp();\n    const response = ctx.getResponse();\n    const status = exception.getStatus();\n    response.status(status).json({\n      statusCode: status,\n      message: exception.message,\n      timestamp: new Date().toISOString(),\n    });\n  }\n}"},{t:"Middleware — Request Pipeline",d:"Middleware runs BEFORE the route handler on every request. Use it for logging, CORS, rate limiting, or authentication checks. It's the bouncer at the door — checking everyone before they enter the club (your controller).",code:"// Middleware runs BEFORE the route handler\n@Injectable()\nexport class LoggerMiddleware implements NestMiddleware {\n  use(req: Request, res: Response, next: NextFunction) {\n    console.log(`${req.method} ${req.url}`);\n    next(); // pass to next middleware or handler\n  }\n}\n\n// Apply in module\nconfigure(consumer: MiddlewareConsumer) {\n  consumer.apply(LoggerMiddleware).forRoutes('*');\n}"},{t:"Custom Decorators",d:"Create your own decorators like @CurrentUser() to extract the logged-in user from the request, or @Roles('admin') to mark routes. Custom decorators make your code cleaner and more readable — hiding complexity behind a simple @ symbol.",code:"// Create your own decorator!\nexport const CurrentUser = createParamDecorator(\n  (data: unknown, ctx: ExecutionContext) => {\n    const request = ctx.switchToHttp().getRequest();\n    return request.user; // extract user from request\n  },\n);\n\n// Use it cleanly in any controller\n@Get('profile')\ngetProfile(@CurrentUser() user: User) {\n  return user; // no need to access request manually!\n}"}],whatIs:"NestJS is a progressive Node.js framework for building server-side applications. Built on top of Express (or Fastify), it provides an opinionated structure inspired by Angular, using modules, controllers, and services. It includes powerful features like Pipes, Interceptors, Filters, Middleware, and custom Decorators.",realWorld:"NestJS is used by Adidas, Roche, Autodesk, and many startups. It's the most popular structured Node.js framework, with over 70K GitHub stars.",code:`// The NestJS Holy Trinity 🔺
...
export class CreateUserDto {
  ...
  {id:16,title:"NestJS Architecture Patterns",subtitle:"Building Clean, Scalable Apps",analogy:"A NestJS app is like a well-organized company. The CEO (AppModule) oversees departments (feature modules). Each department has a receptionist (controller), workers (services), and security (guards). Nobody does someone else's job!",points:[{t:"Modules = Departments",d:"Each feature gets its own module: UserModule, ProductModule, AuthModule. Modules group controllers, services, and providers into self-contained units that can share functionality via imports.",code:"@Module({\n  imports: [DatabaseModule],      // other modules needed\n  controllers: [UsersController], // handles HTTP routes\n  providers: [UsersService],      // business logic\n  exports: [UsersService],        // share with other modules\n})\nexport class UsersModule {}\n\n// Each module = self-contained feature"},{t:"Pipes = Validators",d:"Pipes validate and transform data before it reaches your handler. ValidationPipe checks DTOs, ParseIntPipe converts strings to numbers. Bad data gets a clear 400 error before your logic runs.",code:"// Built-in pipes transform & validate\n@Get(':id')\nfindOne(@Param('id', ParseIntPipe) id: number) {\n  // ParseIntPipe: 'abc' \u2192 400 error, '5' \u2192 number 5\n}\n\n// Global validation pipe\napp.useGlobalPipes(new ValidationPipe({\n  whitelist: true,    // strip unknown fields\n  transform: true,    // auto-transform types\n}));"},{t:"Interceptors = Middleware++",d:"Interceptors wrap around handlers, running code before AND after execution. Use them to log timing, transform responses into standard wrappers, cache results, or measure performance with RxJS.",code:"// Transform response data automatically\n@Injectable()\nexport class TransformInterceptor<T> implements NestInterceptor {\n  intercept(ctx: ExecutionContext, next: CallHandler) {\n    return next.handle().pipe(\n      map(data => ({\n        success: true,\n        data,\n        timestamp: new Date().toISOString(),\n      })),\n    );\n  }\n}\n// Every response wrapped: { success: true, data: {...} }"},{t:"Exception Filters",d:"Catch errors globally and return consistent, user-friendly responses with proper status codes. Create custom filters to log errors to monitoring services and format clean messages for end users.",code:"// Catch and format all errors consistently\n@Catch()\nexport class AllExceptionsFilter implements ExceptionFilter {\n  catch(exception: unknown, host: ArgumentsHost) {\n    const ctx = host.switchToHttp();\n    const status = exception instanceof HttpException\n      ? exception.getStatus() : 500;\n    ctx.getResponse().status(status).json({\n      statusCode: status,\n      message: exception instanceof Error ? exception.message : 'Unknown error',\n    });\n  }\n}"},{t:"Middleware",d:"Middleware runs BEFORE guards and handlers on every matching request. Use it for logging, CORS headers, cookie parsing, or rate limiting. Works like Express middleware, so existing plugins are compatible.",code:"// Middleware runs before any route handler\n@Injectable()\nexport class CorsMiddleware implements NestMiddleware {\n  use(req: Request, res: Response, next: NextFunction) {\n    res.header('X-Request-Id', randomUUID());\n    console.log(req.method, req.url);\n    next();\n  }\n}"},{t:"Lifecycle Hooks",d:"Control startup and shutdown with hooks: onModuleInit fires when a module loads, onModuleDestroy during shutdown, onApplicationBootstrap after all modules are ready. Great for DB setup and cleanup.",code:"// Lifecycle hooks — NestJS tells you when things happen\n@Injectable()\nexport class DatabaseService implements OnModuleInit, OnModuleDestroy {\n  async onModuleInit() {\n    await this.connect(); // runs when module starts\n    console.log('Database connected!');\n  }\n  async onModuleDestroy() {\n    await this.disconnect(); // runs when app shuts down\n    console.log('Database disconnected!');\n  }\n}"},{t:"Guards = Security Checkpoints",d:"Guards decide if a request can proceed or gets rejected. JwtAuthGuard verifies tokens, RolesGuard checks permissions. They run after middleware but before interceptors and pipes in the request lifecycle.",code:"// Guard = security checkpoint\n@Injectable()\nexport class AuthGuard implements CanActivate {\n  canActivate(context: ExecutionContext): boolean {\n    const request = context.switchToHttp().getRequest();\n    const token = request.headers.authorization;\n    return !!token; // true = allow, false = 403 Forbidden\n  }\n}\n\n@UseGuards(AuthGuard)\n@Get('secret')\ngetSecret() { return 'only authenticated users see this'; }"},{t:"Custom Decorators",d:"Create reusable decorators like @CurrentUser() to extract the logged-in user, or @Public() to skip auth on specific routes. Custom decorators hide repetitive logic behind a clean @ symbol.",code:"// Combine multiple decorators into one!\nexport function Auth(...roles: Role[]) {\n  return applyDecorators(\n    UseGuards(JwtAuthGuard, RolesGuard),\n    SetMetadata('roles', roles),\n    ApiBearerAuth(),\n  );\n}\n\n// Use: @Auth('admin') instead of 3 separate decorators"},{t:"Provider Scopes",d:"By default, providers are singletons — one shared instance. Change scope to REQUEST (new per request) or TRANSIENT (new per injection). Request scope is great for multi-tenant apps needing per-request context.",code:"// Default: Singleton (one instance for entire app)\n@Injectable()\nexport class AppService {}\n\n// Request-scoped: new instance per HTTP request\n@Injectable({ scope: Scope.REQUEST })\nexport class RequestService {\n  constructor() {\n    // new instance created for each request!\n  }\n}\n\n// Transient: new instance every time it's injected\n@Injectable({ scope: Scope.TRANSIENT })\nexport class HelperService {}"},{t:"Dynamic Modules",d:"Some modules need runtime config like DB URLs or API keys. Dynamic modules use forRoot() and forRootAsync() to accept config at import time. Example: TypeOrmModule.forRoot({ host, port }).",code:"// Dynamic module — configurable at import time\n@Module({})\nexport class MailModule {\n  static forRoot(apiKey: string): DynamicModule {\n    return {\n      module: MailModule,\n      providers: [\n        { provide: 'MAIL_API_KEY', useValue: apiKey },\n        MailService,\n      ],\n      exports: [MailService],\n    };\n  }\n}\n\n// Usage: MailModule.forRoot('my-secret-key')"}],whatIs:"NestJS follows a layered architecture: Modules organize features, Controllers handle HTTP, Services contain business logic, and cross-cutting concerns (validation, logging, auth) are handled by Pipes, Guards, Interceptors, and Filters.",realWorld:"This architecture pattern (separation of concerns) is used by enterprise companies worldwide. It scales from a 1-person project to a 100-person team without becoming a mess.",code:`// The NestJS Request Lifecycle 🔄
...
export class HttpExceptionFilter implements ExceptionFilter {
  ...
  {id:17,title:"Validation & DTOs",subtitle:"Never Trust User Input",analogy:"DTOs are like airport security checkpoints. Before you board a plane (enter the server), your luggage (data) goes through scanners (validators). Is your bag the right size? Any prohibited items? If anything is wrong, you get stopped BEFORE you reach the plane. Without security (validation), anyone could bring anything on board — chaos!",points:[{t:"What is a DTO?",d:"Data Transfer Object — a class that defines the shape of incoming data. CreateUserDTO says 'to create a user, you MUST send name, email, and password with these rules.' Nothing more, nothing less.",code:"// DTO = shape of data coming into your API\nclass CreateUserDto {\n  name: string;\n  email: string;\n  password: string;\n}\n\n// Controller uses DTO to know what data to expect\n@Post()\ncreate(@Body() dto: CreateUserDto) {\n  return this.service.create(dto);\n}"},{t:"class-validator Decorators",d:"@IsString(), @IsEmail(), @MinLength(8), @IsNotEmpty(), @IsOptional(), @IsNumber(), @IsArray(), @IsEnum(). Decorators on DTO properties that define validation rules.",code:"import { IsString, IsEmail, MinLength, IsOptional, IsInt, Min } from 'class-validator';\n\nclass CreateUserDto {\n  @IsString() @MinLength(2) name: string;\n  @IsEmail() email: string;\n  @MinLength(8) password: string;\n  @IsOptional() @IsInt() @Min(0) age?: number;\n}\n// Invalid data? Auto-rejected with clear error messages!"},{t:"ValidationPipe",d:"NestJS built-in pipe that automatically validates incoming data against your DTO. Add it globally: app.useGlobalPipes(new ValidationPipe()). Invalid requests get a clean 400 error.",code:"// Enable validation globally in main.ts\napp.useGlobalPipes(new ValidationPipe());\n\n// Now ALL incoming data is validated automatically!\n// POST /users { name: '', email: 'not-email' }\n// → 400: ['name must be longer than 2 chars', 'email must be an email']"},{t:"Whitelist & Transform",d:"Setting whitelist: true on ValidationPipe strips any properties not defined in your DTO, preventing attackers from injecting extra fields like isAdmin: true. Setting transform: true auto-converts types so a string '42' from a URL parameter becomes the number 42. Always enable both in production apps.",code:"app.useGlobalPipes(new ValidationPipe({\n  whitelist: true,     // strip unknown fields\n  transform: true,     // auto-convert types (string '5' → number 5)\n  forbidNonWhitelisted: true, // error on unknown fields\n}));\n\n// POST { name: 'Alice', hackerField: 'evil' }\n// whitelist strips 'hackerField' — security!"},{t:"Nested Validation",d:"DTOs can contain other DTOs for complex nested data. Use @ValidateNested() and @Type(() => AddressDTO) to validate objects within objects. This ensures every level of deeply nested request bodies is thoroughly validated, not just the top-level properties. Essential for complex forms and nested API payloads.",code:"import { ValidateNested } from 'class-validator';\nimport { Type } from 'class-transformer';\n\nclass AddressDto {\n  @IsString() street: string;\n  @IsString() city: string;\n}\n\nclass CreateUserDto {\n  @IsString() name: string;\n  @ValidateNested()\n  @Type(() => AddressDto)\n  address: AddressDto;  // validates nested object too!\n}","code":"// Nested object validation\nclass AddressDto {\n  @IsString() street: string;\n  @IsString() city: string;\n}\n\nclass CreateUserDto {\n  @IsString() name: string;\n  @ValidateNested()\n  @Type(() => AddressDto)\n  address: AddressDto; // validates the nested object too!\n}"},{t:"Custom Validators",d:"When built-in decorators are not enough, create custom validators with @ValidatorConstraint(). Build reusable rules like @IsStrongPassword (checks complexity requirements) or @IsUniqueEmail (queries the database to verify uniqueness). Custom validators keep your validation logic centralized and reusable across all DTOs.",code:"import { ValidatorConstraint, Validate } from 'class-validator';\n\n@ValidatorConstraint({ name: 'isStrongPassword' })\nclass IsStrongPassword implements ValidatorConstraintInterface {\n  validate(password: string) {\n    return /[A-Z]/.test(password) && /[0-9]/.test(password);\n  }\n  defaultMessage() { return 'Password needs uppercase + number'; }\n}\n\nclass UserDto {\n  @Validate(IsStrongPassword) password: string;\n}","code":"// Custom validation rule\n@ValidatorConstraint({ name: 'isStrongPassword' })\nclass IsStrongPassword implements ValidatorConstraintInterface {\n  validate(password: string) {\n    return password.length >= 8 && /[A-Z]/.test(password) && /[0-9]/.test(password);\n  }\n  defaultMessage() {\n    return 'Password must be 8+ chars with uppercase and number';\n  }\n}\n\nclass RegisterDto {\n  @Validate(IsStrongPassword)\n  password: string;\n}"},{t:"Partial & Pick Types",d:"PartialType(CreateUserDTO) makes all fields optional — perfect for UpdateUserDTO where users might only change one field. PickType selects specific fields from an existing DTO. OmitType removes fields. IntersectionType combines multiple DTOs. These utilities let you compose DTOs without repeating property definitions.",code:"// CreateUserDto has all required fields\nclass CreateUserDto {\n  @IsString() name: string;\n  @IsEmail() email: string;\n  @MinLength(8) password: string;\n}\n\n// PartialType makes ALL fields optional (for updates)\nclass UpdateUserDto extends PartialType(CreateUserDto) {}\n// Now you can send just { name: 'Bob' } for PATCH"},{t:"Validation Groups",d:"Validation groups let you apply different rules depending on the context. For example, an email field might be required during registration but optional during profile updates. Assign groups to decorators and specify which group to validate in each route — one DTO handles multiple validation scenarios cleanly.",code:"class UserDto {\n  @IsString({ groups: ['create', 'update'] })\n  name: string;\n\n  @IsEmail({ groups: ['create'] })  // only required on create!\n  email: string;\n}\n\n// Apply specific group\n@Post()\ncreate(@Body(new ValidationPipe({ groups: ['create'] })) dto: UserDto) {}"},{t:"Error Messages & i18n",d:"Customize validation error messages with the message option: @MinLength(8, { message: 'Password must be at least 8 characters' }). For international apps, integrate i18n libraries to return error messages in the user's preferred language. Clear, localized error messages dramatically improve the user experience.",code:"class CreateUserDto {\n  @IsString({ message: 'Name must be text' })\n  @MinLength(2, { message: 'Name needs at least 2 characters' })\n  name: string;\n\n  @IsEmail({}, { message: 'Please enter a valid email address' })\n  email: string;\n}\n// Custom messages instead of generic ones!"}],whatIs:"DTOs (Data Transfer Objects) define the expected shape of request data. Combined with class-validator, they automatically validate incoming data — checking types, formats, lengths, and custom rules. NestJS ValidationPipe connects DTOs to the request pipeline, rejecting invalid data with helpful error messages before it reaches your business logic.",realWorld:"Every form submission, API call, and webhook payload should be validated. Without validation, users could send malformed data that crashes your database, inject malicious code, or bypass business rules. DTOs are your first line of defense.",code:`// Install: npm install class-validator class-transformer
...
// }`,funFact:"The 2017 Equifax data breach exposed 147 million people's personal data. The root cause? A known vulnerability in an unpatched server — but proper input validation and security layers could have limited the damage significantly.",quiz:[{q:"What does a DTO do in NestJS?",opts:["Transfers data to the database directly","Defines the expected shape and validation rules for incoming request data","Creates database tables","Sends emails"],ans:1},{q:"What does 'whitelist: true' in ValidationPipe do?",opts:["Only allows admin users","Strips any properties not defined in the DTO","Makes all fields optional","Enables CORS"],ans:1},{q:"How do you make an UpdateDTO where all fields are optional?",opts:["Add ? to every property manually","Use PartialType(CreateDTO)","Use @IsOptional() on the class","Set required: false globally"],ans:1},{q:"What does 'transform: true' in ValidationPipe do?",opts:["Transforms the response format","Transforms error messages","Auto-converts types so a string '42' from a URL parameter becomes the number 42","Transforms the database schema"],ans:2},{q:"What are validation groups used for in class-validator?",opts:["Grouping DTOs into folders","Running tests in groups","Organizing database queries","Applying different validation rules depending on context, like stricter rules for creation vs. looser rules for updates"],ans:3}],challenge:"Create a CreateProductDTO with: name (string, min 3 chars), price (number, positive), category (enum: electronics/clothing/food), description (optional string, max 500 chars). Set up ValidationPipe globally and test with invalid data!",resources:[{type:"docs",title:"NestJS Validation",url:"https://docs.nestjs.com/techniques/validation",source:"NestJS Official"},{type:"docs",title:"class-validator Documentation",url:"https://github.com/typestack/class-validator",source:"GitHub"},{type:"docs",title:"class-transformer Documentation",url:"https://github.com/typestack/class-transformer",source:"GitHub"}],eli5:"Imagine filling out a form to join a club. The form says 'Name: at least 2 letters' and 'Age: must be a number'. If you write something wrong, the form tells you what to fix BEFORE you hand it in. DTOs are like those smart forms that check your answers!",codeWalkthrough:["Install: npm install class-validator class-transformer","","create-user.dto.ts","Importing required dependencies","","","","","Defining an enum","","Exporting for use in other files","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","","Decorator that adds metadata or behavior","","","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","","Decorator that adds metadata or behavior","Decorator that adds metadata or behavior","","Closing block","","update-user.dto.ts — all fields optional!","Importing required dependencies","Exporting for use in other files","","user.controller.ts","Importing required dependencies","","Decorator that adds metadata or behavior","","dto is already validated! Safe to use.","Returning a value","Closing block","","Decorator that adds metadata or behavior","","Returning a value","Closing block","","main.ts — Enable validation globally","Importing required dependencies","","Declaring a variable","","","","","","","What happens when invalid data is sent:","POST /users { name: \"\", email: \"not-email\", hack: \"injected\" }","Response 400:","{","\"statusCode\": 400,","\"message\": [","\"name must be longer than or equal to 2 characters\",","\"email must be an email\",","\"property hack should not exist\"","],","\"error\": \"Bad Request\"","}"],bugChallenge:{"code":"export class CreateUserDTO {\n  @IsString()\n  name: string;\n\n  @IsEmail()\n  email: string;\n\n  @MinLength(8)\n  password: string;\n}","hint":"What type decorator is missing from the password field?","answer":"Password has @MinLength(8) but is missing @IsString() decorator. Best practice: always include the type decorator. Fix: add @IsString() above @MinLength(8)."},difficulty:"intermediate",prereqs:[1,4,15]},
  ...
  {id:18,title:"MongoDB — The Flexible Database",subtitle:"Store Data Like JSON Files",analogy:"MySQL is like a strict printed form — every person fills in EXACTLY the same boxes (columns). MongoDB is like a folder of sticky notes — each note can have different info! One has a phone number, another has an address. Both are fine!",points:[{t:"Documents, Not Tables",d:"MongoDB stores data as JSON-like documents instead of rigid table rows. Each document can have different fields from others in the same collection, giving ultimate flexibility for data like user profiles.",code:"// SQL table (rows & columns)\n// | id | name  | email          |\n// | 1  | Alice | alice@mail.com |\n\n// MongoDB document (JSON-like)\n{\n  _id: ObjectId('...'),\n  name: 'Alice',\n  email: 'alice@mail.com',\n  hobbies: ['coding', 'reading'],  // arrays OK!\n  address: { city: 'NYC' }          // nested objects OK!\n}"},{t:"No Schema Migrations",d:"Need a new field? Just include it in your next document — no ALTER TABLE, no migration scripts, no downtime. MongoDB adapts to your data shape naturally, speeding up development versus SQL databases.",code:"// SQL: must define schema first, migrate for changes\n// ALTER TABLE users ADD COLUMN phone VARCHAR(20);\n\n// MongoDB: just add the field!\nawait db.collection('users').insertOne({\n  name: 'Alice',\n  phone: '555-0123',  // new field — no migration needed!\n});\n// Old documents without 'phone' still work fine"},{t:"Nested Data",d:"Store complex objects inside other objects naturally. A user can contain an address object, an array of orders, and nested preferences — all in one document without expensive JOINs that slow SQL queries.",code:"// MongoDB allows nesting — no joins needed!\n{\n  name: 'Alice',\n  orders: [\n    { item: 'Book', price: 15, date: '2024-01-15' },\n    { item: 'Pen', price: 3, date: '2024-01-20' },\n  ],\n  address: {\n    street: '123 Main St',\n    city: 'NYC',\n    zip: '10001'\n  }\n}"},{t:"Scales Horizontally",d:"When your app outgrows one server, MongoDB distributes data across multiple machines via sharding. Each shard holds a portion of your data. Add more servers to handle more load without rewriting app code.",code:"// Horizontal scaling = add more servers\n// Server 1: users A-M\n// Server 2: users N-Z\n// This is called 'sharding'\n\n// MongoDB handles this automatically!\n// sh.shardCollection('mydb.users', { lastName: 1 });\n\n// SQL scaling is harder — usually vertical (bigger server)"},{t:"BSON Format",d:"MongoDB stores data in Binary JSON (BSON), extending JSON with types like Date, ObjectId, Binary, and Decimal128. BSON is more compact and faster to parse than plain JSON, improving read/write performance.",code:"// BSON = Binary JSON (what MongoDB actually stores)\n// JSON:  { \"age\": 25 }      → text, slow to parse\n// BSON:  \\x10age\\x00\\x19   → binary, fast to parse!\n\n// BSON adds types JSON doesn't have:\n// ObjectId, Date, Decimal128, Binary\n{\n  _id: ObjectId('507f1f77bcf86cd799439011'),\n  created: ISODate('2024-01-15'),\n  price: NumberDecimal('19.99')\n}"},{t:"Collections, Not Tables",d:"Collections are the MongoDB equivalent of SQL tables, and documents are like rows. Unlike SQL tables, collections do not enforce a fixed schema — two documents in the same collection can have different fields.",code:"// SQL has databases → tables → rows\n// MongoDB has databases → collections → documents\n\n// Create and insert in one step:\nawait db.collection('products').insertOne({\n  name: 'Widget',\n  price: 9.99,\n});\n// Collection auto-created if it doesn't exist!"},{t:"Indexing for Speed",d:"Without indexes, MongoDB scans every document to find matches — very slow at scale. Create indexes on frequently-queried fields like email or createdAt so MongoDB jumps directly to matching documents.",code:"// Without index: MongoDB scans EVERY document (slow!)\n// With index: jumps straight to the match (fast!)\n\n// Create an index on the 'email' field\ndb.users.createIndex({ email: 1 });  // 1 = ascending\n\n// Compound index (multiple fields)\ndb.users.createIndex({ lastName: 1, age: -1 });\n\n// Unique index — no duplicate emails!\ndb.users.createIndex({ email: 1 }, { unique: true });","code":"// Prisma schema — add indexes for fast queries\nmodel User {\n  id    String @id @default(auto()) @map(\"_id\") @db.ObjectId\n  email String @unique          // unique index\n  name  String\n  age   Int\n\n  @@index([name])               // single field index\n  @@index([name, age])          // compound index\n}\n// Now: db.users.find({ name: 'Alice' }) is fast!"},{t:"When to Use MongoDB",d:"MongoDB excels with varied data shapes: property listings, user profiles, CMS, IoT data. Choose SQL instead when you need complex multi-table JOINs, strict ACID transactions, or rigid data structures.",code:"// Great for:\n// - Flexible/evolving schemas (startups, prototypes)\n// - Nested/hierarchical data (comments, categories)\n// - High-volume reads (caching, logging)\n// - Real-time analytics\n\n// Consider SQL instead for:\n// - Complex joins and relationships\n// - Strict data integrity (banking)\n// - ACID transactions across tables"},{t:"Aggregation Pipeline",d:"The aggregation pipeline processes data in stages: $match filters, $group aggregates, $sort orders, $project reshapes output. Like an assembly line where each stage transforms data before passing it along.",code:"// Aggregation = multi-step data processing\ndb.orders.aggregate([\n  { $match: { status: 'completed' } },     // Step 1: filter\n  { $group: {                               // Step 2: group\n      _id: '$customerId',\n      total: { $sum: '$amount' },\n      count: { $sum: 1 }\n  }},\n  { $sort: { total: -1 } },                // Step 3: sort\n  { $limit: 10 }                            // Step 4: top 10\n]);","code":"// MongoDB aggregation pipeline\nconst result = await db.collection('orders').aggregate([\n  { $match: { status: 'completed' } },     // Step 1: filter\n  { $group: {                               // Step 2: group & sum\n      _id: '$customerId',\n      totalSpent: { $sum: '$amount' },\n      orderCount: { $sum: 1 }\n  }},\n  { $sort: { totalSpent: -1 } },           // Step 3: sort\n  { $limit: 10 }                           // Step 4: top 10\n]).toArray();\n// Result: top 10 customers by spending"},{t:"Replica Sets for Reliability",d:"Replica sets maintain multiple copies of your data across servers. If the primary goes down, a secondary is auto-promoted within seconds. Provides high availability and protects against hardware failures.",code:"// Replica set = copies of your data on multiple servers\n// Primary: handles all writes\n// Secondary 1: copy (can handle reads)\n// Secondary 2: another copy\n\n// Connection string with replica set:\nmongodb://server1,server2,server3/mydb?replicaSet=rs0\n\n// If primary dies → secondary auto-promoted!"}],whatIs:"MongoDB is a NoSQL database that stores data as flexible JSON-like documents (BSON). Unlike SQL databases with rigid tables, MongoDB lets each document have its own structure. It's the 'M' in the MEAN/MERN stack.",realWorld:"MongoDB is used by Adobe, eBay, Forbes, Google, and Toyota. It's especially popular for apps with varied data shapes — like property listings, user profiles, or content management systems.",code:`// SQL (MySQL) — rigid table structure 📊
...
// Error: "DATABASE_URL" is required`,funFact:"In 2016, an Uber engineer accidentally committed AWS credentials to a public GitHub repo. Hackers found them within minutes and accessed data of 57 million users. This is why .env files exist and why you NEVER commit secrets to Git!",quiz:[{q:"Why should you NEVER commit .env files to Git?",opts:["They make the repo too large","They contain sensitive secrets like API keys and passwords","Git cannot handle .env files","They slow down the build"],ans:1},{q:"What does ConfigModule.forRoot({ isGlobal: true }) do in NestJS?",opts:["Makes the config available in all modules without re-importing","Shares config across multiple servers","Makes all values public","Enables global error handling"],ans:0},{q:"What is the purpose of a .env.example file?",opts:["It's a backup of the real .env file","It documents required environment variables without exposing actual values","It's used in production instead of .env","It automatically generates .env files"],ans:1},{q:"Why is Joi validation useful for environment variables?",opts:["It makes the app faster","It validates env vars at startup so missing or invalid config crashes immediately instead of failing at runtime","It encrypts environment variables","It replaces .env files entirely"],ans:1},{q:"What should you do if your app needs different config values per environment (dev, staging, production)?",opts:["Hardcode all values in the source code","Use separate .env files per environment and load them via NODE_ENV","Only test in production","Use the same values everywhere"],ans:1}],challenge:"Create a .env file with DATABASE_URL, JWT_SECRET, and PORT. Set up ConfigModule with Joi validation that requires DATABASE_URL and JWT_SECRET. Add a .env.example and update .gitignore. What happens when you remove DATABASE_URL?",resources:[{type:"docs",title:"NestJS Configuration",url:"https://docs.nestjs.com/techniques/configuration",source:"NestJS Official"},{type:"docs",title:"dotenv Documentation",url:"https://github.com/motdotla/dotenv",source:"GitHub"},{type:"article",title:"Environment Variables Best Practices",url:"https://12factor.net/config",source:"The Twelve-Factor App"}],eli5:"Think of your app like getting dressed. At home you wear pajamas (development). At school you wear a uniform (production). Same you, different outfits! Environment variables are like outfit lists for each place - you don't sew clothes into your body, you just change what you wear.",codeWalkthrough:[".env file (NEVER commit this!)","","","","","",".env.example (DO commit this)","","","","","",".gitignore","Method chaining on the previous expression","Method chaining on the previous expression","Method chaining on the previous expression","","app.module.ts — Load config","Importing required dependencies","","Decorator that adds metadata or behavior","","","","","","","","Exporting for use in other files","","any.service.ts — Use config values","Importing required dependencies","","Decorator that adds metadata or behavior","Exporting for use in other files","","","","Returning a value","Closing block","Closing block","","Config validation with Joi","Importing required dependencies","","","","","","","","Method chaining on the previous expression","Method chaining on the previous expression","","","If DATABASE_URL is missing, app crashes at startup:","Error: \"DATABASE_URL\" is required"],bugChallenge:{"code":"// .env committed to Git!\nDATABASE_URL=mongodb://admin:password123@production-server:27017/myapp\nJWT_SECRET=my-super-secret-key","hint":"Should .env files with real credentials be in your Git repository?","answer":"NEVER commit .env files with real credentials to Git! Anyone with repo access can see your passwords. Fix: add .env to .gitignore and use .env.example with empty values instead."},difficulty:"intermediate",prereqs:[1,15]},
  ...
  {id:21,title:"Authentication — JWT & Guards",subtitle:"Who Are You? Prove It!",analogy:"Authentication is like a nightclub. The bouncer (Guard) checks your ID (JWT token) at the door. If valid, you're in! If expired or fake, you're out. Some VIP rooms (admin routes) need a special stamp (role) on your wristband!",points:[{t:"JWT (JSON Web Token)",d:"A signed token with user info like userId and role. The server verifies it using a secret key without querying the DB each request. Like a concert wristband with three parts: header, payload, signature.",code:"// JWT = encoded JSON with a signature\nimport { JwtService } from '@nestjs/jwt';\n\n// Create a token\nconst token = jwtService.sign({ userId: 1, role: 'admin' });\n// eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjF9.abc123\n\n// Verify and decode\nconst payload = jwtService.verify(token);\n// { userId: 1, role: 'admin' }"},{t:"Passport.js",d:"Passport has 500+ auth strategies: local (email/password), Google OAuth, Facebook, GitHub, and more. NestJS integrates it via @nestjs/passport. Each strategy handles its specific login flow for you.",code:"// Passport strategy for JWT authentication\nimport { PassportStrategy } from '@nestjs/passport';\nimport { Strategy, ExtractJwt } from 'passport-jwt';\n\nexport class JwtStrategy extends PassportStrategy(Strategy) {\n  constructor() {\n    super({\n      jwtFromRequest: ExtractJwt.fromAuthHeaderAsBearerToken(),\n      secretOrKey: 'your-secret',\n    });\n  }\n  validate(payload: any) { return { id: payload.userId }; }\n}"},{t:"Guards",d:"Guards are the conceptual gatekeepers of your API — middleware that decides if a request should proceed. Think of them as security checkpoints: Is this user authenticated? Do they have the right role? The concept applies to any framework, not just NestJS. For NestJS-specific Guard implementation (AuthGuard, RolesGuard, custom decorators), see Lesson 45.",code:"// Guards decide if a request can proceed\nimport { AuthGuard } from '@nestjs/passport';\n\n@Controller('profile')\nexport class ProfileController {\n  @UseGuards(AuthGuard('jwt'))  // must be logged in!\n  @Get()\n  getProfile(@Req() req) {\n    return req.user;  // user attached by Passport\n  }\n}"},{t:"Role-Based Access",d:"Define roles like admin, manager, user, and guest with different permissions. Admins delete users, regular users edit only their profile. Guards check the JWT payload and reject unauthorized requests.",code:"// Custom decorator for roles\nexport const Roles = (...roles: string[]) => SetMetadata('roles', roles);\n\n// Role guard checks if user has required role\n@Injectable()\nexport class RolesGuard implements CanActivate {\n  canActivate(context: ExecutionContext): boolean {\n    const roles = this.reflector.get<string[]>('roles', context.getHandler());\n    const user = context.switchToHttp().getRequest().user;\n    return roles.includes(user.role);\n  }\n}\n\n@Roles('admin') @UseGuards(RolesGuard)\n@Delete(':id') remove() {}"},{t:"Token Refresh",d:"Access tokens expire in 15-30 minutes for security. Refresh tokens last 7-30 days. When access tokens expire, exchange the refresh token for a new one — no re-login needed. Always rotate refresh tokens!",code:"// Login returns both tokens\nasync login(user: User) {\n  return {\n    access_token: this.jwt.sign(payload, { expiresIn: '15m' }),  // short-lived\n    refresh_token: this.jwt.sign(payload, { expiresIn: '7d' }),  // long-lived\n  };\n}\n\n// Refresh endpoint — exchange old refresh for new access\n@Post('refresh')\nasync refresh(@Body('refresh_token') token: string) {\n  const payload = this.jwt.verify(token);\n  return { access_token: this.jwt.sign({ sub: payload.sub }, { expiresIn: '15m' }) };\n}"},{t:"Password Hashing",d:"NEVER store plain-text passwords! Use bcrypt to hash with a salt before saving. Even if your database is breached, hashes cannot be reversed. Use bcrypt.compare() during login to verify credentials.",code:"import * as bcrypt from 'bcrypt';\n\n// Hash password before saving\nconst salt = await bcrypt.genSalt(10);\nconst hashed = await bcrypt.hash('myPassword123', salt);\n// hashed = '$2b$10$X7z...' (unreadable!)\n\n// Verify password at login\nconst isMatch = await bcrypt.compare('myPassword123', hashed);\nconsole.log(isMatch); // true\n\nconst isWrong = await bcrypt.compare('wrongPassword', hashed);\nconsole.log(isWrong); // false"},{t:"OAuth 2.0 Social Login",d:"Let users log in with Google, GitHub, or Facebook instead of creating passwords. OAuth 2.0 redirects to the provider, they authorize your app, and you get a token with their profile. Improves UX greatly.",code:"// Google OAuth with Passport\n@Injectable()\nexport class GoogleStrategy extends PassportStrategy(Strategy, 'google') {\n  constructor() {\n    super({\n      clientID: process.env.GOOGLE_CLIENT_ID,\n      clientSecret: process.env.GOOGLE_CLIENT_SECRET,\n      callbackURL: '/auth/google/callback',\n      scope: ['email', 'profile'],\n    });\n  }\n  async validate(accessToken, refreshToken, profile) {\n    return { email: profile.emails[0].value, name: profile.displayName };\n  }\n}"},{t:"CSRF & Security Headers",d:"CSRF tricks users into making unwanted requests. Protect with CSRF tokens and helmet middleware for security headers. Set HttpOnly and Secure flags on cookies and use SameSite attribute for protection.",code:"// Helmet adds security headers automatically\nimport helmet from 'helmet';\napp.use(helmet());\n// Sets: X-Frame-Options, Content-Security-Policy, etc.\n\n// CORS — control who can call your API\napp.enableCors({\n  origin: ['https://myapp.com'],\n  methods: ['GET', 'POST', 'PUT', 'DELETE'],\n  credentials: true,\n});"},{t:"Two-Factor Authentication",d:"Add extra security with a second step after the password. Users scan a QR code with Google Authenticator then enter a 6-digit code each login. Libraries like speakeasy make TOTP-based 2FA straightforward.",code:"// Generate TOTP secret for user\nimport * as speakeasy from 'speakeasy';\n\nconst secret = speakeasy.generateSecret({ name: 'MyApp' });\n// User scans QR code with authenticator app\n\n// Verify 2FA code on login\nconst verified = speakeasy.totp.verify({\n  secret: secret.base32,\n  encoding: 'base32',\n  token: '123456',  // code from user's app\n});"},{t:"Session vs Token Auth",d:"Sessions store user state on the server (Redis or memory) using cookies. JWT is stateless — the token itself holds all info. Tokens suit APIs and mobile apps; sessions work better for server-rendered web apps.",code:"// Session-based: server stores session data\n// + Simple, easy to invalidate\n// - Hard to scale (need shared session store)\n\n// Token-based (JWT): client stores token\n// + Stateless, scales easily\n// - Can't easily invalidate before expiry\n\n// Typical JWT flow:\n// 1. POST /auth/login → { accessToken, refreshToken }\n// 2. GET /api/data + Header: 'Bearer <accessToken>'\n// 3. POST /auth/refresh → new accessToken"}],whatIs:"Authentication verifies WHO you are (login). Authorization verifies WHAT you can do (permissions). JWTs are stateless tokens that contain encoded user info, verified by the server using a secret key.",realWorld:"Nearly every web app uses JWT for authentication. Google, GitHub, and Stripe all use OAuth + JWT. NestJS makes it clean with decorators like @UseGuards() and @Roles().",code:`// 1. Login — get your JWT token 🎟️
@Controller('auth')
...
export class AdminController {
  ...
  {id:22,title:"Generics & Utility Types",subtitle:"Writing Code That Works With Any Type",analogy:"Generics are like a universal adapter plug you take on international trips. The adapter shape (generic type) stays the same, but you slot in different country prongs (concrete types) depending on where you are. ApiResponse&lt;User&gt; is the adapter configured for the User outlet. Same adapter, any country!",points:[{t:"Generic Functions with &lt;T&gt;",d:"function getFirst&lt;T&gt;(arr: T[]): T { return arr[0]; } — T is a placeholder. Call with getFirst&lt;string&gt;(['a','b']) and T becomes string.",code:"function first<T>(arr: T[]): T {\n  return arr[0];\n}\n\nfirst<string>(['a', 'b']);  // type: string\nfirst<number>([1, 2, 3]);  // type: number\nfirst([true, false]);       // inferred: boolean"},{t:"Generic Interfaces",d:"interface ApiResponse&lt;T&gt; { data: T; success: boolean; }. Use ApiResponse&lt;User&gt; or ApiResponse&lt;Post[]&gt;. Same interface, different types!",code:"interface ApiResponse<T> {\n  data: T;\n  status: number;\n  message: string;\n}\n\nconst userRes: ApiResponse<User> = {\n  data: { name: 'Alice', age: 25 },\n  status: 200,\n  message: 'OK',\n};"},{t:"Constraints with extends",d:"function process&lt;T extends { length: number }&gt;(item: T) — T MUST have a length property. Prevents passing number (which has no length).",code:"// T must have a 'length' property\nfunction longest<T extends { length: number }>(a: T, b: T): T {\n  return a.length >= b.length ? a : b;\n}\n\nlongest('hello', 'hi');     // 'hello'\nlongest([1, 2, 3], [1]);    // [1, 2, 3]\n// longest(10, 20);         // Error! number has no .length"},{t:"Partial&lt;T&gt;",d:"Partial&lt;User&gt; makes all properties optional. Great for update DTOs where only SOME fields change.",code:"interface User { name: string; age: number; email: string; }\n\n// Partial makes ALL fields optional\nfunction updateUser(id: number, data: Partial<User>) {\n  // data can have any combination of User fields\n}\n\nupdateUser(1, { name: 'Bob' });          // OK\nupdateUser(1, { age: 26, email: 'x' }); // OK\nupdateUser(1, {});                        // also OK"},{t:"Pick&lt;T, K&gt;",d:"Pick&lt;User, 'name' | 'email'&gt; = only those properties. Remove unnecessary fields!",code:"interface User { name: string; age: number; email: string; role: string; }\n\n// Pick only the fields you need\ntype UserPreview = Pick<User, 'name' | 'email'>;\n// = { name: string; email: string }\n\nconst preview: UserPreview = {\n  name: 'Alice',\n  email: 'alice@mail.com',\n  // age and role are excluded!\n};"},{t:"Omit&lt;T, K&gt;",d:"Omit&lt;User, 'password'&gt; = everything EXCEPT password. Perfect for API responses (never expose secrets!).",code:"interface User { id: number; name: string; password: string; }\n\n// Omit removes specified fields\ntype SafeUser = Omit<User, 'password'>;\n// = { id: number; name: string }\n\n// Great for API responses — never send passwords!\nfunction getUser(): SafeUser {\n  return { id: 1, name: 'Alice' };\n}"},{t:"Record&lt;K, V&gt;",d:"Record&lt;string, number&gt; = object with string keys and number values. Like a Map but as an object!",code:"// Record creates an object type with specific key and value types\ntype Scores = Record<string, number>;\n\nconst grades: Scores = {\n  math: 95,\n  science: 88,\n  english: 92,\n};\n\n// Useful for dictionaries/maps\ntype UserMap = Record<number, User>;\nconst users: UserMap = { 1: alice, 2: bob };"},{t:"Readonly&lt;T&gt;",d:"Readonly&lt;User&gt; makes all properties readonly. Prevents accidental mutations!",code:"interface Config { apiUrl: string; port: number; }\n\nconst config: Readonly<Config> = {\n  apiUrl: 'https://api.com',\n  port: 3000,\n};\n\n// config.port = 8080; // Error! All properties are readonly\n\n// Also works with arrays\nconst nums: ReadonlyArray<number> = [1, 2, 3];\n// nums.push(4); // Error!"}],whatIs:"Generics let you write flexible code that works with ANY type. Utility types transform existing types: Partial makes properties optional, Pick selects properties, Omit removes them. Learn these and you'll write DRY code!",realWorld:"React hooks use generics: useState&lt;T&gt;, useCallback&lt;T&gt;. API responses use generics: Promise&lt;ApiResponse&lt;T&gt;&gt;. Mastering generics = writing production-quality code!",code:`// Generic function — T is a placeholder
...
export function WelcomeEmail({ name }: { name: string }) {
  ...
  {id:26,title:"Push Notifications with Firebase",subtitle:"Ding! You Have a Message!",analogy:"Push notifications are like a doorbell. The user doesn't need to keep checking if someone's at the door — the doorbell (Firebase Cloud Messaging) rings and tells them! Your server pushes the button, Firebase rings the bell on their device.",points:[{t:"Firebase Cloud Messaging (FCM)",d:"FCM is Google's free push notification service for Android, iOS, and web. It handles delivery infrastructure — just call an API with the message and target. Delivers billions of messages daily at no cost.",code:"// Send push notifications with Firebase Admin SDK\nimport * as admin from 'firebase-admin';\n\nadmin.initializeApp({ credential: admin.credential.cert(serviceAccount) });\n\nawait admin.messaging().send({\n  token: userDeviceToken,\n  notification: {\n    title: 'New Message!',\n    body: 'Alice sent you a message',\n  },\n});"},{t:"Device Tokens",d:"When a user installs your app, FCM assigns a unique device token. Store tokens in your database linked to each user. Provide the token when sending and FCM routes it to the exact device. Refresh regularly.",code:"// Each device gets a unique token for push notifications\n// Client-side (React Native / Flutter):\nconst token = await messaging().getToken();\n// Send token to your backend\nawait api.post('/users/device-token', { token });\n\n// Backend stores token in database\nawait prisma.user.update({\n  where: { id: userId },\n  data: { deviceToken: token },\n});"},{t:"Topic Subscriptions",d:"Users subscribe to topics like news, deals, or sports. One API call to a topic delivers to all subscribers automatically. Perfect for broadcasting announcements, breaking news, or promotions to large groups.",code:"// Subscribe devices to topics for group messaging\nawait admin.messaging().subscribeToTopic([deviceToken], 'news');\n\n// Send to ALL subscribers of a topic\nawait admin.messaging().send({\n  topic: 'news',\n  notification: {\n    title: 'Breaking News!',\n    body: 'Something amazing happened',\n  },\n});\n// All 'news' subscribers get the notification!"},{t:"Background Processing",d:"Send notifications through a Bull queue instead of directly in your API handler. Queue the job, return instantly, let a background worker call FCM. Keeps your API responsive even for thousands of messages.",code:"// Queue notifications for background sending\n@Injectable()\nexport class NotificationService {\n  constructor(@InjectQueue('push') private queue: Queue) {}\n\n  async notifyFollowers(userId: number, message: string) {\n    const followers = await this.getFollowers(userId);\n    for (const follower of followers) {\n      await this.queue.add('push', {\n        token: follower.deviceToken,\n        title: 'New Post!', body: message,\n      });\n    }\n  }\n}"},{t:"Data Payloads",d:"Notifications carry custom data beyond title and body. Include fields like screen: orderDetails and orderId: 123 so tapping navigates to the right screen. Data payloads create rich, interactive experiences.",code:"// Send data WITH notification for app logic\nawait admin.messaging().send({\n  token: deviceToken,\n  notification: {\n    title: 'Order Update',\n    body: 'Your order has shipped!',\n  },\n  data: {\n    orderId: '12345',\n    screen: 'order-details',  // app navigates here on tap\n    trackingUrl: 'https://track.example.com/12345',\n  },\n});"},{t:"Rich Notifications",d:"Go beyond plain text with images, action buttons, and expandable content. Show product images, add Reply and Mark as Read buttons, or display delivery progress. Rich notifications boost user engagement.",code:"// Add images, buttons, and actions\nawait admin.messaging().send({\n  token: deviceToken,\n  notification: {\n    title: 'Sale: 50% Off!',\n    body: 'Limited time offer on all items',\n    imageUrl: 'https://myapp.com/sale-banner.jpg',\n  },\n  android: {\n    notification: {\n      clickAction: 'OPEN_SALE_SCREEN',\n    },\n  },\n});"},{t:"Notification Channels",d:"Android requires notification channels so users control which types they receive. Create channels for messages, updates, and promotions with different importance levels. High-priority wakes the screen silently.",code:"// Android requires notification channels (Android 8+)\n// Define in your Android app:\nawait admin.messaging().send({\n  token: deviceToken,\n  android: {\n    notification: {\n      channelId: 'orders',     // must exist in app\n      priority: 'high',\n      sound: 'default',\n    },\n  },\n});\n// Users can control each channel's settings!"},{t:"Token Management",d:"FCM tokens become invalid when users uninstall, clear data, or switch devices. Handle refresh events in your client app and update the server. Remove stale tokens when FCM returns errors to keep data clean.",code:"// Tokens can expire or become invalid\nasync sendPush(token: string, payload: any) {\n  try {\n    await admin.messaging().send({ token, ...payload });\n  } catch (error) {\n    if (error.code === 'messaging/registration-token-not-registered') {\n      // Token expired — remove from database\n      await this.removeToken(token);\n    }\n  }\n}\n// Always handle token errors gracefully!"},{t:"Notification Analytics",d:"Track delivery rates, open rates, and click-through rates to measure engagement. FCM provides delivery receipts. Use this data to optimize send times, personalize content, and stop sending what users ignore.",code:"// Track notification engagement\nawait admin.messaging().send({\n  token: deviceToken,\n  notification: { title: 'Check this out!' },\n  fcmOptions: {\n    analyticsLabel: 'promo_jan_2024',  // track in Firebase console\n  },\n});\n\n// Track in your backend:\n// - Sent count, Delivered count\n// - Opened/clicked rate\n// - Opt-out rate"},{t:"Silent Notifications",d:"Send data-only messages without visible alerts to trigger background work. Use silent notifications to sync data, update cache, or refresh badge counts. Users see nothing, but your app stays current when opened.",code:"// Silent notification â no alert, triggers background code\nconst message = {\n  token: deviceToken,\n  data: {                    // data-only, no 'notification' field\n    type: 'sync',\n    updatedAt: Date.now().toString(),\n  },\n  android: { priority: 'high' },\n  apns: {\n    payload: { aps: { 'content-available': 1 } }, // iOS background fetch\n  },\n};\nawait admin.messaging().send(message);\n// App wakes up silently to sync data!"}],whatIs:"Push notifications let your server send messages directly to a user's device (phone or browser) without the user needing to be on your app. Firebase Cloud Messaging (FCM) is the most popular service for this.",realWorld:"Every app you use sends push notifications — WhatsApp messages, Instagram likes, Uber ride updates, news alerts. FCM handles billions of notifications daily for free.",code:`// 1. Initialize Firebase Admin SDK 🔧
import * as admin from 'firebase-admin';
...
export class NotificationService {
  ...
  {id:27,title:"AWS S3 — File Storage",subtitle:"Your Files in the Cloud",analogy:"S3 is like a magical storage locker with unlimited space. You give each file a unique key (like a locker number), and S3 stores it safely in the cloud. Need it back? Just ask for it by key. It never runs out of space and it never loses your files!",points:[{t:"Object Storage",d:"S3 stores files as objects in containers called buckets. Each object has a unique key, the file data, and metadata. S3 is flat — no real folders, just key prefixes like uploads/images/photo.jpg that mimic directories.",code:"// S3 stores files as objects in buckets\nimport { S3Client, PutObjectCommand } from '@aws-sdk/client-s3';\n\nconst s3 = new S3Client({ region: 'us-east-1' });\n\nawait s3.send(new PutObjectCommand({\n  Bucket: 'my-app-uploads',\n  Key: 'avatars/user-123.jpg',\n  Body: fileBuffer,\n  ContentType: 'image/jpeg',\n}));"},{t:"Pre-Signed URLs",d:"Generate a temporary URL granting upload or download access for a limited time without exposing AWS credentials. The frontend uploads directly to S3, bypassing your server. Reduces load and speeds up file uploads.",code:"// Generate temporary upload/download URLs\nimport { getSignedUrl } from '@aws-sdk/s3-request-presigner';\n\nconst url = await getSignedUrl(s3, new GetObjectCommand({\n  Bucket: 'my-app-uploads',\n  Key: 'avatars/user-123.jpg',\n}), { expiresIn: 3600 }); // 1 hour\n\n// Share URL — works without AWS credentials!\n// Expires automatically for security"},{t:"Scalable & Durable",d:"S3 offers 99.999999999% durability (11 nines) — store 10 million files and expect to lose one every 10,000 years. Data replicates across facilities. Store 1 or 1 billion files with no capacity planning.",code:"// S3 guarantees:\n// - 99.999999999% durability (11 nines!)\n// - 99.99% availability\n// - Unlimited storage\n\n// Store anything:\nawait s3.send(new PutObjectCommand({\n  Bucket: 'backups',\n  Key: \`db-backup-${Date.now()}.sql\`,\n  Body: backupData,\n}));\n// Your data survives even if multiple data centers fail!"},{t:"CDN Integration",d:"Pair S3 with CloudFront CDN to serve files from edge servers nearest to users worldwide. Someone in Tokyo gets images from a nearby server, not US-East. Reduces latency to milliseconds for media-heavy apps.",code:"// CloudFront CDN serves files from edge locations worldwide\n// User in Tokyo? Served from Tokyo edge, not US server!\n\n// CloudFront URL instead of S3 URL:\n// Before: https://my-bucket.s3.amazonaws.com/image.jpg (slow)\n// After:  https://d1234.cloudfront.net/image.jpg (fast!)\n\n// Configure in AWS:\n// CloudFront Distribution → Origin: your S3 bucket\n// Result: ~50ms load time instead of ~500ms"},{t:"Versioning",d:"Enable bucket versioning to keep every version of every file. Accidentally deleted an image or overwrote a document? Restore a previous version with one API call. Also protects against malicious deletions.",code:"// Enable versioning to keep file history\n// AWS Console: Bucket → Properties → Versioning → Enable\n\n// Every upload creates a new version\nawait s3.send(new PutObjectCommand({\n  Bucket: 'my-bucket',\n  Key: 'config.json',  // same key, new version\n  Body: newConfig,\n}));\n\n// Retrieve old version:\n// GET /config.json?versionId=abc123\n// Accidentally deleted? Restore from versions!"},{t:"Access Control",d:"Control access with bucket policies, IAM roles, and ACLs. Make profile images public while keeping invoices private. Grant your backend upload permissions via IAM without access to delete other buckets.",code:"// Control who can access your files\n// Bucket policy — allow public read for avatars\n{\n  \"Statement\": [{\n    \"Effect\": \"Allow\",\n    \"Principal\": \"*\",\n    \"Action\": \"s3:GetObject\",\n    \"Resource\": \"arn:aws:s3:::my-bucket/public/*\"\n  }]\n}\n\n// Private by default — use pre-signed URLs\n// Never make entire bucket public!"},{t:"Cost Effective",d:"S3 pricing is pay-as-you-go: about $0.023 per GB/month for standard storage. Store thousands of images for pennies. Use S3 Glacier for rarely-accessed files at even lower rates. Pay only for what you use.",code:"// S3 pricing (very cheap!)\n// Storage: ~$0.023/GB/month\n// 100GB of images = ~$2.30/month!\n\n// Save money with lifecycle rules:\n// After 30 days → move to S3 Infrequent Access ($0.0125/GB)\n// After 90 days → move to Glacier ($0.004/GB)\n// After 365 days → delete\n\n// Configure in bucket settings or AWS CLI"},{t:"Storage Classes",d:"S3 offers storage classes: Standard for frequent access, Intelligent-Tiering for unpredictable patterns, Glacier for archival. Set lifecycle rules to auto-move files to cheaper tiers after 30 or 90 days.",code:"// Different storage tiers for different needs\nawait s3.send(new PutObjectCommand({\n  Bucket: 'my-bucket',\n  Key: 'archive/old-report.pdf',\n  Body: fileData,\n  StorageClass: 'GLACIER',  // cheap long-term storage\n}));\n\n// Standard: frequent access (~$0.023/GB)\n// IA: infrequent access (~$0.0125/GB)\n// Glacier: archival (~$0.004/GB)\n// Glacier Deep: rarely accessed (~$0.00099/GB)"},{t:"File Upload Best Practices",d:"Generate unique keys with timestamps or UUIDs to prevent collisions: uploads/1709234567-photo.jpg. Validate file types and sizes on both frontend and backend. Set Content-Type so browsers render files correctly.",code:"// Validate uploads on the server!\n@Post('upload')\n@UseInterceptors(FileInterceptor('file', {\n  limits: { fileSize: 5 * 1024 * 1024 },  // 5MB max\n  fileFilter: (req, file, cb) => {\n    if (!file.mimetype.match(/image\\/(jpg|jpeg|png|gif)/)) {\n      cb(new Error('Only images allowed!'), false);\n    }\n    cb(null, true);\n  },\n}))\nasync upload(@UploadedFile() file: Express.Multer.File) {}"},{t:"Multipart Uploads",d:"For files over 100MB, multipart upload splits them into chunks uploaded in parallel. If one chunk fails, only that chunk retries. AWS SDK handles this via the Upload class, making large uploads reliable.",code:"// Multipart upload â for large files (100MB+)\nconst upload = new Upload({\n  client: s3Client,\n  params: {\n    Bucket: 'my-bucket',\n    Key: 'large-video.mp4',\n    Body: fileStream,\n  },\n  partSize: 10 * 1024 * 1024, // 10MB chunks\n  leavePartsOnError: false,\n});\n\n// Track progress\nupload.on('httpUploadProgress', (p) => {\n  console.log(`Uploaded: ${p.loaded}/${p.total} bytes`);\n});\n\nawait upload.done();"}],whatIs:"Amazon S3 (Simple Storage Service) is cloud-based object storage. It's where you store files like images, documents, videos, and backups. Files are organized in buckets and accessed via unique keys.",realWorld:"Netflix stores all their content on S3. Airbnb stores listing photos. Almost every app that handles file uploads uses S3 or a similar service (Google Cloud Storage, Azure Blob).",code:`// 1. Upload a file to S3 📤
import { S3Client, PutObjectCommand } from '@aws-sdk/client-s3';
...
export class FileController {
  ...
  {id:28,title:"WebSockets & Real-Time",subtitle:"Live Updates Without Refreshing",analogy:"Normal HTTP is like sending letters — you send a question, wait for a reply. WebSockets are like a phone call — once connected, both sides can talk anytime! That's how live chat, notifications, and collaborative editing work.",points:[{t:"Persistent Connection",d:"Unlike HTTP where each request opens a new connection (connect, send, disconnect, repeat), WebSockets establish a single persistent connection that stays open. Both client and server can send messages at any time without the overhead of reconnecting. This enables true real-time two-way communication with minimal latency.",code:"// HTTP: client asks, server responds, connection closes\n// WebSocket: connection stays open for real-time data!\n\n// Client connects once:\nconst socket = io('http://localhost:3000');\n\n// Server can push data anytime:\nsocket.on('message', (data) => {\n  console.log('New message:', data);  // instant!\n});\n// No need to keep asking 'any new messages?'"},{t:"Socket.IO",d:"Socket.IO is the most popular WebSocket library for JavaScript. It wraps raw WebSockets with powerful features: automatic reconnection when the connection drops, room-based messaging for group communication, binary data support, and graceful fallbacks for environments where WebSockets are not available.",code:"// Socket.IO makes WebSockets easy\n// Server:\nimport { Server } from 'socket.io';\nconst io = new Server(3000);\n\nio.on('connection', (socket) => {\n  console.log('User connected:', socket.id);\n  socket.on('chat', (msg) => {\n    io.emit('chat', msg);  // send to everyone\n  });\n});"},{t:"Rooms",d:"Rooms let you group WebSocket connections together so you can broadcast messages to specific subsets of users. For example, everyone in Chat Room 5 receives new messages but users in other rooms do not. Rooms are also useful for game lobbies, collaborative document sessions, and per-user notification channels.",code:"// Rooms = groups of sockets\n// Join a room\nsocket.join('room-123');\n\n// Send to everyone in a room\nio.to('room-123').emit('message', 'Hello room!');\n\n// Leave a room\nsocket.leave('room-123');\n\n// Great for: chat rooms, game lobbies,\n// order tracking, collaborative editing"},{t:"NestJS Gateway",d:"NestJS provides built-in WebSocket support through the @WebSocketGateway() decorator. Define event handlers with @SubscribeMessage('eventName') just like you define HTTP routes with @Get(). The gateway integrates with NestJS dependency injection, guards, and interceptors for clean, organized real-time code.",code:"// NestJS WebSocket gateway\nimport { WebSocketGateway, SubscribeMessage } from '@nestjs/websockets';\n\n@WebSocketGateway()\nexport class ChatGateway {\n  @SubscribeMessage('message')\n  handleMessage(client: any, payload: { text: string }) {\n    this.server.emit('message', payload);\n    return { event: 'message', data: 'received!' };\n  }\n}"},{t:"Broadcasting",d:"Send messages to a single connected client, a specific room (group of users), or broadcast to every connected user at once. Socket.IO provides flexible methods: socket.emit (one user), socket.to('room').emit (room only), and io.emit (everyone). This gives you precise control over who receives each update.",code:"// Send to everyone, some, or one\n@WebSocketGateway()\nexport class ChatGateway {\n  @WebSocketServer() server: Server;\n\n  broadcast(event: string, data: any) {\n    this.server.emit(event, data);           // to ALL\n    this.server.to('room1').emit(event, data); // to room\n    client.broadcast.emit(event, data);      // all EXCEPT sender\n  }\n}"},{t:"Reconnection Logic",d:"Network interruptions are inevitable on mobile devices and unstable connections. Socket.IO handles reconnection automatically with configurable retry intervals and exponential backoff. The client detects disconnection, queues outgoing messages, reconnects seamlessly, and replays missed messages — users barely notice the blip.",code:"// Socket.IO handles reconnection automatically!\nconst socket = io('http://localhost:3000', {\n  reconnection: true,\n  reconnectionAttempts: 5,\n  reconnectionDelay: 1000,     // start at 1 second\n  reconnectionDelayMax: 5000,  // max 5 seconds\n});\n\nsocket.on('reconnect', (attempt) => {\n  console.log(\`Reconnected after ${attempt} attempts\`);\n});"},{t:"Namespaces for Separation",d:"Socket.IO namespaces let you separate WebSocket logic into distinct channels on the same server. Create /chat for messaging, /notifications for alerts, and /live-scores for sports updates. Each namespace has its own event handlers, rooms, and middleware — keeping your real-time code organized and maintainable.",code:"// Namespaces — separate concerns on same connection\n@WebSocketGateway({ namespace: 'chat' })\nexport class ChatGateway {\n  @SubscribeMessage('message')\n  handleMessage(data: string) { /* chat logic */ }\n}\n\n@WebSocketGateway({ namespace: 'notifications' })\nexport class NotifyGateway {\n  @SubscribeMessage('subscribe')\n  handleSubscribe(data: any) { /* notification logic */ }\n}\n\n// Client connects to specific namespace\nconst chat = io('http://localhost:3000/chat');\nconst notify = io('http://localhost:3000/notifications');"},{t:"Authentication for WebSockets",d:"WebSocket connections need authentication just like HTTP routes. Pass the JWT token during the connection handshake and verify it in a middleware or guard before allowing the socket to join. Without authentication, anyone could connect and listen to private messages. NestJS guards work seamlessly with WebSocket gateways.",code:"// WebSocket authentication via handshake\n@WebSocketGateway()\nexport class ChatGateway implements OnGatewayConnection {\n  async handleConnection(client: Socket) {\n    const token = client.handshake.auth.token;\n    try {\n      const user = await this.jwt.verify(token);\n      client.data.user = user; // attach user to socket\n    } catch (e) {\n      client.disconnect(); // invalid token â kick out\n    }\n  }\n\n  @SubscribeMessage('message')\n  handleMessage(client: Socket, data: string) {\n    const user = client.data.user; // authenticated user!\n    this.server.emit('message', { user: user.name, text: data });\n  }\n}"}],whatIs:"WebSockets provide a persistent, bidirectional communication channel between client and server. Unlike HTTP (request-response), WebSocket connections stay open, allowing the server to push data to clients in real-time.",realWorld:"Slack, Discord, WhatsApp Web, Google Docs collaborative editing, live sports scores, stock tickers — all use WebSockets for real-time updates.",code:`// 1. NestJS WebSocket Gateway 🚀
@WebSocketGateway({
  cors: { origin: '*' },
})
export class ChatGateway {
...
describe('POST /auth/login', () => {
  ...
  {id:30,title:"Docker — Containers Explained",subtitle:"Ship Your App in a Box",analogy:"Remember when you shared a school project and your friend said 'it doesn't work on my computer'? Docker solves this. It puts your app in a shipping container (image) that works EXACTLY the same on ANY computer. No more 'works on my machine'!",points:[{t:"Containers",d:"A Docker container is a lightweight, isolated environment that packages your application with everything it needs to run: code, runtime, libraries, and system tools. Unlike virtual machines, containers share the host OS kernel so they start in seconds and use minimal resources. Each container is isolated from others.",code:"# Run a container\ndocker run -d --name my-app -p 3000:3000 node:18\n\n# List running containers\ndocker ps\n\n# Stop and remove\ndocker stop my-app\ndocker rm my-app"},{t:"Images",d:"A Docker image is the blueprint for creating containers — like a recipe that produces the exact same dish every time. Images are built from a Dockerfile that specifies the base OS, your application code, dependencies, and startup command. Share images via Docker Hub so anyone can run your app identically.",code:"# Dockerfile — recipe for your image\nFROM node:18-alpine\nWORKDIR /app\nCOPY package*.json ./\nRUN npm install\nCOPY . .\nRUN npm run build\nCMD [\"node\", \"dist/main.js\"]\n\n# Build: docker build -t my-app .\n# Run:   docker run -p 3000:3000 my-app"},{t:"Docker Compose",d:"Docker Compose lets you define and run multi-container applications with a single YAML file. Your app needs Node.js, MongoDB, and Redis? Define all three services in docker-compose.yml and run docker compose up to start everything together with proper networking. One command replaces complex setup instructions.",code:"# docker-compose.yml\nversion: '3.8'\nservices:\n  app:\n    build: .\n    ports: ['3000:3000']\n    depends_on: [db, redis]\n  db:\n    image: postgres:15\n    environment:\n      POSTGRES_PASSWORD: secret\n  redis:\n    image: redis:7-alpine\n\n# Start all: docker compose up -d"},{t:"Consistent Environments",d:"Docker ensures development, staging, and production run the exact same containerized environment. If your app works in the Docker container on your laptop, it will work the same way on the production server. This eliminates the entire class of 'works on my machine' bugs caused by environment differences.",code:"# Same setup everywhere!\n# Developer A (Mac):  docker compose up → works\n# Developer B (Linux): docker compose up → works\n# CI/CD server:       docker compose up → works\n# Production:         docker compose up → works\n\n# No more \"works on my machine\" problems!"},{t:"Layering",d:"Docker images are built in layers: each instruction in your Dockerfile creates a new layer. When you rebuild, Docker caches unchanged layers and only rebuilds what changed. Put rarely-changing layers (like npm install) before frequently-changing ones (like copying source code) for dramatically faster builds.",code:"# Each instruction creates a layer (cached!)\nFROM node:18-alpine       # Layer 1: base OS\nWORKDIR /app              # Layer 2: set directory\nCOPY package*.json ./     # Layer 3: dependency files\nRUN npm install           # Layer 4: install deps (cached if package.json unchanged!)\nCOPY . .                  # Layer 5: app code\nRUN npm run build         # Layer 6: build\n\n# Change app code? Only layers 5-6 rebuild!"},{t:"Image Size Matters",d:"Smaller images download faster and use less disk space. Start with alpine-based images (a tiny 5MB Linux distro instead of 900MB Ubuntu). Use multi-stage builds to compile in one stage and copy only the production artifacts to a minimal final image. Add a .dockerignore file to exclude node_modules and .git.",code:"# Multi-stage build — small final image!\nFROM node:18 AS builder\nWORKDIR /app\nCOPY . .\nRUN npm install && npm run build\n\n# Final image: only production files\nFROM node:18-alpine\nWORKDIR /app\nCOPY --from=builder /app/dist ./dist\nCOPY --from=builder /app/node_modules ./node_modules\nCMD [\"node\", \"dist/main.js\"]\n\n# Result: ~200MB instead of ~1GB!"},{t:"Volumes for Persistent Data",d:"Containers are ephemeral — when they stop, their data disappears. Docker volumes persist data outside the container lifecycle. Mount a volume for your MongoDB data directory so database records survive container restarts. Volumes also enable sharing data between containers and backing up important data.",code:"# Volumes keep data even when container is deleted\nservices:\n  db:\n    image: postgres:15\n    volumes:\n      - pgdata:/var/lib/postgresql/data\n\nvolumes:\n  pgdata:  # named volume — persists across restarts\n\n# Dev: mount local code for hot reload\n  app:\n    volumes:\n      - ./src:/app/src  # local changes reflected instantly"},{t:"Networking Between Containers",d:"Docker Compose creates a private network where containers can communicate using service names as hostnames. Your Node.js app connects to MongoDB at mongodb://mongo:27017 where 'mongo' is the service name. Expose only the ports you need to the outside world, keeping internal services like databases safely hidden.",code:"# Docker Compose creates a network automatically\nservices:\n  app:\n    environment:\n      DATABASE_URL: postgresql://db:5432/myapp  # 'db' = service name!\n      REDIS_URL: redis://redis:6379\n  db:\n    image: postgres:15\n  redis:\n    image: redis:7\n\n# Services find each other by name — no IP addresses!"}],whatIs:"Docker packages your application and all its dependencies into a standardized container. A container is like a lightweight virtual machine that runs consistently on any system with Docker installed.",realWorld:"Almost every company uses Docker: Google runs billions of containers weekly. Spotify, PayPal, and Uber all use Docker for deployment. It's become a standard part of modern development.",code:`// Dockerfile — the recipe for your app container 📝
FROM node:20-alpine
...
coverage/`,funFact:"Linus Torvalds (creator of Linux) built Git in just 10 days in 2005 because he was frustrated with existing version control tools. He named it 'git' — British slang for an annoying person — saying 'I name all my projects after myself.'",quiz:[{q:"What does 'git add' do?",opts:["Uploads files to GitHub","Stages files to be included in the next commit","Creates a new branch","Deletes files from the repository"],ans:1},{q:"What is the purpose of branching in Git?",opts:["To make the repository larger","To work on features in parallel without affecting the main code","To speed up Git operations","To create backup copies of files"],ans:1},{q:"What should you put in a .gitignore file?",opts:["Your most important source code files","Files that should not be tracked: node_modules, .env, build outputs","Only JavaScript files","Files larger than 1MB"],ans:1},{q:"What does 'git stash' do?",opts:["Temporarily saves uncommitted changes so you can switch branches and restore them later with git stash pop","Permanently deletes uncommitted changes","Pushes changes to the remote repository","Creates a new branch automatically"],ans:0},{q:"Why are good commit messages important?",opts:["They make the repo larger","They are shown to users","They have no real purpose","They help your future self and teammates understand WHY changes were made when reviewing history"],ans:3}],challenge:"Initialize a new Git repo, create a .gitignore (ignore node_modules and .env), make your first commit. Then create a 'feature-hello' branch, add a hello.ts file, commit it, and merge back into main. Check git log to see the history!",resources:[{type:"docs",title:"Git Official Documentation",url:"https://git-scm.com/doc",source:"Git Official"},{type:"article",title:"Atlassian Git Tutorial",url:"https://www.atlassian.com/git/tutorials",source:"Atlassian"},{type:"video",title:"Git Explained in 100 Seconds",url:"https://www.youtube.com/watch?v=hwP7WQkmECE",source:"Fireship"}],eli5:"Git is like a time machine for your homework. Every time you finish a page, you take a photo (commit). If you mess up page 3, go back to page 2's photo! You can also make a copy to try something wild (branch), and if it works, put it back (merge).",codeWalkthrough:["Initialize a new project","Git command","Git command","Git command","","Connect to GitHub","Git command","Git command","","Daily workflow","Git command","Git command","Git command","Git command","","Branching workflow","Git command","Git command","... make changes ...","Git command","Git command","Git command","-> Open Pull Request on GitHub","-> Team reviews and approves","-> Merge into main","","Useful commands","Git command","Git command","Git command","Git command","Git command","Git command","",".gitignore","","","Method chaining on the previous expression","Method chaining on the previous expression",".log","Method chaining on the previous expression",""],bugChallenge:{"code":"git add .\ngit commit -m \"initial commit\"\ngit push origin main","hint":"What files might be included when you use 'git add .'?","answer":"Without a .gitignore, 'git add .' commits EVERYTHING including .env secrets and node_modules. Fix: create .gitignore with node_modules/, .env, dist/ BEFORE git add."},difficulty:"beginner",prereqs:[]},
  ...
  {id:32,title:"Deployment & DevOps",subtitle:"From Code to Production",analogy:"Writing code is like building a rocket in your garage. Deployment is launching it into orbit — you need a launchpad (server), enough fuel for the journey (scaling), a pre-flight checklist that never changes (CI/CD), and mission control watching every sensor (monitoring)!",points:[{t:"CI/CD Pipeline",d:"Continuous Integration and Continuous Deployment automates your entire workflow: push code to Git, automated tests run, linting checks pass, and if everything succeeds, the app deploys automatically to production. No manual steps, no human error. GitHub Actions, GitLab CI, and CircleCI are popular CI/CD platforms.",code:"# .github/workflows/deploy.yml\nname: Deploy\non:\n  push:\n    branches: [main]\njobs:\n  deploy:\n    runs-on: ubuntu-latest\n    steps:\n      - uses: actions/checkout@v4\n      - run: npm ci\n      - run: npm test\n      - run: npm run build"},{t:"Environment Variables",d:"Each deployment environment (development, staging, production) needs different configuration: database URLs, API keys, feature flags, and log levels. Store these as environment variables, never hardcode them. Your CI/CD platform injects the right values for each environment automatically during deployment.",code:"# GitHub Actions — inject secrets\nsteps:\n  - name: Deploy\n    env:\n      DATABASE_URL: ${{ secrets.DATABASE_URL }}\n      JWT_SECRET: ${{ secrets.JWT_SECRET }}\n    run: npm run deploy\n\n# Never hardcode secrets in code!"},{t:"Container Orchestration",d:"Docker Compose manages multi-container apps on a single server. For larger scale, Kubernetes orchestrates containers across many servers: auto-scaling when traffic spikes, restarting crashed containers, rolling out updates with zero downtime. Start with Docker Compose and graduate to Kubernetes when your app demands it.",code:"# Kubernetes deployment\napiVersion: apps/v1\nkind: Deployment\nspec:\n  replicas: 3\n  template:\n    spec:\n      containers:\n      - name: app\n        image: my-app:latest\n        ports: [{ containerPort: 3000 }]"},{t:"Monitoring & Logging",d:"Production apps need observability: structured logging with tools like Winston or Pino, error tracking with Sentry, performance monitoring with Datadog or New Relic, and uptime monitoring with Pingdom. If something breaks at 3 AM, automated alerts notify your team immediately via Slack, email, or PagerDuty.",code:"// Structured logging\nconst logger = new Logger('UserService');\n\nlogger.log('User created', { userId: 123 });\nlogger.warn('Slow query', { duration: '500ms' });\nlogger.error('Payment failed', { orderId: 456 });\n\n// Health check endpoint\n@Get('health')\ncheck() { return { status: 'ok', uptime: process.uptime() }; }"},{t:"Scaling",d:"When traffic grows beyond what one server can handle, scale horizontally by adding more instances behind a load balancer. The load balancer distributes incoming requests across all instances evenly. Make your app stateless (store sessions in Redis, files in S3) so any instance can handle any request interchangeably.",code:"# Horizontal: more instances\ndocker compose up --scale app=3\n\n# Auto-scaling (Kubernetes)\nspec:\n  minReplicas: 2\n  maxReplicas: 10\n  targetCPUUtilizationPercentage: 70\n\n# Load balancer distributes traffic across instances"},{t:"SSL/HTTPS — Secure Your App",d:"Production apps MUST use HTTPS to encrypt data in transit. Use Let's Encrypt for free SSL certificates, or your cloud provider's certificate manager. Never transmit passwords or tokens over plain HTTP — it's like sending postcards instead of sealed letters.",code:"# Nginx + Let's Encrypt (free SSL)\nserver {\n  listen 443 ssl;\n  server_name myapp.com;\n  ssl_certificate /etc/letsencrypt/live/myapp.com/fullchain.pem;\n  ssl_certificate_key /etc/letsencrypt/live/myapp.com/privkey.pem;\n  location / { proxy_pass http://localhost:3000; }\n}"},{t:"Secrets Management",d:"Never hardcode API keys or passwords in your code. Use environment variables (.env files locally, secret managers in production). Tools like AWS Secrets Manager, HashiCorp Vault, or even GitHub Secrets keep your sensitive data safe and separate from code.",code:"// Cloud secrets (AWS example)\nconst client = new SecretsManager();\nconst secret = await client.getSecretValue({\n  SecretId: 'my-app/production'\n});\nconst config = JSON.parse(secret.SecretString);\n// config.DATABASE_URL, config.JWT_SECRET\n// Never in code or .env in production!"},{t:"Blue-Green & Canary Deployments",d:"Blue-green deployment runs two identical environments: blue (current) and green (new version). Switch traffic to green once verified. Canary deployment routes a small percentage of traffic (like 5%) to the new version first, then gradually increases. Both strategies minimize risk and enable instant rollback if issues arise.",code:"// Blue-Green: two identical environments\n// Blue (v1) ← current traffic\n// Green (v2) ← new version testing\n// Switch: route all traffic to Green\n// Rollback: switch back to Blue!\n\n// Canary: gradual rollout\n// v1: 90% traffic → v2: 10% traffic\n// If stable, increase v2 to 100%"},{t:"Infrastructure as Code",d:"Define your servers, databases, and networking in code files (Terraform, Pulumi, or AWS CDK) instead of clicking through cloud consoles. Version control your infrastructure alongside your application code. Recreate entire environments from scratch with a single command — reproducible, auditable, and disaster-proof.",code:"// Terraform — define infrastructure in code\nresource \"aws_instance\" \"app\" {\n  ami           = \"ami-0c55b159\"\n  instance_type = \"t3.micro\"\n  tags = { Name = \"my-app\" }\n}\n\n// terraform plan  → preview changes\n// terraform apply → create infrastructure"}],whatIs:"Deployment is the process of getting your code from your laptop to a server where users can access it. DevOps practices (CI/CD, containers, monitoring) make this reliable, repeatable, and automated.",realWorld:"Netflix deploys thousands of times per day. Amazon deploys every 11.7 seconds. Modern CI/CD pipelines make this possible — push code, let the robots handle the rest.",code:`# 1. GitHub Actions CI/CD 🤖
...
// turbo.json — configure what to cache
{
  ...
  {id:34,title:"React vs React Native",subtitle:"Web vs Mobile — Same Brain, Different Body",analogy:"React is like a musician who performs in a concert hall (web browser). React Native is the SAME musician performing at an outdoor festival (mobile phone). Same songs (JavaScript/React), same talent — but different stage equipment (HTML elements vs native phone components)!",points:[{t:"Same Language",d:"Both use JavaScript/TypeScript and React concepts (components, hooks, state). If you know React, learning React Native is just learning new component names!",code:"// React (Web)\nconst App = () => <div>Hello Web!</div>;\n\n// React Native (Mobile) — same JS/TS!\nconst App = () => <View><Text>Hello Mobile!</Text></View>;\n\n// Same: hooks, state, props, TypeScript"},{t:"Different Output",d:"React renders HTML elements (div, span, p). React Native renders native mobile components (View, Text, TouchableOpacity). Web = browser. Mobile = iOS/Android.",code:"// React → HTML elements\n<div className=\"card\"><h1>Title</h1></div>\n\n// React Native → native mobile components\n<View style={styles.card}><Text>Title</Text></View>\n// Renders REAL native UI, not a web view!"},{t:"Code Sharing",d:"Business logic, API calls, state management — all can be shared between web (React) and mobile (React Native)! Only UI differs.",code:"// Shared logic works in both!\nexport function formatPrice(cents: number): string {\n  return '$' + (cents / 100).toFixed(2);\n}\n\nexport async function fetchUser(id: number) {\n  return fetch('/api/users/' + id).then(r => r.json());\n}\n// Import in React OR React Native!"},{t:"Expo for Easy Setup",d:"Expo is to React Native what create-react-app is to React. Instant setup, hot reload, testing on your phone instantly. No Android Studio!",code:"npx create-expo-app my-app\ncd my-app\nnpx expo start\n// Scan QR code on phone → see your app!\n// No Xcode or Android Studio needed"},{t:"Styling Differences",d:"React uses CSS. React Native uses StyleSheet (like inline styles). No CSS here — just JavaScript objects. Learn once, apply everywhere!",code:"// React: CSS classes\n<div className=\"bg-white rounded-lg p-4\">\n\n// React Native: StyleSheet objects\nconst styles = StyleSheet.create({\n  card: {\n    backgroundColor: 'white',\n    borderRadius: 12,\n    padding: 16,\n  },\n});"},{t:"Navigation Different",d:"React Router for web. React Navigation for mobile. Different APIs but same concepts (stacks, tabs, drawers).",code:"// React: URL-based (React Router)\n<Route path=\"/profile/:id\" element={<Profile />} />\n\n// React Native: stack-based (React Navigation)\n<Stack.Screen name=\"Profile\" component={Profile} />\nnavigation.navigate('Profile', { id: 1 });"},{t:"Performance Considerations",d:"React Native apps can be slower than native (written in Swift/Kotlin) but much faster to develop. Trade-off between speed and time-to-market!",code:"// Use FlatList for large lists (not ScrollView)\n<FlatList\n  data={items}\n  renderItem={({ item }) => <Item data={item} />}\n  keyExtractor={item => item.id}\n/>\n\n// Memoize expensive components\nconst MemoItem = React.memo(Item);"},{t:"Third-Party Libraries",d:"Some npm packages work on web only. Check compatibility! React Navigation, Expo libraries work cross-platform. Native modules need bridges!",code:"// Work in both React & React Native\nimport axios from 'axios';     // HTTP\nimport dayjs from 'dayjs';     // dates\nimport { z } from 'zod';       // validation\n\n// Platform-specific\nimport AsyncStorage from '@react-native-async-storage'; // mobile\nimport { useRouter } from 'next/router';                 // web"}],whatIs:"React Native lets you build native mobile apps (iOS + Android) using React and JavaScript. Unlike hybrid apps (like Cordova), React Native renders REAL native UI components — so your app feels native because it IS native.",realWorld:"Facebook, Instagram, Discord, Shopify, and Pinterest all use React Native. Many teams share 60-80% of code between web (React) and mobile (React Native).",code:`// React (Web) 🌐
function Welcome() {
  return (
...
function UserList() {
  ...
  {id:35,title:"Putting It All Together",subtitle:"The Full Picture",analogy:"You've learned each instrument individually. Now it's time to play in the orchestra! Each technology is one musician — alone they sound good, but TOGETHER they create a symphony. Your fullstack app is that symphony! 🎵",points:[{t:"Frontend to Backend",d:"React makes API calls using Axios or React Query, which hit NestJS controllers. Controllers delegate to services for business logic. Services use Prisma to query MongoDB. The response flows back through the same chain. This clean separation means each layer can be tested, modified, and scaled independently.",code:"// Full request flow:\n// React → axios.post('/api/users', { name: 'Alice' })\n// NestJS Controller → @Post() create(@Body() dto)\n// Service → business logic\n// Prisma → database query\n// Response flows back to React"},{t:"Real-Time Layer",d:"Socket.IO establishes persistent WebSocket connections between React and NestJS gateways. When data changes on the server (new message, order update), the gateway pushes updates to connected clients instantly — no polling or page refreshing needed. Combine with Redis Pub/Sub for multi-server real-time support.",code:"// WebSocket for instant updates\n// Backend:\nthis.server.to('room-1').emit('newMessage', { text: 'Hi!' });\n\n// Frontend:\nsocket.on('newMessage', (msg) => {\n  setMessages(prev => [...prev, msg]);\n});"},{t:"Background Work",d:"Bull queues offload slow tasks like sending emails, processing images, generating PDFs, and sending push notifications. Redis stores the queue state. Your API responds instantly with 'job accepted' while background workers process tasks asynchronously. Failed jobs retry automatically without losing data.",code:"@Post('register')\nasync register(@Body() dto: RegisterDto) {\n  const user = await this.userService.create(dto);\n  await this.emailQueue.add('welcome', { userId: user.id });\n  return user; // respond immediately, email sent in background\n}"},{t:"Infrastructure",d:"Docker containers package each service (Node app, MongoDB, Redis) with its dependencies. Docker Compose orchestrates them locally. CI/CD pipelines (GitHub Actions) run tests and deploy automatically on every push. ESLint and Prettier enforce code quality through pre-commit hooks. Everything is automated.",code:"# docker-compose.yml\nservices:\n  api:    { build: ./apps/api, ports: ['3000:3000'] }\n  web:    { build: ./apps/web, ports: ['5173:5173'] }\n  db:     { image: postgres:15 }\n  redis:  { image: redis:7 }\n# docker compose up — entire stack running!"},{t:"Security and Performance",d:"JWT authentication protects API routes, HTTPS encrypts data in transit, and CORS controls which domains can call your API. Redis caching reduces database load for frequently accessed data. Database indexes speed up queries. CloudFront CDN serves static files and images from edge servers closest to users.",code:"app.enableCors({ origin: ALLOWED_ORIGINS });\napp.use(helmet());                          // security headers\napp.useGlobalPipes(new ValidationPipe());   // input validation\n@UseGuards(JwtAuthGuard)                    // authentication\n@UseGuards(ThrottlerGuard)                  // rate limiting"},{t:"Error Handling Strategy",d:"Implement a global NestJS exception filter that catches all errors and returns consistent JSON responses with status codes, messages, and error details. On the frontend, React error boundaries catch rendering errors gracefully. Structured logging with correlation IDs lets you trace any request through every layer of the stack.",code:"@Catch()\nexport class GlobalFilter implements ExceptionFilter {\n  catch(exception: unknown, host: ArgumentsHost) {\n    const status = exception instanceof HttpException\n      ? exception.getStatus() : 500;\n    this.logger.error(exception);\n    if (status >= 500) this.alertService.notify(exception);\n    response.status(status).json({ error: true, message });\n  }\n}"},{t:"Data Flow Architecture",d:"Understand how data flows through your entire system: user action in React triggers an API call, which passes through guards (auth), pipes (validation), controllers, services, and finally the database. On the way back, interceptors can transform the response. Knowing this flow helps you debug issues at any layer.",code:"// Clean layers — each has one job\nReact Component\n  → React Query (cache + fetch)\n    → NestJS Controller (routes)\n      → ValidationPipe (validate input)\n        → Service (business logic)\n          → Prisma (database)\n            → Response back up"},{t:"Monitoring and Observability",d:"Production applications need three pillars of observability: logs (structured JSON logs with Winston or Pino), metrics (response times, error rates, CPU usage), and traces (follow a request through every service). Tools like Sentry for error tracking and Datadog for dashboards give you visibility into your running system.",code:"@Get('health')\ncheck() {\n  return { status: 'ok', uptime: process.uptime() };\n}\n\n// Error tracking with Sentry\nimport * as Sentry from '@sentry/node';\nSentry.init({ dsn: process.env.SENTRY_DSN });"}],whatIs:"A fullstack NestJS + React application combines everything you've learned: React frontend, NestJS backend, MongoDB database, Redis cache, Bull queues, JWT auth, Docker containers, and CI/CD pipelines — all working together as one system.",realWorld:"This is the exact architecture used by thousands of production applications. Companies like Adidas, Roche, and countless startups run this stack in production serving millions of users.",code:`// The Complete Request Flow 🌊
//
...
// Quality:   ESLint + Prettier + Husky`,funFact:"If you've made it this far, you've learned about 25+ technologies that professional fullstack developers use daily. That's more tech than most bootcamps cover in 12 weeks! 🏆",quiz:[{q:"In the full request flow, what happens AFTER the user gets their response?",opts:["Nothing — the server stops","Background workers handle slow tasks like emails and notifications","The server shuts down","The database deletes the data"],ans:1},{q:"Which of these is the frontend of our stack?",opts:["NestJS","MongoDB","React + Vite + Tailwind","Docker"],ans:2},{q:"What's responsible for sending emails in the background?",opts:["React","MongoDB","Bull queues powered by Redis","NestJS directly"],ans:2},{q:"In the fullstack request flow, what role does Redis play between the API and database?",opts:["It serves as a fast cache layer — checked before the database, storing frequently-accessed data for near-instant retrieval","It replaces the database entirely","It only stores user sessions","It handles file uploads"],ans:0},{q:"Why should background tasks like emails and notifications be processed through a job queue?",opts:["Job queues are required by NestJS","Queues make emails more secure","Queues cost less money","So the user gets an instant API response while slow tasks run asynchronously without blocking the request"],ans:3}],challenge:"Draw the entire architecture on paper (or a whiteboard): React → NestJS → MongoDB, with Redis, Bull, S3, and FCM connected. Label each arrow with what data flows through it!",resources:[{type:"docs",title:"NestJS Full Example",url:"https://github.com/nestjs/nest/tree/master/sample",source:"NestJS GitHub"},{type:"docs",title:"NestJS Configuration",url:"https://docs.nestjs.com/techniques/configuration",source:"NestJS Official"},{type:"article",title:"NestJS Official Documentation",url:"https://docs.nestjs.com/",source:"NestJS Official"}],eli5:"You have learned to play piano, guitar, drums, and singing separately. Now it is time to play in a band! Each instrument sounds nice alone, but together they make beautiful music. A fullstack app is all your technologies playing in harmony!",codeWalkthrough:["The Complete Request Flow 🌊","","1. User clicks \"Sign Up\" in React","└→ React Hook Form validates with Zod","└→ Axios sends POST /auth/signup","","2. NestJS receives the request","└→ ValidationPipe checks the DTO","└→ AuthController.signup() runs","└→ AuthService.register() is called","","3. Business logic executes","└→ Prisma creates user in MongoDB","└→ JWT token is generated","└→ Bull queue: add \"send welcome email\" job","└→ Bull queue: add \"send push notification\" job","","4. Response sent to React","└→ { user, access_token }","└→ React stores token in memory","└→ React Query caches user data","└→ React Router redirects to /dashboard","","5. Background (user doesn't wait!)","└→ Bull worker sends welcome email via SES","└→ Bull worker sends push notification via FCM","└→ Redis caches the new user data","","6. Dashboard loads","└→ React Query fetches /api/dashboard","└→ NestJS checks JWT (Guard)","└→ Redis cache checked first (fast!)","└→ If miss → MongoDB query → cache result","└→ Dashboard renders with real-time data","","The whole flow: ~200ms for the user","Background tasks: ~5-10 seconds (user doesn't notice!) 🚀","","Your tech stack summary:","Frontend:  React + Vite + TypeScript + Tailwind + React Query","Backend:   NestJS + Prisma + MongoDB","Cache:     Redis","Queue:     Bull (powered by Redis)","Auth:      JWT + Passport","Files:     AWS S3","Email:     AWS SES / Mailgun","Push:      Firebase Cloud Messaging","Realtime:  Socket.IO","Container: Docker + Docker Compose","CI/CD:     GitHub Actions","Quality:   ESLint + Prettier + Husky"],bugChallenge:{"code":"const app = await NestFactory.create(AppModule);\nawait app.listen(4000);\n\n// React on localhost:3000\nfetch('http://localhost:4000/api/users')","hint":"What happens when React on one port calls NestJS on another?","answer":"Browser blocks the request due to CORS - frontend (port 3000) and backend (port 4000) are different origins. Fix: add app.enableCors({ origin: 'http://localhost:3000' }) before app.listen()."},difficulty:"advanced",prereqs:[1,11,12,15,18,19]},
  ...
  {id:36,title:"Your Learning Path Forward",subtitle:"What to Build Next",analogy:"You've finished the tutorial — but this is the beginning, not the end! It's like getting your driver's license. You know HOW to drive, but you get GOOD at driving by actually driving. Build projects, break things, fix them. That's how you level up! 🚗💨",points:[{t:"Build a Todo App",d:"Start with the classic CRUD project: React frontend with a NestJS backend storing tasks in MongoDB via Prisma. Add user authentication with JWT, then real-time updates with Socket.IO so multiple users see changes instantly. A todo app touches every fundamental concept in a manageable scope.",code:"// Todo app stack:\n// NestJS + Prisma + PostgreSQL + React\n// Features: CRUD, auth, filtering\n// Covers 80% of web dev patterns!"},{t:"Build a Chat App",d:"A chat application exercises real-time features deeply: WebSocket connections for instant messaging, message history stored in MongoDB, typing indicators broadcast to the room, online status tracking with Redis, and push notifications for new messages. This project makes WebSockets and Redis click.",code:"// Chat teaches real-time!\n// NestJS + WebSockets + Redis + React\n// Features: rooms, online status, history"},{t:"Build a Blog Platform",d:"A blog platform covers nearly every technology: rich text editing in React, image uploads to AWS S3, Prisma for managing posts and comments, user authentication and authorization (only authors can edit their posts), email notifications for new comments, and SEO optimization for public pages.",code:"// Blog teaches content management\n// NestJS + Prisma + S3 (images) + React\n// Features: rich editor, categories, comments, SEO"},{t:"Contribute to Open Source",d:"Find NestJS or React repositories on GitHub and start contributing. Begin with documentation fixes and small bug fixes to learn the workflow. Read other developers' code to see how experienced teams structure their projects. Contributing to open source builds your skills, your portfolio, and your professional network.",code:"// Start small!\ngit fork → git clone\ngit checkout -b fix/typo\n// Fix docs, typos, add tests\ngit push → Create Pull Request\n// github.com/topics/good-first-issue"},{t:"Build Your SaaS Idea",d:"Take that app idea you have been thinking about and start building it for real. Apply everything from this tutorial: authentication, database design, background jobs, file uploads, email notifications. Start with a minimum viable product (MVP), get real users to try it, collect feedback, and iterate. Ship it!",code:"// SaaS uses everything you learned:\n// Auth (JWT + OAuth)\n// Payments (Stripe)\n// Email notifications\n// Background jobs\n// Rate limiting\n// Monitoring"},{t:"Reading Production Code",d:"Clone open-source NestJS projects on GitHub and read every file systematically. Ask yourself: why did they organize modules this way? How do they handle errors? What patterns do they use for testing? Reading production code teaches you patterns and practices that tutorials cannot cover. The more code you read, the better you write.",code:"// Study real codebases:\n// github.com/nestjs/nest\n// github.com/calcom/cal.com\n// Start from main.ts → follow imports"},{t:"Build a Portfolio Website",d:"Create a personal portfolio that showcases your projects using the technologies you learned. Deploy it with a custom domain, add a contact form with email notifications, and include live demos of your projects. A well-built portfolio demonstrates your skills better than any resume and attracts job opportunities.",code:"// Showcase your work:\n// Live demo links + GitHub repos\n// Deploy: Vercel (free) + Railway\n// Write good READMEs"},{t:"Join Developer Communities",d:"Engage with communities on Discord (NestJS, Prisma, React), Stack Overflow, and Twitter/X. Ask questions, answer other developers' questions, share what you build, and attend virtual meetups. Teaching others is one of the fastest ways to deepen your own understanding and stay current with evolving best practices.",code:"// Connect and learn:\n// Discord: Reactiflux, NestJS, TypeScript\n// Reddit: r/webdev, r/reactjs\n// Dev.to: write articles\n// Stack Overflow: answer questions"}],whatIs:"The best way to solidify your knowledge is to BUILD THINGS. Each project will force you to revisit concepts, solve real problems, and discover things this tutorial couldn't cover. Your code will get better with every project.",realWorld:"Every senior developer will tell you the same thing: 'I learned the most from building projects and debugging issues.' The theory gets you started — the practice makes you a pro.",code:`// Your Learning Roadmap 🗺️
//
...
// These print in order: Step 1, Step 2, Step 3`,funFact:"The first computer 'bug' was a real bug! In 1947, a moth got stuck inside the Harvard Mark II computer and caused errors. Engineer Grace Hopper taped the moth into the logbook and wrote 'First actual case of bug being found.' The term stuck!",quiz:[{q:"What is a program?",opts:["A TV show about computers","A collection of instructions that tells a computer what to do","A type of computer hardware","A special kind of keyboard"],ans:1},{q:"How does a computer read code?",opts:["All at once, in a flash","From bottom to top","From top to bottom, one line at a time","It reads randomly"],ans:2},{q:"What does Input → Process → Output mean?",opts:["You type a password and it logs you in automatically","The program takes data in, does something with it, and produces a result","The computer turns on, processes files, then turns off","Input and output are the same thing"],ans:1},{q:"What is the fundamental purpose of a programming language?",opts:["To give instructions to a computer in a way that humans can write and understand","To make computers faster","To design websites","To store data in databases"],ans:0},{q:"What is the relationship between source code and a running program?",opts:["They are the same thing","Source code is always longer than the program","Programs don't need source code","Source code is the human-written instructions; the program is what the computer executes after processing that code"],ans:3}],challenge:"Open any website, right-click, and choose 'Inspect' (or press F12). Click the 'Console' tab. Type: console.log(\"I wrote my first code!\") and press Enter. Congratulations — you just ran your first line of code!",resources:[{type:"video",title:"How Do Computers Work?",url:"https://www.youtube.com/watch?v=QZwneRb-zqA",source:"Crash Course"},{type:"article",title:"What is Programming?",url:"https://www.freecodecamp.org/news/what-is-programming/",source:"freeCodeCamp"},{type:"video",title:"Programming in 100 Seconds",url:"https://www.youtube.com/watch?v=l1F_yRV5lcE",source:"Fireship"}],eli5:"Imagine you have a very obedient robot friend. It will do ANYTHING you tell it — but only if you tell it in the right language, step by step. Programming is learning to talk to that robot. 'Pick up the cup. Walk to the table. Put the cup down.' If you say it right, the robot does it perfectly!",codeWalkthrough:["A comment explaining this is your first code. Comments start with // and are ignored by the computer.","console.log() is a built-in function that prints text to the screen.","","Printing the classic 'Hello, World!' — every programmer's first program!","This is what appears on screen when the line above runs.","","A comment introducing math operations.","The computer calculates 2 + 3 and prints the result.","The output is 5 — the computer did the math for us!","","A comment about combining text (called 'concatenation').","The + sign joins two pieces of text together into one.","The output combines both text pieces into a single line.","","A comment explaining execution order.","This prints first because the computer reads top to bottom.","This prints second.","This prints third — computers always follow the order you write!"],bugChallenge:{"code":"console.log(\"Hello, World!)\nconsole.log(2 + 3)","hint":"Look very carefully at the quotes in the first line...","answer":"The first line is missing the closing double quote before the parenthesis. Fix: console.log(\"Hello, World!\") — every opening quote needs a matching closing quote."},difficulty:"beginner",prereqs:[]},
  ...
  {id:38,title:"Setup Your Toolkit",subtitle:"Get Your Coding Workshop Ready",analogy:"Before a chef cooks, they set up their kitchen — knives sharpened, ingredients prepped, oven preheated. Before you code, you set up your toolkit — a code editor to write in, Node.js to run your code, and a terminal to give commands. Let's prep your coding kitchen!",points:[{t:"What is a Code Editor?",d:"A code editor is a special text app designed for writing code. Unlike Notepad or Word, it understands programming languages — it colors your code for readability (syntax highlighting), suggests completions as you type, and flags errors instantly. It's like upgrading from a pencil to a smart pen!",code:"// A code editor is where you write code\n// Like Microsoft Word, but for programming\n\n// Popular editors:\n// VS Code — free, most popular (recommended!)\n// WebStorm — paid, great for JS/TS\n// Sublime Text — fast, lightweight\n// Vim/Neovim — terminal-based, for power users"},{t:"Installing VS Code",d:"VS Code (Visual Studio Code) is the most popular free code editor in the world, made by Microsoft. Download it from code.visualstudio.com, install it, and you're ready. It works on Windows, Mac, and Linux. Over 70% of developers use it — so you'll always find help online!",code:"// 1. Go to: code.visualstudio.com\n// 2. Download for your OS (Mac/Windows/Linux)\n// 3. Install and open\n\n// Must-have extensions:\n// - ESLint (catches errors)\n// - Prettier (formats code)\n// - TypeScript (built-in!)\n// - GitLens (see git history)"},{t:"What is Node.js?",d:"Normally JavaScript only runs inside web browsers. Node.js lets you run JavaScript OUTSIDE the browser — on your own computer! Think of it as giving JavaScript a passport to travel beyond the browser. Download it from nodejs.org (choose the LTS/stable version).",code:"// Node.js lets you run JavaScript outside the browser\n// Browser: JavaScript runs in Chrome, Firefox, etc.\n// Node.js: JavaScript runs on your computer/server!\n\n// Check if installed:\n// node --version    → v18.17.0\n// npm --version     → 9.6.7\n\n// Download from: nodejs.org"},{t:"Using the Terminal",d:"The terminal (also called command line or console) is a text-based way to talk to your computer. Instead of clicking folders, you type commands. It feels old-school but it's incredibly powerful. In VS Code, press Ctrl+` (backtick) to open the built-in terminal.",code:"// Terminal = text-based way to control your computer\n\n// Navigate folders\ncd my-project        // go into folder\ncd ..                // go back one level\nls                   // list files (Mac/Linux)\ndir                  // list files (Windows)\n\n// Open terminal in VS Code: Ctrl+` (backtick)"},{t:"Running Your First Command",d:"Once Node.js is installed, open your terminal and type: node -v. This shows your Node.js version number — if you see a version like v20.11.0, it's working! Then try: node -e \"console.log('Hello!')\" to run JavaScript right from the terminal.",code:"// Open terminal and type:\nnode -e \"console.log('Hello from Node.js!')\"\n// Output: Hello from Node.js!\n\n// Or start interactive mode:\nnode\n> 2 + 3\n5\n> 'Hello'.toUpperCase()\n'HELLO'\n> .exit"},{t:"npm — The Package Manager",d:"npm (Node Package Manager) comes free with Node.js. It's like an app store for code — other developers share useful tools and libraries, and you can install them with one command: npm install package-name. There are over 2 million packages available!",code:"// npm = Node Package Manager\n// Like an app store for code libraries\n\nnpm init -y              // create package.json\nnpm install express      // add a package\nnpm install -D jest      // add dev-only package\nnpm install              // install all from package.json\nnpm run test             // run a script\n\n// package.json tracks all your dependencies"},{t:"Creating a Project Folder",d:"Every coding project lives in its own folder. Open your terminal and type: mkdir my-first-project to create a folder, then cd my-first-project to enter it. Then npm init -y creates a package.json file — your project's ID card that tracks its name, version, and dependencies.",code:"// Create and set up a new project\nmkdir my-first-app     // create folder\ncd my-first-app        // enter folder\nnpm init -y            // create package.json\n\n// Your project structure:\nmy-first-app/\n  ├── package.json     // project info + dependencies\n  └── (your code goes here)"},{t:"Your First JavaScript File",d:"In VS Code, create a new file called hello.js inside your project folder. Type console.log(\"Hello from my first file!\") and save it. Then in the terminal, type: node hello.js — and watch your message appear! You just created and ran your first program!",code:"// Create a file called hello.js\n// Type this code:\nconsole.log('Hello, World!');\nconsole.log('My name is Alice');\nconsole.log('2 + 2 =', 2 + 2);\n\n// Run it:\n// node hello.js\n\n// Output:\n// Hello, World!\n// My name is Alice\n// 2 + 2 = 4"}],whatIs:"Your coding toolkit is the set of software tools you need to write and run code. The three essentials are: a code editor (VS Code) where you write your code, Node.js which lets you run JavaScript on your computer, and the terminal where you execute commands and run your programs.",realWorld:"Every professional developer uses these exact tools daily. VS Code is used at companies like Google, Facebook, and Netflix. Node.js powers backends at LinkedIn, Uber, and PayPal. Learning these tools isn't just practice — it's real-world professional setup!",code:`// Step 1: Check if Node.js is installed
...
console.log(users.length); // 3 users`,funFact:"The first website ever created is still online! Tim Berners-Lee created it in 1991 at CERN. You can visit it at info.cern.ch — it's a simple page of text and links about the World Wide Web project. The entire internet grew from that one humble page!",quiz:[{q:"What does a server do?",opts:["Displays web pages on your screen","Receives requests and sends back responses","Connects to WiFi","Creates programming languages"],ans:1},{q:"What does DNS do?",opts:["Blocks viruses","Translates domain names (like google.com) into IP addresses","Designs websites","Sends emails"],ans:1},{q:"What is JSON used for?",opts:["Styling web pages","Playing music online","Exchanging data between clients and servers in a structured format","Creating databases"],ans:2},{q:"What is the role of a server in web communication?",opts:["A computer that stores and serves data or web pages in response to client requests","A type of web browser","A programming language","A physical building where code is written"],ans:0},{q:"What does HTTP stand for and what is its purpose?",opts:["Hyper Text Transfer Protocol — it's the set of rules for how web browsers and servers communicate","Hyper Tool Transfer Program","High Tech Transfer Protocol","Home Text Transfer Page"],ans:0}],challenge:"Open your browser and go to: jsonplaceholder.typicode.com/users — this is a free, public API! You'll see real JSON data with fake users. Notice the structure: curly braces for objects, square brackets for arrays, key-value pairs. This is what APIs look like under the hood!",resources:[{type:"video",title:"How the Internet Works in 5 Minutes",url:"https://www.youtube.com/watch?v=7_LPdttKXPc",source:"Aaron"},{type:"article",title:"MDN: How the Web Works",url:"https://developer.mozilla.org/en-US/docs/Learn_web_development/Getting_started/Web_standards/How_the_web_works",source:"MDN Web Docs"},{type:"docs",title:"HTTP Status Codes",url:"https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status",source:"MDN Web Docs"}],eli5:"Imagine you're sending a letter. You write the letter (your request), put an address on it (the URL), drop it in the mailbox (the internet), and it goes to the post office (DNS) which figures out where it should go. The letter arrives at someone's house (the server), they read it, write a reply, and send it back to you. That round trip is how the internet works!",codeWalkthrough:["Comment: Walking through how the internet works","","Comment: Step 1 — the user action","The URL you typed — this is the 'address' of the data you want","","Comment: Step 2 — DNS lookup","DNS converts the human-readable domain into a numeric IP address","","Comment: Step 3 — the browser sends a request","This is the actual HTTP request format — GET means 'give me data'","The Host header tells the server which website you want","","Comment: Step 4 — the server responds","200 OK is the status code meaning everything worked","","Comment: Step 5 — the response body","This is the JSON data the server sent back","Opening the response object with curly braces","The user's unique ID","The user's name","The user's email","The user's role","Closing the object","","Comment: The four main HTTP methods","GET reads data — like viewing a profile","POST creates new data — like signing up","PUT updates existing data — like editing your bio","DELETE removes data — like deleting a post","","Comment: A JSON array with multiple objects","Opening the array with a square bracket","First user object — Alex is a developer","Second user object — Sam is a designer","Third user object — Jo is a manager","Closing the array","Accessing the length property — arrays know how many items they hold"],bugChallenge:{"code":"// Trying to fetch data from an API\nGET https://api.example.com/users\n\n// Expected response:\n{\n  name: Alex,\n  age: 25\n}","hint":"Look at the JSON format — is something missing around the values?","answer":"JSON requires string values to be wrapped in double quotes! Fix: {\"name\": \"Alex\", \"age\": 25}. The number 25 doesn't need quotes, but 'Alex' does because it's a string. Valid JSON always uses double quotes, never single quotes."},difficulty:"beginner",prereqs:[37]},
  ...
  {id:40,title:"Build Your First Mini App",subtitle:"From Zero to Running Code",analogy:"Building your first app is like assembling a paper airplane. You fold one crease at a time (write one line at a time), check the shape as you go (run and debug), and eventually launch it across the room (execute the program). It won't be a Boeing 747 — but watching YOUR creation fly for the first time is unforgettable!",points:[{t:"console.log() — Your Voice",d:"console.log() is how your program talks to you. Whatever you put inside the parentheses gets printed to the screen. It's your program's voice — and your best debugging friend. Use it to check values, show messages, and verify your code is working: console.log(\"It works!\").",code:"// console.log() prints text to the screen\nconsole.log('Hello!');           // Hello!\nconsole.log(42);                 // 42\nconsole.log('Age:', 25);         // Age: 25\nconsole.log(true);               // true\nconsole.log(1 + 2);             // 3\n\n// Your #1 debugging tool!"},{t:"Variables — Storing Information",d:"Variables are named containers that hold data. Use let to create one: let myName = \"Alex\". Now 'myName' holds the text 'Alex' and you can use it anywhere in your code. Use const if the value should never change: const PI = 3.14. Pick descriptive names so your code reads like English!",code:"// Variables store data with a name\nconst name = 'Alice';     // text (string)\nconst age = 25;           // number\nconst isHappy = true;     // true/false (boolean)\n\nconsole.log(name);        // 'Alice'\nconsole.log(age + 1);     // 26\n\nlet score = 0;            // 'let' can change\nscore = 10;               // updated!"},{t:"String Concatenation — Joining Text",d:"You can join (concatenate) text using the + sign: \"Hello, \" + \"World!\" gives you \"Hello, World!\". You can mix variables and text: \"My name is \" + myName. Even better, use template literals with backticks: `My name is ${myName}` — this is the modern, cleaner way to combine text and variables.",code:"const name = 'Alice';\nconst age = 25;\n\n// Way 1: + operator\nconsole.log('Hello, ' + name + '!');  // Hello, Alice!\n\n// Way 2: template literals (backticks) — recommended!\nconsole.log(`Hello, ${name}! You are ${age} years old.`);\n// Hello, Alice! You are 25 years old."},{t:"Running a Script",d:"Save your code in a .js file (like app.js) and run it by typing node app.js in the terminal. The computer reads your file from top to bottom and executes each line. If there's an error, it tells you which line has the problem. Save, run, check — that's the cycle!",code:"// 1. Create a file: myScript.js\nconsole.log('Starting...');\nconst x = 10;\nconst y = 20;\nconsole.log('Sum:', x + y);\nconsole.log('Done!');\n\n// 2. Open terminal\n// 3. Run: node myScript.js\n// Output:\n//   Starting...\n//   Sum: 30\n//   Done!"},{t:"User Input Concepts",d:"Programs can ask users for information! In the browser, prompt(\"What is your name?\") shows a popup. In Node.js, you can use the readline module to read from the terminal. For now, we'll simulate input by storing values in variables — the concept is the same: your program receives data and responds to it.",code:"// In the browser:\nconst name = prompt('What is your name?');\nalert('Hello, ' + name + '!');\n\n// In Node.js (using readline):\nconst readline = require('readline');\nconst rl = readline.createInterface({ input: process.stdin });\nrl.question('Your name? ', (name) => {\n  console.log('Hello, ' + name);\n  rl.close();\n});"},{t:"if/else — Making Decisions",d:"Programs can make decisions! 'if' checks a condition — if it's true, run this code. 'else' runs different code when the condition is false. Example: if (age >= 18) { console.log(\"Adult\"); } else { console.log(\"Minor\"); }. This is how programs react differently based on data.",code:"const age = 18;\n\nif (age >= 18) {\n  console.log('You can vote!');\n} else if (age >= 16) {\n  console.log('Almost there!');\n} else {\n  console.log('Too young to vote');\n}\n\n// Comparison operators:\n// === equal    !== not equal\n// >  greater   <  less\n// >= greater or equal"},{t:"Putting It All Together",d:"A real program combines all these pieces: store data in variables, join text with concatenation, make decisions with if/else, and show results with console.log. That's what we're building today — a mini app that greets users differently based on their name and time of day!",code:"// Mini program: greeting generator\nconst name = 'Alice';\nconst hour = new Date().getHours();\nlet greeting;\n\nif (hour < 12) {\n  greeting = 'Good morning';\n} else if (hour < 18) {\n  greeting = 'Good afternoon';\n} else {\n  greeting = 'Good evening';\n}\n\nconsole.log(greeting + ', ' + name + '!');"}],whatIs:"A mini app is a small, self-contained program that does one useful thing. Today we're building a console app that stores a user's name, checks the time of day, and prints a personalized greeting. It uses variables, string concatenation, if/else logic, and console.log — the essential building blocks of every program ever written.",realWorld:"Every massive app started as something tiny. Facebook started as a simple profile page. Google started as a search box. Your mini app is the first step on that same journey. The skills you learn here — variables, strings, conditionals — are used in EVERY programming language and EVERY application.",code:`// My First Mini App: The Greeter!
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: 'Install the NestJS CLI', d: "Run `npm i -g @nestjs/cli` to install the NestJS command-line tool globally. The CLI is your best friend — it generates projects, modules, controllers, services, and more with a single command. Think of it as a robot assistant that writes boilerplate for you.", code: "npm install -g @nestjs/cli\n\n// Verify installation:\nnest --version\n// Output: 10.x.x\n\n// The CLI helps you generate code quickly!" },
    { t: 'Create a New Project', d: "`nest new my-app` scaffolds a complete project with TypeScript config, testing setup, linting, and a working hello-world endpoint. Choose npm or yarn when prompted. In seconds, you have a production-ready project structure.", code: "nest new my-api\n// Choose package manager: npm/yarn/pnpm\n\ncd my-api\nnpm run start:dev\n// Server running at http://localhost:3000\n// Visit it → 'Hello World!'" },
    { t: 'Project Structure', d: "src/main.ts is the entry point that bootstraps the app. src/app.module.ts is the root module. src/app.controller.ts handles routes. src/app.service.ts contains logic. test/ has your test files. This structure stays consistent no matter how big the app grows.", code: "my-api/\n├── src/\n│   ├── app.module.ts      // root module\n│   ├── app.controller.ts  // routes\n│   ├── app.service.ts     // business logic\n│   └── main.ts            // entry point\n├── test/                   // e2e tests\n├── package.json\n└── tsconfig.json" },
    { t: 'The main.ts File', d: "main.ts calls NestFactory.create(AppModule) to bootstrap your application. It's where you set the port (default 3000), enable CORS, add global pipes, and configure middleware. This tiny file is the ignition key for your entire server.", code: "// src/main.ts — app entry point\nimport { NestFactory } from '@nestjs/core';\nimport { AppModule } from './app.module';\n\nasync function bootstrap() {\n  const app = await NestFactory.create(AppModule);\n  app.enableCors();\n  await app.listen(3000);\n  console.log('Server running on http://localhost:3000');\n}\nbootstrap();" },
    { t: 'Running the App', d: "`npm run start:dev` starts the app in watch mode — it auto-restarts when you save files. Visit http://localhost:3000 and see 'Hello World!' Your first NestJS server is alive! Use `npm run start:debug` for debugging with breakpoints.", code: "# Development (auto-restart on changes)\nnpm run start:dev\n\n# Production build\nnpm run build\nnpm run start:prod\n\n# Debug mode\nnpm run start:debug\n\n# The app restarts automatically when you save!" },
    { t: 'The nest generate Command', d: "`nest g resource cats` generates a complete CRUD module: controller, service, module, DTOs, and entity — all wired together. `nest g controller users` creates just a controller. The CLI saves hours of typing boilerplate files manually.", code: "# Generate a full module with CRUD\nnest generate resource users\n// Creates:\n// src/users/users.module.ts\n// src/users/users.controller.ts\n// src/users/users.service.ts\n// src/users/dto/create-user.dto.ts\n// src/users/dto/update-user.dto.ts\n\n# Short form:\nnest g res products" },
    { t: 'package.json Scripts', d: "NestJS comes with scripts for every situation: `start` (production), `start:dev` (watch mode), `start:debug` (debugger), `build` (compile to JS), `test` (unit tests), `test:e2e` (end-to-end). You rarely need to add custom scripts.", code: "{\n  \"scripts\": {\n    \"start\": \"nest start\",\n    \"start:dev\": \"nest start --watch\",\n    \"start:debug\": \"nest start --debug --watch\",\n    \"start:prod\": \"node dist/main\",\n    \"build\": \"nest build\",\n    \"test\": \"jest\",\n    \"test:e2e\": \"jest --config ./test/jest-e2e.json\"\n  }\n}" },
    { t: 'Hot Reload', d: "In dev mode, NestJS uses webpack or SWC for hot module replacement. When you change a file, only that module reloads — not the entire app. This means sub-second feedback loops while developing. Productivity goes through the roof!", code: "// nest start --watch watches for file changes\n// Save a file → app restarts in ~1 second\n\n// For even faster reload with SWC compiler:\nnpm i -D @swc/cli @swc/core\n\n// nest-cli.json\n{\n  \"compilerOptions\": {\n    \"builder\": \"swc\"  // 20x faster compilation!\n  }\n}" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: '@Controller() Decorator', d: "The @Controller('users') decorator marks a class as a route handler and sets the base path. All routes inside will start with /users. You can nest paths: @Controller('api/v1/users'). Without the decorator, NestJS won't recognize the class as a controller.", code: "@Controller('users')  // all routes start with /users\nexport class UsersController {\n  @Get()                // GET /users\n  findAll() { return []; }\n\n  @Get(':id')           // GET /users/1\n  findOne() { return {}; }\n}\n// The decorator tells NestJS this class handles routes" },
    { t: 'HTTP Method Decorators', d: "@Get(), @Post(), @Put(), @Patch(), @Delete() — each maps to an HTTP method. @Get('profile') handles GET /users/profile. @Post() handles POST /users. You can have multiple methods on the same path with different HTTP verbs — that's RESTful design!", code: "@Controller('tasks')\nexport class TasksController {\n  @Get()    findAll() {}     // GET /tasks\n  @Get(':id') findOne() {}   // GET /tasks/1\n  @Post()   create() {}      // POST /tasks\n  @Patch(':id') update() {}  // PATCH /tasks/1\n  @Delete(':id') remove() {} // DELETE /tasks/1\n}" },
    { t: 'Route Parameters', d: "@Param('id') extracts dynamic segments from the URL. GET /users/123 → id = '123'. Use @Param() without arguments to get all params as an object. Always validate params with pipes: @Param('id', ParseIntPipe) ensures id is a number.", code: "@Get(':id')\nfindOne(@Param('id') id: string) {\n  return this.service.findOne(+id); // +id converts string to number\n}\n\n// Multiple params:\n@Get(':userId/posts/:postId')\nfindPost(\n  @Param('userId') userId: string,\n  @Param('postId') postId: string,\n) {}" },
    { t: 'Query Parameters', d: "@Query('page') extracts query string values. GET /users?page=2&limit=10 → page = '2', limit = '10'. Great for filtering, pagination, and sorting. Use @Query() to get the entire query object at once.", code: "@Get()\nfindAll(\n  @Query('page') page: number = 1,\n  @Query('limit') limit: number = 10,\n  @Query('search') search?: string,\n) {\n  // GET /users?page=2&limit=20&search=alice\n  return this.service.findAll({ page, limit, search });\n}" },
    { t: 'Request Body', d: "@Body() extracts the request body from POST/PUT/PATCH requests. Use with DTOs for automatic validation: @Body() dto: CreateUserDto. NestJS parses JSON automatically. @Body('name') extracts a single field from the body.", code: "@Post()\ncreate(@Body() createUserDto: CreateUserDto) {\n  // POST /users with JSON body:\n  // { \"name\": \"Alice\", \"email\": \"alice@mail.com\" }\n  return this.service.create(createUserDto);\n}\n\n@Patch(':id')\nupdate(@Param('id') id: string, @Body() updateDto: UpdateUserDto) {\n  return this.service.update(+id, updateDto);\n}" },
    { t: 'Response Handling', d: "By default, NestJS serializes your return value to JSON with status 200 (GET) or 201 (POST). For custom status codes, use @HttpCode(204). For custom headers, use @Header('Cache-Control', 'none'). For redirects, use @Redirect('https://example.com', 301).", code: "// NestJS auto-serializes to JSON\n@Get()\nfindAll() {\n  return [{ id: 1, name: 'Alice' }]; // → JSON automatically\n}\n\n// Custom status code\n@Post()\n@HttpCode(201)\ncreate(@Body() dto: CreateUserDto) {\n  return this.service.create(dto);\n}\n\n// Custom response\n@Get()\nfindAll(@Res() res: Response) {\n  res.status(200).json({ data: [] });\n}" },
    { t: 'Headers & Cookies', d: "@Headers('authorization') reads request headers. @Req() gives you the raw Express request object — but prefer specific decorators for cleaner code. Use @Res() for the raw response (but then YOU must send the response manually).", code: "// Read headers\n@Get()\nfindAll(@Headers('authorization') auth: string) {\n  console.log('Token:', auth);\n}\n\n// Set response header\n@Post()\n@Header('Cache-Control', 'none')\ncreate() {}\n\n// Read cookies\n@Get()\nfindAll(@Req() req: Request) {\n  const token = req.cookies['session'];\n}" },
    { t: 'Wildcard & Nested Routes', d: "Use wildcards for flexible matching: @Get('ab*cd') matches abcd, abXcd, ab123cd. Group related routes with sub-paths: @Get(':id/posts') for /users/123/posts. NestJS resolves routes in order — put specific routes before wildcards.", code: "// Wildcard route\n@Get('docs/*')\nserveDoc() { return 'Matches /docs/anything/here'; }\n\n// Nested controllers via module imports\n@Controller('users/:userId/posts')\nexport class UserPostsController {\n  @Get()    findAll(@Param('userId') userId: string) {}\n  @Post()   create(@Param('userId') userId: string) {}\n}\n// GET /users/1/posts" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: '@Injectable() Decorator', d: "Adding @Injectable() to a class tells NestJS: 'This class can be managed by the DI container.' It can then be injected into controllers, other services, or any provider. Without @Injectable(), NestJS can't create or inject the class.", code: "@Injectable() // tells NestJS: 'manage this class for me'\nexport class UsersService {\n  getUsers() {\n    return [{ id: 1, name: 'Alice' }];\n  }\n}\n// Without @Injectable(), NestJS can't inject it!" },
    { t: 'Constructor Injection', d: "The main way to inject dependencies: `constructor(private usersService: UsersService) {}`. NestJS reads the type (UsersService), finds the matching provider, creates it (or reuses a singleton), and passes it in. Zero manual wiring needed!", code: "@Controller('users')\nexport class UsersController {\n  // NestJS automatically creates and injects UsersService\n  constructor(private readonly usersService: UsersService) {}\n\n  @Get()\n  findAll() {\n    return this.usersService.getUsers(); // just use it!\n  }\n}" },
    { t: 'Providers Array', d: "Services must be registered in a module's `providers` array to be available for injection. `providers: [UsersService]` is shorthand for `providers: [{ provide: UsersService, useClass: UsersService }]`. The module is the registry that connects everything.", code: "@Module({\n  controllers: [UsersController],\n  providers: [UsersService],  // register here so NestJS knows about it\n  exports: [UsersService],    // share with other modules\n})\nexport class UsersModule {}\n\n// Forgot to add to providers? → Error: Can't resolve UsersService" },
    { t: 'Singleton by Default', d: "By default, every service is a singleton — one instance shared across the entire app. This means the first time UsersService is needed, NestJS creates it, and every subsequent injection gets the SAME instance. Great for caching, connection pools, and shared state.", code: "// NestJS creates ONE instance of each service\n@Injectable()\nexport class CounterService {\n  private count = 0;\n  increment() { return ++this.count; }\n}\n\n// Both controllers share the SAME instance:\n// ControllerA calls increment() → 1\n// ControllerB calls increment() → 2 (not 1!)" },
    { t: 'Service-to-Service Injection', d: "Services can inject other services. An OrdersService might inject UsersService and ProductsService. This creates a dependency tree that NestJS resolves automatically. Just add them to the constructor — NestJS handles the rest.", code: "@Injectable()\nexport class EmailService {\n  send(to: string, msg: string) { /* ... */ }\n}\n\n@Injectable()\nexport class UsersService {\n  // Inject another service!\n  constructor(private email: EmailService) {}\n\n  async create(dto: CreateUserDto) {\n    const user = await this.save(dto);\n    await this.email.send(user.email, 'Welcome!'); // use it\n    return user;\n  }\n}" },
    { t: 'Custom Providers', d: "Beyond simple classes, you can provide values (useValue), factories (useFactory), or aliases (useExisting). `{ provide: 'API_KEY', useValue: 'abc123' }` lets you inject config. `{ provide: Logger, useFactory: () => new WinstonLogger() }` for custom creation.", code: "// useValue — provide a constant\n{ provide: 'API_KEY', useValue: 'my-secret-key' }\n\n// useClass — swap implementation\n{ provide: LoggerService, useClass: ProdLoggerService }\n\n// useFactory — dynamic creation\n{ provide: 'CONFIG', useFactory: () => loadConfig() }\n\n// Inject custom provider\nconstructor(@Inject('API_KEY') private apiKey: string) {}" },
    { t: 'Async Providers', d: "Need to wait for a DB connection before creating a service? Use useFactory with async: `{ provide: 'DB', useFactory: async () => await connectDB() }`. NestJS waits for the promise to resolve before injecting the result. Essential for real-world apps.", code: "// Async provider — wait for setup before injecting\nconst dbProvider = {\n  provide: 'DATABASE',\n  useFactory: async () => {\n    const connection = await createConnection({\n      host: 'localhost',\n      port: 5432,\n    });\n    console.log('Database connected!');\n    return connection;\n  },\n};\n\n@Module({ providers: [dbProvider] })\nexport class AppModule {}" },
    { t: 'Provider Scopes', d: "Change the scope with @Injectable({ scope: Scope.REQUEST }) to create a new instance per request — useful for multi-tenant apps. Scope.TRANSIENT creates a new instance per injection point. Default (Scope.DEFAULT) is singleton. Choose wisely — singletons are faster!", code: "// Singleton (default) — one instance for entire app\n@Injectable()\nexport class ConfigService {} // shared everywhere\n\n// Request-scoped — new instance per HTTP request\n@Injectable({ scope: Scope.REQUEST })\nexport class RequestLogger {\n  private requestId = Math.random().toString(36);\n  // Each request gets its own logger with unique ID!\n}\n\n// Transient — new instance every time it's injected\n@Injectable({ scope: Scope.TRANSIENT })\nexport class HelperService {} // different instance in each service" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: 'What is Middleware?', d: "Middleware functions run BEFORE the route handler on every matching request. They have access to the request and response objects and a next() function. Use them for logging, CORS, cookie parsing, rate limiting, or authentication. They're the first checkpoint in the request pipeline.", code: "// Middleware = code that runs BEFORE route handlers\n// Request → Middleware → Route Handler → Response\n\n// Like a security checkpoint:\n// Person → ID Check → Building entrance" },
    { t: 'Creating Middleware', d: "Implement the NestMiddleware interface with a use(req, res, next) method. Call next() to pass control to the next middleware or handler. If you don't call next(), the request hangs forever! Middleware can be class-based (injectable) or function-based (simple).", code: "@Injectable()\nexport class LoggerMiddleware implements NestMiddleware {\n  use(req: Request, res: Response, next: NextFunction) {\n    console.log(req.method, req.url, new Date().toISOString());\n    next(); // MUST call next() to continue!\n  }\n}" },
    { t: 'Applying Middleware', d: "In your module, implement NestModule and configure middleware in the configure() method. Use .forRoutes() to target specific routes and .exclude() to skip certain paths. You can apply middleware globally, per-module, or per-route.", code: "// In module's configure method\nexport class AppModule implements NestModule {\n  configure(consumer: MiddlewareConsumer) {\n    consumer\n      .apply(LoggerMiddleware)\n      .forRoutes('*');  // all routes\n\n    consumer\n      .apply(AuthMiddleware)\n      .forRoutes('users', 'orders'); // specific routes\n  }\n}" },
    { t: 'What are Interceptors?', d: "Interceptors wrap AROUND the route handler using RxJS observables. They execute logic BEFORE the handler runs AND AFTER the handler returns. This makes them perfect for transforming responses, adding caching, logging timing, and more.", code: "// Interceptors wrap AROUND the route handler\n// Before → Route Handler → After\n\n@Injectable()\nexport class TimingInterceptor implements NestInterceptor {\n  intercept(context: ExecutionContext, next: CallHandler) {\n    const start = Date.now();\n    return next.handle().pipe(\n      tap(() => console.log('Took', Date.now() - start, 'ms')),\n    );\n  }\n}" },
    { t: 'Response Transformation', d: "The most common use: wrap all responses in a standard format. `{ success: true, data: ..., timestamp: ... }` Instead of doing this in every controller, one interceptor handles all routes. Consistent API responses with zero repetition.", code: "// Wrap all responses in a standard format\n@Injectable()\nexport class WrapInterceptor implements NestInterceptor {\n  intercept(ctx: ExecutionContext, next: CallHandler) {\n    return next.handle().pipe(\n      map(data => ({ success: true, data, timestamp: new Date() })),\n    );\n  }\n}\n// { name: 'Alice' } → { success: true, data: { name: 'Alice' }, timestamp: ... }" },
    { t: 'Logging Interceptor', d: "Measure how long every request takes. Log the method, URL, and response time. In production, send these metrics to monitoring services like DataDog or New Relic. One interceptor replaces hundreds of manual console.log calls.", code: "@Injectable()\nexport class LoggingInterceptor implements NestInterceptor {\n  intercept(ctx: ExecutionContext, next: CallHandler) {\n    const req = ctx.switchToHttp().getRequest();\n    console.log('→', req.method, req.url);\n\n    return next.handle().pipe(\n      tap(data => console.log('←', req.method, req.url, JSON.stringify(data).slice(0, 100))),\n    );\n  }\n}" },
    { t: 'Caching Interceptor', d: "NestJS has a built-in CacheInterceptor that caches GET responses. Apply it globally or per-route with @UseInterceptors(CacheInterceptor). It checks the cache before hitting the handler — if cached, it returns immediately without running your code.", code: "// Built-in caching\nimport { CacheInterceptor } from '@nestjs/cache-manager';\n\n@UseInterceptors(CacheInterceptor)\n@Get('products')\nfindAll() {\n  // First call: hits database\n  // Next calls: returns cached result instantly!\n  return this.productsService.findAll();\n}\n\n// Cache expires after TTL (time to live)" },
    { t: 'Middleware vs Interceptors', d: "Middleware: runs BEFORE only, has access to raw req/res, good for cross-cutting concerns. Interceptors: run BEFORE and AFTER, use RxJS, good for transforming responses and timing. Use middleware for low-level stuff, interceptors for application-level logic.", code: "// Middleware: runs BEFORE handler only\n// → Good for: logging, auth checks, CORS\n\n// Interceptors: run BEFORE and AFTER handler\n// → Good for: response transform, timing, caching\n\n// Execution order:\n// Request → Middleware → Guard → Interceptor (before)\n//   → Pipe → Handler → Interceptor (after) → Response" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: 'What are Guards?', d: "Guards implement CanActivate and return true (allow) or false (deny). They run AFTER middleware but BEFORE interceptors and pipes. Perfect for authentication and authorization — they decide if a request should proceed based on conditions like valid tokens or user roles.", code: "// Guards decide: should this request be allowed?\n// Return true → request proceeds\n// Return false → 403 Forbidden\n\n@Injectable()\nexport class SimpleGuard implements CanActivate {\n  canActivate(context: ExecutionContext): boolean {\n    const request = context.switchToHttp().getRequest();\n    return !!request.headers.authorization;\n  }\n}" },
    { t: 'AuthGuard — JWT Authentication', d: "The most common guard: verify the JWT token from the Authorization header. Extract the user, attach it to the request, and let the handler access it. If the token is invalid or missing, throw UnauthorizedException (401). One guard protects your entire API.", code: "@Injectable()\nexport class JwtAuthGuard extends AuthGuard('jwt') {\n  handleRequest(err, user) {\n    if (err || !user) throw new UnauthorizedException('Invalid token');\n    return user;\n  }\n}\n\n@UseGuards(JwtAuthGuard)\n@Get('profile')\ngetProfile(@Req() req) { return req.user; }" },
    { t: 'RolesGuard — Authorization', d: "After authentication (who are you?), authorization checks permissions (what can you do?). RolesGuard reads @Roles('admin') metadata from the route and compares it with the user's role. Admins can delete, users can only read. Separate concerns = clean code.", code: "@Injectable()\nexport class RolesGuard implements CanActivate {\n  constructor(private reflector: Reflector) {}\n\n  canActivate(context: ExecutionContext): boolean {\n    const roles = this.reflector.get<string[]>('roles', context.getHandler());\n    if (!roles) return true;\n    const user = context.switchToHttp().getRequest().user;\n    return roles.includes(user.role);\n  }\n}" },
    { t: 'Applying Guards', d: "Three levels: @UseGuards(AuthGuard) on a single route, on a controller (all routes), or globally via app.useGlobalGuards(). Global is best for auth — protect everything by default, then whitelist public routes with a @Public() decorator.", code: "// Method level\n@UseGuards(AuthGuard)\n@Get('secret')\ngetSecret() {}\n\n// Controller level (all routes)\n@UseGuards(AuthGuard)\n@Controller('admin')\nexport class AdminController {}\n\n// Global level (entire app)\napp.useGlobalGuards(new JwtAuthGuard());" },
    { t: '@SetMetadata() & Reflector', d: "Guards read metadata set by decorators. @SetMetadata('roles', ['admin']) attaches data to a route. Inside the guard, Reflector reads it: reflector.get('roles', context.getHandler()). This is how @Roles() and @Public() work under the hood.", code: "// Set custom metadata on routes\n@SetMetadata('roles', ['admin'])\n@Get('admin')\nadminOnly() {}\n\n// Read metadata in guard\nconst roles = this.reflector.get<string[]>('roles', context.getHandler());\n// roles = ['admin']\n\n// Better: create a custom decorator\nexport const Roles = (...roles: string[]) => SetMetadata('roles', roles);\n@Roles('admin') // cleaner!" },
    { t: 'Custom @CurrentUser() Decorator', d: "Create a parameter decorator that extracts the logged-in user from the request: `createParamDecorator((data, ctx) => ctx.switchToHttp().getRequest().user)`. Now use @CurrentUser() in any controller instead of repeating request extraction logic everywhere.", code: "// Extract user from request cleanly\nexport const CurrentUser = createParamDecorator(\n  (data: string, ctx: ExecutionContext) => {\n    const user = ctx.switchToHttp().getRequest().user;\n    return data ? user?.[data] : user;\n  },\n);\n\n@Get('profile')\ngetProfile(@CurrentUser() user: User) { return user; }\n\n@Get('name')\ngetName(@CurrentUser('name') name: string) { return name; }" },
    { t: 'Custom @Public() Decorator', d: "Mark routes that skip authentication: `const Public = () => SetMetadata('isPublic', true)`. In your AuthGuard, check this metadata — if isPublic is true, return true without checking the token. Login and register routes need this!", code: "// Mark routes as public (skip auth)\nexport const IS_PUBLIC = 'isPublic';\nexport const Public = () => SetMetadata(IS_PUBLIC, true);\n\n// In AuthGuard:\ncanActivate(context: ExecutionContext) {\n  const isPublic = this.reflector.get(IS_PUBLIC, context.getHandler());\n  if (isPublic) return true; // skip auth!\n  return super.canActivate(context);\n}\n\n@Public()\n@Get('health')\nhealthCheck() { return 'ok'; }" },
    { t: 'Combining Guards', d: "Stack multiple guards: @UseGuards(AuthGuard, RolesGuard). They run in order — if AuthGuard fails, RolesGuard never runs. This creates a security pipeline: first verify identity, then check permissions. Clean separation of authentication and authorization.", code: "// Multiple guards run in order — ALL must pass\n@UseGuards(JwtAuthGuard, RolesGuard)\n@Roles('admin')\n@Delete(':id')\nremove(@Param('id') id: string) {\n  // 1. JwtAuthGuard checks: is user logged in?\n  // 2. RolesGuard checks: is user an admin?\n  // Both pass → handler runs\n  return this.service.remove(+id);\n}" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: 'Built-in HTTP Exceptions', d: "NestJS provides exceptions for every HTTP status: NotFoundException (404), BadRequestException (400), UnauthorizedException (401), ForbiddenException (403), ConflictException (409), InternalServerErrorException (500). Throw them anywhere — NestJS handles the rest.", code: "// NestJS provides exception classes for every HTTP status\nthrow new BadRequestException('Invalid input');     // 400\nthrow new UnauthorizedException('Please log in');    // 401\nthrow new ForbiddenException('Admin only');          // 403\nthrow new NotFoundException('User not found');       // 404\nthrow new ConflictException('Email already exists'); // 409\nthrow new InternalServerErrorException('Oops');      // 500" },
    { t: 'Default Exception Filter', d: "NestJS has a built-in global exception filter that catches ALL unhandled errors and returns a JSON response with statusCode, message, and error. Unknown errors become 500 Internal Server Error. You get sane defaults out of the box!", code: "// NestJS auto-catches exceptions and returns JSON\nthrow new NotFoundException('User 123 not found');\n\n// Auto-response:\n// {\n//   \"statusCode\": 404,\n//   \"message\": \"User 123 not found\",\n//   \"error\": \"Not Found\"\n// }\n// No try/catch needed in controllers!" },
    { t: 'Custom Exception Filters', d: "Create filters with @Catch(ExceptionType) to handle specific errors your way. Implement ExceptionFilter with a catch(exception, host) method. You control the response format, status code, logging, and error reporting. One filter, consistent errors everywhere.", code: "@Catch(HttpException)\nexport class HttpFilter implements ExceptionFilter {\n  catch(exception: HttpException, host: ArgumentsHost) {\n    const ctx = host.switchToHttp();\n    const response = ctx.getResponse();\n    response.status(exception.getStatus()).json({\n      success: false,\n      error: exception.message,\n      timestamp: new Date().toISOString(),\n    });\n  }\n}" },
    { t: 'Catch Everything', d: "@Catch() with no arguments catches ALL exceptions — including non-HTTP errors like TypeErrors and database errors. This is your last line of defense. Log the error, send an alert, and return a generic 'something went wrong' message to the user.", code: "@Catch() // no argument = catch ALL exceptions\nexport class AllExceptionsFilter implements ExceptionFilter {\n  catch(exception: unknown, host: ArgumentsHost) {\n    const status = exception instanceof HttpException\n      ? exception.getStatus() : 500;\n    const message = exception instanceof Error\n      ? exception.message : 'Something went wrong';\n\n    host.switchToHttp().getResponse()\n      .status(status).json({ error: message });\n  }\n}" },
    { t: 'Custom Exception Classes', d: "Extend HttpException to create domain-specific errors: `class UserNotFoundException extends NotFoundException`. Add custom properties like error codes: `{ code: 'USER_NOT_FOUND', message: '...' }`. Makes error handling more semantic and easier to debug.", code: "// Create domain-specific exceptions\nexport class UserNotFoundException extends NotFoundException {\n  constructor(userId: number) {\n    super('User with ID ' + userId + ' not found');\n  }\n}\n\nexport class InsufficientFundsException extends BadRequestException {\n  constructor() {\n    super('Insufficient funds for this transaction');\n  }\n}\n\n// throw new UserNotFoundException(123);" },
    { t: 'Applying Filters', d: "@UseFilters(MyFilter) per route/controller, or app.useGlobalFilters(new MyFilter()) globally. Global filters catch errors from any route. You can stack multiple filters — they execute in order until one handles the exception.", code: "// Method level\n@UseFilters(HttpFilter)\n@Get(':id')\nfindOne() {}\n\n// Controller level\n@UseFilters(HttpFilter)\n@Controller('users')\nexport class UsersController {}\n\n// Global level (recommended)\napp.useGlobalFilters(new AllExceptionsFilter());" },
    { t: 'Error Logging & Monitoring', d: "In your filter, log errors to external services: Sentry, DataDog, or a custom logger. Include request details (URL, method, body, user) for debugging. Production apps need error tracking — filters are the perfect place to add it.", code: "@Catch()\nexport class LoggingFilter implements ExceptionFilter {\n  private logger = new Logger('ExceptionFilter');\n\n  catch(exception: unknown, host: ArgumentsHost) {\n    this.logger.error(\n      exception instanceof Error ? exception.message : 'Unknown error',\n      exception instanceof Error ? exception.stack : '',\n    );\n    // Also send to Sentry, DataDog, etc.\n    Sentry.captureException(exception);\n  }\n}" },
    { t: 'Validation Errors', d: "When ValidationPipe rejects input, it throws BadRequestException with an array of error messages. Customize this by providing an exceptionFactory to the pipe. Return field-level errors: `{ field: 'email', errors: ['must be valid email'] }` for better frontend integration.", code: "// ValidationPipe + class-validator = automatic validation\napp.useGlobalPipes(new ValidationPipe({\n  whitelist: true,\n  forbidNonWhitelisted: true,\n  transform: true,\n}));\n\n// Invalid input auto-returns:\n// {\n//   \"statusCode\": 400,\n//   \"message\": [\"email must be an email\", \"name should not be empty\"],\n//   \"error\": \"Bad Request\"\n// }" }
  ],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  points: [
    { t: 'What is CRUD?', d: "Create, Read, Update, Delete — the four fundamental operations for any data-driven app. Every app you use does CRUD: Instagram creates posts, reads feeds, updates profiles, deletes comments. Mastering CRUD means you can build almost any app.", code: "// CRUD = the 4 basic database operations\n// C = Create → POST   /items\n// R = Read   → GET    /items, GET /items/:id\n// U = Update → PATCH  /items/:id\n// D = Delete → DELETE /items/:id\n\n// Every app needs CRUD!" },
    { t: 'Project Structure', d: "Each feature gets its own folder: users/users.module.ts, users/users.controller.ts, users/users.service.ts, users/dto/create-user.dto.ts, users/dto/update-user.dto.ts. `nest g resource users` generates all of this in one command!", code: "src/items/\n├── items.module.ts       // wires everything together\n├── items.controller.ts   // handles HTTP routes\n├── items.service.ts      // business logic + database\n├── dto/\n│   ├── create-item.dto.ts\n│   └── update-item.dto.ts\n└── entities/\n    └── item.entity.ts    // database model" },
    { t: 'Create — POST /items', d: "Accept a validated DTO, pass to service, insert into database, return the created item with 201 status. Always validate input with DTOs before creating. Return the full created object so the client has the ID and timestamps.", code: "@Post()\ncreate(@Body() dto: CreateItemDto) {\n  return this.prisma.item.create({\n    data: {\n      title: dto.title,\n      description: dto.description,\n      price: dto.price,\n    },\n  });\n}\n// POST /items { title: 'Widget', price: 9.99 }" },
    { t: 'Read — GET /items & GET /items/:id', d: "findAll() returns a paginated list with metadata (total, page, pages). findOne() returns a single item or throws NotFoundException. Add query params for filtering (search, status), sorting (sortBy, order), and pagination (page, limit).", code: "@Get()\nfindAll() {\n  return this.prisma.item.findMany();\n}\n\n@Get(':id')\nasync findOne(@Param('id', ParseIntPipe) id: number) {\n  const item = await this.prisma.item.findUnique({ where: { id } });\n  if (!item) throw new NotFoundException('Item ' + id + ' not found');\n  return item;\n}" },
    { t: 'Update — PATCH /items/:id', d: "Use PATCH (partial update) over PUT (full replace). Accept UpdateDto (PartialType of CreateDto) so clients only send changed fields. Verify the item exists first — update a non-existent item should throw 404, not create a new one.", code: "@Patch(':id')\nasync update(\n  @Param('id', ParseIntPipe) id: number,\n  @Body() dto: UpdateItemDto,\n) {\n  await this.findOne(id); // throws 404 if not found\n  return this.prisma.item.update({\n    where: { id },\n    data: dto,\n  });\n}" },
    { t: 'Delete — DELETE /items/:id', d: "Soft delete vs hard delete: soft delete sets a deletedAt timestamp (recoverable), hard delete removes the row permanently. Return 204 No Content on success. Always verify the item exists before deleting.", code: "@Delete(':id')\nasync remove(@Param('id', ParseIntPipe) id: number) {\n  await this.findOne(id); // throws 404 if not found\n  await this.prisma.item.delete({ where: { id } });\n  return { message: 'Item deleted' };\n}" },
    { t: 'Pagination Pattern', d: "Return `{ data: items[], meta: { total, page, limit, pages } }`. Calculate skip = (page - 1) * limit. Use default values for page (1) and limit (10). Set a max limit (100) to prevent clients from requesting millions of rows.", code: "@Get()\nfindAll(\n  @Query('page', new DefaultValuePipe(1), ParseIntPipe) page: number,\n  @Query('limit', new DefaultValuePipe(10), ParseIntPipe) limit: number,\n) {\n  const skip = (page - 1) * limit;\n  const [data, total] = await Promise.all([\n    this.prisma.item.findMany({ skip, take: limit }),\n    this.prisma.item.count(),\n  ]);\n  return { data, total, page, lastPage: Math.ceil(total / limit) };\n}" },
    { t: 'Putting It All Together', d: "Module imports PrismaModule, registers controller + service. Controller handles HTTP with decorators. Service contains all database logic. DTOs validate input. This pattern repeats for every feature in your app — learn it once, use it forever.", code: "@Module({\n  controllers: [ItemsController],\n  providers: [ItemsService, PrismaService],\n})\nexport class ItemsModule {}\n\n// Register in AppModule\n@Module({\n  imports: [ItemsModule],\n})\nexport class AppModule {}\n\n// Now all CRUD routes work:\n// GET/POST/PATCH/DELETE /items" }
  ],
...
// ── Lesson 48: Build a Task Manager App (Project-Based) ──────────────
{
  ...
  points: [
    {t: 'Project Overview', d: "We'll build a full-stack Task Manager with features: create tasks, set due dates, assign priority/status, add descriptions, and view a dashboard. The backend uses NestJS + Prisma + PostgreSQL. The frontend can be React or React Native. This is the kind of app companies use in interviews to evaluate candidates.", code: "// Task Manager — full-stack project\n// Backend: NestJS + Prisma + PostgreSQL\n// Features: auth, CRUD, filtering, validation\n\nnest new task-manager\ncd task-manager\nnpm i @prisma/client class-validator class-transformer\nnpm i -D prisma\nnpx prisma init"},
    {t: 'Database Schema Design', d: "Start with two models: User (id, email, password, name, createdAt) and Task (id, title, description, dueDate, priority, status, assigneeId, createdAt, updatedAt). The Task has a foreign key to User. Priority is an enum: LOW, MEDIUM, HIGH, URGENT. Status is an enum: TODO, IN_PROGRESS, COMPLETED. Always think about your data shape before writing any code.", code: "// Think before coding: what data do we need?\n// Users: id, name, email, password\n// Tasks: id, title, description, status, priority, userId\n\n// Relationships:\n// User has many Tasks (1:N)\n// Task belongs to one User"},
    {t: 'Prisma Schema & Migration', d: "Define your models in schema.prisma with @id, @default, @relation, and enum types. Run 'npx prisma migrate dev --name init' to create the database tables. Then run 'npx prisma generate' to create the type-safe client. Prisma gives you autocompletion for every query — no raw SQL needed.", code: "// prisma/schema.prisma\nmodel User {\n  id       Int    @id @default(autoincrement())\n  email    String @unique\n  password String\n  tasks    Task[]\n}\n\nmodel Task {\n  id          Int      @id @default(autoincrement())\n  title       String\n  description String?\n  status      Status   @default(TODO)\n  userId      Int\n  user        User     @relation(fields: [userId], references: [id])\n}\n\nenum Status { TODO, IN_PROGRESS, DONE }\n\n// npx prisma migrate dev --name init"},
    {t: 'NestJS Module Structure', d: "Organize into feature modules: AuthModule (login/register), UsersModule (user CRUD), TasksModule (task CRUD). Each module has its own controller, service, and DTOs. Use the CLI: 'nest g module tasks', 'nest g controller tasks', 'nest g service tasks'. Keep modules focused on one responsibility.", code: "// Generate modules\nnest g resource users\nnest g resource tasks\nnest g module auth\nnest g service auth\n\n// Structure:\nsrc/\n  ├── auth/       (login, register, JWT)\n  ├── users/      (user CRUD)\n  ├── tasks/      (task CRUD)\n  └── prisma/     (database service)"},
    {t: 'Authentication Flow', d: "Register: hash password with bcrypt, store user, return JWT. Login: verify email/password, return access + refresh tokens. Protect routes with JwtAuthGuard. Use @CurrentUser() decorator to get the logged-in user. Every task operation should be scoped to the authenticated user — users can only see and modify their own tasks.", code: "// Register\n@Post('register')\nasync register(@Body() dto: RegisterDto) {\n  const hashed = await bcrypt.hash(dto.password, 10);\n  return this.prisma.user.create({\n    data: { ...dto, password: hashed },\n  });\n}\n\n// Login\n@Post('login')\nasync login(@Body() dto: LoginDto) {\n  const user = await this.validateUser(dto);\n  return { access_token: this.jwt.sign({ sub: user.id }) };\n}"},
    {t: 'CRUD Endpoints', d: "POST /tasks — create a task (validate with CreateTaskDto). GET /tasks — list user's tasks with filters (status, priority, search). GET /tasks/:id — get single task (check ownership). PATCH /tasks/:id — update task fields (partial update with UpdateTaskDto). DELETE /tasks/:id — soft delete or hard delete. Always return appropriate HTTP status codes: 201 for create, 200 for success, 204 for delete.", code: "@UseGuards(JwtAuthGuard)\n@Controller('tasks')\nexport class TasksController {\n  @Post()   create(@CurrentUser() user, @Body() dto) {}\n  @Get()    findAll(@CurrentUser() user, @Query() query) {}\n  @Get(':id') findOne(@Param('id') id) {}\n  @Patch(':id') update(@Param('id') id, @Body() dto) {}\n  @Delete(':id') remove(@Param('id') id) {}\n}"},
...
// ── Lesson 49: Database Relationships ──────────────
{
  ...
  points: [
    {t: 'One-to-One (1:1)', d: "Each record in Table A links to exactly one record in Table B, and vice versa. Example: a User has one Profile. In Prisma, use @relation with a unique foreign key. One-to-one is less common but useful for splitting large tables or optional data (not every user needs billing info on the main table).", code: "// User has one Profile\nmodel User {\n  id      Int      @id @default(autoincrement())\n  profile Profile?\n}\n\nmodel Profile {\n  id     Int  @id @default(autoincrement())\n  bio    String\n  userId Int  @unique  // @unique makes it 1:1\n  user   User @relation(fields: [userId], references: [id])\n}"},
    {t: 'One-to-Many (1:N)', d: "One record in Table A links to many records in Table B. This is the most common relationship. Example: one User has many Posts. The 'many' side holds the foreign key (Post has userId). In Prisma: User has 'posts Post[]' and Post has 'author User @relation(fields: [authorId], references: [id])'.", code: "// User has many Posts\nmodel User {\n  id    Int    @id @default(autoincrement())\n  posts Post[] // one user → many posts\n}\n\nmodel Post {\n  id     Int  @id @default(autoincrement())\n  title  String\n  userId Int\n  user   User @relation(fields: [userId], references: [id])\n}"},
    {t: 'Many-to-Many (M:N)', d: "Records in Table A link to many records in Table B, and vice versa. Example: Students enroll in many Courses, and each Course has many Students. This requires a join table (enrollment) that holds both foreign keys. Prisma can create implicit join tables automatically or you can define explicit ones for extra fields like enrolledAt.", code: "// Posts can have many Tags, Tags can have many Posts\nmodel Post {\n  id   Int   @id @default(autoincrement())\n  tags Tag[] // implicit join table\n}\n\nmodel Tag {\n  id    Int    @id @default(autoincrement())\n  name  String @unique\n  posts Post[]\n}\n\n// Prisma auto-creates _PostToTag junction table"},
    {t: 'Foreign Keys', d: "A foreign key is a column that references the primary key of another table. It enforces referential integrity — you can't create a Post with a userId that doesn't exist. In Prisma, @relation(fields: [authorId], references: [id]) defines the link. Foreign keys are the glue that holds relational data together.", code: "// Foreign key = link to another table's ID\nmodel Comment {\n  id     Int  @id @default(autoincrement())\n  text   String\n  postId Int   // foreign key → points to Post\n  post   Post  @relation(fields: [postId], references: [id])\n}\n\n// postId must match an existing Post.id\n// Can't create comment for non-existent post!"},
    {t: 'Cascading Deletes & Updates', d: "When you delete a User, what happens to their Posts? Cascade: delete all posts too. SetNull: keep posts but clear authorId. Restrict: block deletion if posts exist. In Prisma, use onDelete: Cascade, SetNull, or Restrict. Choose carefully — cascading deletes in production can wipe out more data than intended!", code: "model Post {\n  id       Int       @id @default(autoincrement())\n  comments Comment[]\n}\n\nmodel Comment {\n  postId Int\n  post   Post @relation(fields: [postId], references: [id], onDelete: Cascade)\n}\n\n// Delete a Post → all its Comments auto-deleted!\n// Without cascade: error if post has comments"},
    {t: 'Eager vs Lazy Loading', d: "Eager loading fetches related data immediately (include: { posts: true }). Lazy loading fetches only when accessed. Prisma uses explicit eager loading with 'include' — no hidden queries. Always be intentional: don't load 1000 posts when you only need the user's name. The N+1 problem (querying each relation separately in a loop) is the #1 performance killer.", code: "// Eager: load related data immediately\nconst user = await prisma.user.findUnique({\n  where: { id: 1 },\n  include: { posts: true },  // loads posts with user\n});\nuser.posts; // already loaded!\n\n// Lazy: load only when needed (default in Prisma)\nconst user = await prisma.user.findUnique({ where: { id: 1 } });\n// user.posts → undefined (not loaded yet)\n// Must query separately"},
    {t: 'Self-Relations', d: "A table can reference itself. Example: an Employee has a managerId pointing to another Employee. Or a Comment has a parentId for threaded replies. In Prisma, define two relation fields on the same model. Self-relations power org charts, category trees, threaded comments, and file/folder hierarchies.", code: "// Employee reports to another Employee\nmodel Employee {\n  id        Int        @id @default(autoincrement())\n  name      String\n  managerId Int?\n  manager   Employee?  @relation('reports', fields: [managerId], references: [id])\n  reports   Employee[] @relation('reports')\n}\n\n// CEO: managerId = null\n// Manager: managerId = CEO's id\n// Developer: managerId = Manager's id"},
    {t: 'Querying Relations with Prisma', d: "Prisma makes relation queries readable. Find user with posts: prisma.user.findUnique({ where: { id }, include: { posts: true } }). Filter by relation: prisma.post.findMany({ where: { author: { email: { contains: 'gmail' } } } }). Nested creates: prisma.user.create({ data: { name: 'Ali', posts: { create: [{ title: 'Hello' }] } } }).", code: "// Include related data\nconst users = await prisma.user.findMany({\n  include: { posts: { include: { comments: true } } },\n});\n\n// Filter by relation\nconst activeAuthors = await prisma.user.findMany({\n  where: { posts: { some: { published: true } } },\n});\n\n// Count relations\nconst users = await prisma.user.findMany({\n  include: { _count: { select: { posts: true } } },\n});"}
  ],
